...
TCSUPPORT_PON_IP_HOST_AUTOWAN_VOICE=y
...
# TCSUPPORT_VOIP_SIP_T_TIMER is not set
...
TCSUPPORT_PARTITIONS_CMDLINE_STR="16m[tclinux],16m[tclinux_slave],41m[yaffs]"
TCSUPPORT_MTD_PARTITION_NUM=10
...
TCSUPPORT_CT_BLOCK_PROCESS=y
TCSUPPORT_CT_SIMCARD_SEPARATION=y
...
TCSUPPORT_CT_PON_SMALLSYSTEM=y
...
TCSUPPORT_CT_PON_NMG=y
TCSUPPORT_CT_PON_SN=y
TCSUPPORT_CT_PHONEAPP=y
TCSUPPORT_CT_JOYME=y
TCSUPPORT_CT_JOYME_BANDWIDTH=y
TCSUPPORT_CT_OSGI=y
TCSUPPORT_CT_MAXNET_DPI=y
# TCSUPPORT_CT_DHCP_FORCERENEW is not set
# TCSUPPORT_CT_DHCP_ARPPING is not set
TCSUPPORT_CT_PON_JS=y
TCSUPPORT_CT_PON_BIND2=y
# TCSUPPORT_CT_PON_JS_IP is not set
# TCSUPPORT_CT_VOIP_CRYPT is not set
TCSUPPORT_CT_PON_GX=y
# TCSUPPORT_CT_SFU_C9 is not set
# TCSUPPORT_CT_C9 is not set
# TCSUPPORT_CT_PORTSLIMIT is not set
# TCSUPPORT_CUC_BOTH_SIPH248 is not set
TCSUPPORT_CT_IPOE_EMULATOR=y
TCSUPPORT_TR69_IP_HOST=y
# TCSUPPORT_CT_PPPINFORM is not set
# TCSUPPORT_CT_C5_HEN_SFU is not set
TCSUPPORT_CMCC=y
TCSUPPORT_CT_DS_LIMIT=y
TCSUPPORT_CT_PMINFORM=y
TCSUPPORT_CT_STB_TEST=y
TCSUPPORT_CT_TR143_WGET_DOWNLOAD=y
TCSUPPORT_CT_TRACEROUTEIPV6=y
TCSUPPORT_CT_PPPERRCODE_ENHANCE=y
TCSUPPORT_CT_BRIDGE_PPPSTATUS=y
TCSUPPORT_CT_PON_BIND2_WEB=y
TCSUPPORT_CT_CUSTOMMENU=y
TCSUPPORT_CT_CUSTOMCODE=y
