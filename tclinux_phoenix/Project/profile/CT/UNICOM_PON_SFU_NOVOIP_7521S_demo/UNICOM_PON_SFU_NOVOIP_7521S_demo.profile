...
TCSUPPORT_PARTITIONS_CMDLINE_STR="112b[tclinux],134b[tclinux_slave]"
...
TCSUPPORT_LAN1_PORT=-1
TCSUPPORT_LAN2_PORT=-1
...
# TCSUPPORT_CT_ACCESSLIMIT is not set
...
# TCSUPPORT_CT_E8DDNS is not set
...
# TCSUPPORT_CT_PORTAL_MANAGEMENT is not set
TCSUPPORT_CT_IPPINGDIAGNOSTIC=y
# TCSUPPORT_CT_ADSLSETTING is not set
# TCSUPPORT_CT_WLAN_NODE is not set
TCSUPPORT_CT_RECONNECT_NODE=y
# TCSUPPORT_CT_IPTV_NODE is not set
# TCSUPPORT_CT_INFORM_NODE is not set
# TCSUPPORT_CT_ALARMMONITOR is not set
# TCSUPPORT_CT_ALGABILITY is not set
...
# TCSUPPORT_CT_FULL_ROUTE is not set
...
# TCSUPPORT_LED_SWITCH_BUTTON is not set
...
# TCSUPPORT_CUC_PON_SD is not set
