...
#define STB_NOTIFY_SET (1<<0)
	unsigned char stb_state;
#endif
};
#if defined(CONFIG_BRIDGE_IGMP_SNOOPING) && defined(TCSUPPORT_IGMPSNOOPING_ENHANCE)
...
extern int br_pppcheck_init(void);
extern void br_pppcheck_fini(void);
#endif
#if defined(TCSUPPORT_CT_PON_SC)
extern int br_dhcpCheck_init(void);
extern void br_dhcpCheck_fini(void);
#endif
#if defined(TCSUPPORT_CT_DS_LIMIT)
extern int br_dataspeed_limit_init(void);
extern void br_dataspeed_limit_fini(void);
#endif
#if defined(TCSUPPORT_CT_BRIDGE_PPPSTATUS)
extern int br_pppbridge_state_init(void);
extern void br_pppbridge_state_fini(void);
#endif
...
extern struct net_bridge_fdb_entry *__br_fdb_pb_get(struct sk_buff *skb,
													struct net_bridge *br, 
...
#if defined(TCSUPPORT_CT)
#ifdef TCSUPPORT_PORTBIND//CONFIG_PORT_BINDING
extern void br_flood_pb_forward(struct net_bridge *br, struct sk_buff *skb, 
						 struct sk_buff *skb2);

extern void br_multicast_pb_forward(struct net_bridge_mdb_entry *mdst,
			  struct sk_buff *skb, struct sk_buff *skb2);
...
#if defined(TCSUPPORT_CT)
#ifdef TCSUPPORT_PORTBIND//CONFIG_PORT_BINDING
static inline void br_flood_pb_forward(struct net_bridge *br,
			struct sk_buff *skb, struct sk_buff *skb2)
		{
		}
...
static inline void br_multicast_pb_forward(struct net_bridge_mdb_entry *mdst,
			  struct sk_buff *skb, struct sk_buff *skb2)
{
}
