                 ...
                 struct sk_buff* skb, uint tranoff, uint tranlen)
{
	...
	/*  this modification is referred to Linux kernel-3.7-V2 changed to nf_nat_rtsp.c
	    Transport: tran;field;field=val,tran;field;field=val,...
	...
	*/
	nextparamoff = pparamend-ptran;
		...
		else /* this modification is referred to #OSBNB00029063 */
		{
		    is_stun = 1;
		}
		    ...
		    /* this modification is referred to Linux kernel-3.7-V2 changed to nf_nat_rtsp.c 
		       parameter 4(tcpoff) below is offset from start of tcp data.
		    */
		    int tcpoff;
		    tcpoff = tranoff + off;
		    if (!nf_nat_mangle_tcp_packet(skb,ct,ctinfo,tcpoff,diff,NULL,0))
                    {
