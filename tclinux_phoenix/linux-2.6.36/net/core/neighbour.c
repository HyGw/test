...
#if defined(TCSUPPORT_CT_PPPOE_IPV6_EMULATOR)
		t->neigh_vars[15].data  = &p->ra_flags;
		memset(&t->neigh_vars[16], 0, sizeof(t->neigh_vars[16]));
#else
...
#if defined(TCSUPPORT_CT_PPPOE_IPV6_EMULATOR)
		t->neigh_vars[15].data  = &p->ra_flags;
		t->neigh_vars[16].data = (int *)(p + 1);
		t->neigh_vars[17].data = (int *)(p + 1) + 1;
		t->neigh_vars[18].data = (int *)(p + 1) + 2;
		t->neigh_vars[19].data = (int *)(p + 1) + 3;
#else
