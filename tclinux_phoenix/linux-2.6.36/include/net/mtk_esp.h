...
#ifdef TCSUPPORT_IPSEC_PASSTHROUGH
extern void 
ipsec_set_adatpterlist_para(void* inputpara);
extern void 
mtk_ipsec_proc_init(void);
extern void
mtk_ipsec_proc_uninit(void);
extern vpnPassThrough_Global_Para_t *gpVpnPTPara;//for output speed judgement
#endif
...
extern void 
ipsec_esp_input_finish_pt(ipsec_finishpara_t* inputParams);
extern int 
ipsec_esp_input_pt(ipsec_para_t* ipsecparams);
extern int 
ipsec_esp_output_pt(ipsec_para_t* ipsecparams);
