...
struct ipv6_devconf {
	...
	char child_prefix[64];  //used to calulate the new prefix in ra
	char parent_pd_prefix[64];  //used to calulate the new prefix in ra
	char slaac_prefix[64];  //get current ra prefix
#endif
	void		*sysctl;
};
