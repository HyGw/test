...
#define PT_TCSTATUS 176 /* offsetof(struct pt_regs, cp0_tcstatus)	 # */
...
#define TASK_MM 200 /* offsetof(struct task_struct, mm)	 # */
#define TASK_PID 248 /* offsetof(struct task_struct, pid)	 # */
#define TASK_STRUCT_SIZE 1192 /* sizeof(struct task_struct)	 # */
...
#define THREAD_TRAMP 904 /* offsetof(struct task_struct, thread.irix_trampoline)	 # */
#define THREAD_OLDCTX 908 /* offsetof(struct task_struct, thread.irix_oldctx)	 # */
