# 1 "/opt/tclinux_phoenix/modules/private/xpon/src/gpon/gpon_recovery.c"
# 1 "<built-in>"
# 1 "<命令行>"
# 1 "./include/generated/autoconf.h" 1
# 1 "<命令行>" 2
# 1 "/opt/tclinux_phoenix/modules/private/xpon/src/gpon/gpon_recovery.c"
# 47 "/opt/tclinux_phoenix/modules/private/xpon/src/gpon/gpon_recovery.c"
# 1 "/opt/tclinux_phoenix/modules/private/xpon/inc/gpon/gpon_recovery.h" 1
# 49 "/opt/tclinux_phoenix/modules/private/xpon/inc/gpon/gpon_recovery.h"
...
extern int netdev_info(const struct net_device *dev, const char *format, ...)
 __attribute__ ((format (printf, 2, 3)));
# 5 "/opt/tclinux_phoenix/modules/private/xpon/inc/pwan/xpon_netif.h" 2
...
# 9 "/opt/tclinux_phoenix/modules/private/xpon/inc/common/drv_types.h" 2
...
# 8 "/opt/tclinux_phoenix/modules/private/xpon/inc/pwan/xpon_netif.h" 2
...
# 10 "/opt/tclinux_phoenix/modules/private/xpon/inc/pwan/xpon_netif.h" 2
...
# 8 "/opt/tclinux_phoenix/modules/private/xpon/inc/pwan/gpon_wan.h" 2
...
# 1 "/opt/tclinux_phoenix/global_inc/modules/xpon_global/private/../public/xmcs_const.h" 1
# 5 "/opt/tclinux_phoenix/global_inc/modules/xpon_global/private/../public/xmcs_if.h" 2
...
# 1 "/opt/tclinux_phoenix/global_inc/modules/xpon_global/private/xmcs_const.h" 1
# 7 "/opt/tclinux_phoenix/global_inc/modules/xpon_global/private/xmcs_if.h" 2
...
# 281 "/opt/tclinux_phoenix/modules/private/xpon/inc/pwan/xpon_netif.h" 2
...
# 50 "/opt/tclinux_phoenix/modules/private/xpon/inc/gpon/gpon_recovery.h" 2
...
# 48 "/opt/tclinux_phoenix/modules/private/xpon/src/gpon/gpon_recovery.c" 2

struct Gpon_Recovery_S gponRecovery={0};
# 59 "/opt/tclinux_phoenix/modules/private/xpon/src/gpon/gpon_recovery.c"
int gpon_recovery_init(void)
{
 int i;
 ...
 for(i = 0; i < 32; i++){
  gponRecovery.allocId[i] = (0xFF);
    }

 gponRecovery.dbgPrint = 0;
}
# 81 "/opt/tclinux_phoenix/modules/private/xpon/src/gpon/gpon_recovery.c"
int gpon_recover_backup_allocId(unsigned short allocId)
{
 if(((void *)0) != find_backup_allocId(allocId)){
  return -1;
 }

 gponRecovery.allocId[gponRecovery.allocIdNum] = allocId;

 do{ if(gponRecovery.dbgPrint){ printk("%s [%d]: ", (__func__), 89); printk("allocId[%d] = %d\n", gponRecovery.allocIdNum, allocId); } }while(0);

 gponRecovery.allocIdNum++;

 return 0;
}
# 105 "/opt/tclinux_phoenix/modules/private/xpon/src/gpon/gpon_recovery.c"
int gpon_recover_create_allocId(void)
{
 int i = 0;
 int ret = 0;
 ...
 for(i = 0; i < gponRecovery.allocIdNum; i++)
 {
  ...
  do{ if(gponRecovery.dbgPrint){ printk("%s [%d]: ", (__func__), 117); printk("allocId[%d] = %d\n", i, gponRecovery.allocId[i]); } }while(0);
 }

 return ret;
}
# 132 "/opt/tclinux_phoenix/modules/private/xpon/src/gpon/gpon_recovery.c"
int gpon_recover_delete_allocId(unsigned short allocId)
{
 int i = 0;
 ...
 do{ if(gponRecovery.dbgPrint){ printk("%s [%d]: ", (__func__), 162); printk("allocId = %d\n", tmp); } }while(0);

 *tmp = gponRecovery.allocId[gponRecovery.allocIdNum-1];
 gponRecovery.allocId[gponRecovery.allocIdNum-1] = (0xFF);
 gponRecovery.allocIdNum--;
 return 0;
}
# 179 "/opt/tclinux_phoenix/modules/private/xpon/src/gpon/gpon_recovery.c"
int gpon_recover_backup_gemport(struct Gem_Recovery_Info * bakGemportId)
{
 if(((void *)0) != find_backup_gemport(bakGemportId->gemPortId)){
  return -1;
 }

 gponRecovery.gemPort[gponRecovery.gemPortNum] = *bakGemportId;
 do{ do{ if(gponRecovery.dbgPrint){ printk("%s [%d]: ", (__func__), 186); printk("gemPort[%d].allocId = %d\n",gponRecovery.gemPortNum, gponRecovery.gemPort[gponRecovery.gemPortNum].allocId); } }while(0); do{ if(gponRecovery.dbgPrint){ printk("%s [%d]: ", (__func__), 186); printk("gemPort[%d].gemPortId = %d\n",gponRecovery.gemPortNum, gponRecovery.gemPort[gponRecovery.gemPortNum].gemPortId); } }while(0); do{ if(gponRecovery.dbgPrint){ printk("%s [%d]: ", (__func__), 186); printk("gemPort[%d].channel = %d\n",gponRecovery.gemPortNum, gponRecovery.gemPort[gponRecovery.gemPortNum].channel); } }while(0); do{ if(gponRecovery.dbgPrint){ printk("%s [%d]: ", (__func__), 186); printk("gemPort[%d].encryption = %d\n\n",gponRecovery.gemPortNum, gponRecovery.gemPort[gponRecovery.gemPortNum].encryption); } }while(0);}while(0);
 gponRecovery.gemPortNum++;

 return 0;
}
# 201 "/opt/tclinux_phoenix/modules/private/xpon/src/gpon/gpon_recovery.c"
...
# 229 "/opt/tclinux_phoenix/modules/private/xpon/src/gpon/gpon_recovery.c"
int gpon_recover_create_gemport(void)
{
 int i = 0;
 struct Gem_Recovery_Info * pBakGemPort = ((void *)0);
 ...
 for(i = 0; i < gponRecovery.gemPortNum; i++)
 {
  ...
  if(-1 == pBakGemPort->channel){
   do{ if(gponRecovery.dbgPrint){ printk("%s [%d]: ", (__func__), 241); printk("channel err\n"); } }while(0);
   continue;
  }

  if(0 != gwan_create_new_gemport(pBakGemPort->gemPortId, pBakGemPort->channel, pBakGemPort->encryption)){
   do{ if(gponRecovery.dbgPrint){ printk("%s [%d]: ", (__func__), 246); printk("create_gemport err\n"); } }while(0);
   continue;
  }

  if(0 != gwan_config_gemport(pBakGemPort->gemPortId, ENUM_CFG_NETIDX, 1)){
   do{ if(gponRecovery.dbgPrint){ printk("%s [%d]: ", (__func__), 251); printk("config_gemport err\n"); } }while(0);
   continue;
  }

  do{ do{ if(gponRecovery.dbgPrint){ printk("%s [%d]: ", (__func__), 255); printk("gemPort[%d].allocId = %d\n",i, gponRecovery.gemPort[i].allocId); } }while(0); do{ if(gponRecovery.dbgPrint){ printk("%s [%d]: ", (__func__), 255); printk("gemPort[%d].gemPortId = %d\n",i, gponRecovery.gemPort[i].gemPortId); } }while(0); do{ if(gponRecovery.dbgPrint){ printk("%s [%d]: ", (__func__), 255); printk("gemPort[%d].channel = %d\n",i, gponRecovery.gemPort[i].channel); } }while(0); do{ if(gponRecovery.dbgPrint){ printk("%s [%d]: ", (__func__), 255); printk("gemPort[%d].encryption = %d\n\n",i, gponRecovery.gemPort[i].encryption); } }while(0);}while(0);
 }

 return 0;
}
# 270 "/opt/tclinux_phoenix/modules/private/xpon/src/gpon/gpon_recovery.c"
int gpon_recover_delete_gemport(unsigned short gemPortId)
{
 int i = 0;
 struct Gem_Recovery_Info * bakGemport = gponRecovery.gemPort;
 ...
 if((tmp - gponRecovery.gemPort) != (gponRecovery.gemPortNum - 1) )
    {
        do{ if(gponRecovery.dbgPrint){ printk("%s [%d]: ", (__func__), 284); printk("gemPort = %d\n", tmp->gemPortId); } }while(0);
