# 1 "/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy_tx.c"
# 1 "<built-in>"
# 1 "<命令行>"
...
# 8 "/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy_tx.c" 2
...
# 9 "/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy_tx.c" 2
...
# 10 "/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy_tx.c" 2
...
# 12 "/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy_tx.c" 2
# 1 "/opt/tclinux_phoenix/linux-2.6.36/arch/mips/include/asm/tc3162/ledcetrl.h" 1
# 69 "/opt/tclinux_phoenix/linux-2.6.36/arch/mips/include/asm/tc3162/ledcetrl.h"
...
# 70 "/opt/tclinux_phoenix/linux-2.6.36/arch/mips/include/asm/tc3162/ledcetrl.h" 2
...
void ledTask(void);
# 13 "/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy_tx.c" 2
...
# 5 "/opt/tclinux_phoenix/modules/private/xpon_phy/inc/phy_global.h" 2
...
# 5 "/opt/tclinux_phoenix/modules/private/xpon_phy/inc/phy.h" 2
...
# 10 "include/linux/mtd/rt_flash.h"
...
extern PHY_GlbPriv_T *gpPhyPriv ;
# 15 "/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy_tx.c" 2
# 1 "/opt/tclinux_phoenix/modules/private/xpon_phy/inc/i2c.h" 1
# 16 "/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy_tx.c" 2
# 1 "/opt/tclinux_phoenix/modules/private/xpon_phy/inc/phy.h" 1
# 17 "/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy_tx.c" 2
# 1 "/opt/tclinux_phoenix/modules/private/xpon_phy/inc/phy_def.h" 1
# 18 "/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy_tx.c" 2
...
# 19 "/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy_tx.c" 2
...
# 20 "/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy_tx.c" 2
...
# 21 "/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy_tx.c" 2

extern PHY_GlbPriv_T *gpPhyPriv;

extern int mt7570_select;
# 44 "/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy_tx.c"
int phy_gpon_preamble(PPHY_GponPreb_T pon_preb)
{
 uint write_data = 0;
 uint read_data = 0;
 read_data = regReadPhy32((0xbfaf0400 +0x0000));

 if((pon_preb->mask & PHY_GUARD_BIT_NUM_EN) == PHY_GUARD_BIT_NUM_EN )
 {
  read_data = (read_data & 0xffffff00) | pon_preb->guard_bit_num;
 }
 if((pon_preb->mask & PHY_PRE_T1_NUM_EN) == PHY_PRE_T1_NUM_EN)
 {
  read_data = (read_data & 0xffff00ff) | (pon_preb->preamble_t1_num << 8);
 }
 if((pon_preb->mask & PHY_PRE_T2_NUM_EN) == PHY_PRE_T2_NUM_EN)
 {
  read_data = (read_data & 0xff00ffff) | (pon_preb->preamble_t2_num << 16);
 }
 if((pon_preb->mask & PHY_PRE_T3_PAT_EN) == PHY_PRE_T3_PAT_EN)
 {
  read_data = (read_data & 0x00ffffff) | (pon_preb->preamble_t3_pat << 24);
 }
 write_data = read_data;

    gpPhyPriv->phyPreamble = write_data;
 iowrite32(write_data, (void *)((0xbfaf0400 +0x0000)));
 return (0);

}
# 87 "/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy_tx.c"
int phy_tx_fec_status(void)
{
 uint read_data = 0;
 read_data = regReadPhy32((0xbfaf0400 +0x000C));
 if((read_data & (1<<15)) == (1<<15))
 {
  { if(gpPhyPriv->debugLevel & PHY_MSG_DBG) printk("[%lu]" "0ms" "[%s:%d]\n  " "TX FEC on. \n" , jiffies, strrchr("/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy_tx.c", '/') + 1, 93) ; };
  return (1);
 }
 else
 {
  { if(gpPhyPriv->debugLevel & PHY_MSG_DBG) printk("[%lu]" "0ms" "[%s:%d]\n  " "TX FEC off. \n" , jiffies, strrchr("/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy_tx.c", '/') + 1, 98) ; };
  return (0);
 }

}
# 116 "/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy_tx.c"
int phy_gpon_delimiter_guard(uint delimiter_pat, unchar guard_time_pat)
{
 uint write_data = 0;
 if((delimiter_pat & 0xff000000) != 0)
 {
  { if(gpPhyPriv->debugLevel & PHY_MSG_DBG) printk("[%lu]" "0ms" "[%s:%d]\n  " "error input : delimiter pattern. \n" , jiffies, strrchr("/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy_tx.c", '/') + 1, 121) ; };
  return (1);
 }
 else
 {
  write_data = (guard_time_pat << 24) | delimiter_pat;

  gpPhyPriv->phyGuardBitDelm = write_data;
  iowrite32(write_data, (void *)((0xbfaf0400 +0x0004)));
  return (0);
 }
}
# 144 "/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy_tx.c"
int phy_gpon_extend_preamble(PPHY_GponPreb_T pon_preb)
{
 uint read_data = 0;
 uint write_data = 0;
 read_data = regReadPhy32((0xbfaf0400 +0x0008));


 if((pon_preb->mask & PHY_T3_O4_PRE_EN) == PHY_T3_O4_PRE_EN)
  read_data = (read_data & 0xffffff00) | pon_preb->t3_O4_preamble;
 if((pon_preb->mask & PHY_T3_O5_PRE_EN) == PHY_T3_O5_PRE_EN)
  read_data = (read_data & 0xffff00ff) | (pon_preb->t3_O5_preamble << 8);
 if((pon_preb->mask & PHY_EXT_BUR_MODE_EN) == PHY_EXT_BUR_MODE_EN)
 {
  if((pon_preb->extend_burst_mode != (1)) && (pon_preb->extend_burst_mode!= (0)))
  {
   { if(gpPhyPriv->debugLevel & PHY_MSG_ERR) printk("[%lu]" "0ms" "[%s:%d]\n  " "error input : extend_burst_mode. \n" , jiffies, strrchr("/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy_tx.c", '/') + 1, 159) ; };
   return (1);
  }
  read_data = (read_data & 0xfffeffff) | (pon_preb->extend_burst_mode << 16);
 }
 if((pon_preb->mask & PHY_OPER_RANG_EN) == PHY_OPER_RANG_EN)
 {
  if( (pon_preb->oper_ranged_st & 0xfc) != 0x00)
  {
   { if(gpPhyPriv->debugLevel & PHY_MSG_ERR) printk("[%lu]" "0ms" "[%s:%d]\n  " "error input : oper_ranged_st. \n" , jiffies, strrchr("/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy_tx.c", '/') + 1, 168) ; };
   return (1);
  }
  read_data = (read_data & 0xfff9ffff) | (pon_preb->oper_ranged_st<< 17);
 }

 if((pon_preb->mask & PHY_EXTB_LENG_SEL_EN) == PHY_EXTB_LENG_SEL_EN)
 {
  if( (pon_preb->extb_length_sel & 0xfe) != 0x00)
  {
   { if(gpPhyPriv->debugLevel & PHY_MSG_ERR) printk("[%lu]" "0ms" "[%s:%d]\n  " "error input : oper_ranged_st. \n" , jiffies, strrchr("/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy_tx.c", '/') + 1, 178) ; };
   return (1);
  }
  read_data = (read_data & 0xfff7ffff) | (pon_preb->extb_length_sel<< 19);
 }

 if((pon_preb->mask & PHY_DIS_SCRAM_EN) == PHY_DIS_SCRAM_EN)
 {
  if((pon_preb->dis_scramble != (1)) && (pon_preb->dis_scramble!= (0)))
  {
   { if(gpPhyPriv->debugLevel & PHY_MSG_ERR) printk("[%lu]" "0ms" "[%s:%d]\n  " "error input : dis_scramble. \n" , jiffies, strrchr("/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy_tx.c", '/') + 1, 188) ; };
   return (1);
  }
  read_data = (read_data & 0xfeffffff) | (pon_preb->dis_scramble<< 24);
 }
 write_data = read_data;
 ...
 iowrite32(write_data, (void *)((0xbfaf0400 +0x0008)));
 return (0);

}
# 214 "/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy_tx.c"
int phy_rogue_prbs_config(unchar rogue_mode)
{
 ...
 if((rogue_mode != (1)) && (rogue_mode != (0)))
 {
  { if(gpPhyPriv->debugLevel & PHY_MSG_ERR) printk("[%lu]" "0ms" "[%s:%d]\n  " "error input : rogue mode. \n" , jiffies, strrchr("/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy_tx.c", '/') + 1, 227) ; };
  return (1);
 }
 ...
 {
  { if(gpPhyPriv->debugLevel & PHY_MSG_ERR) printk("[%lu]" "0ms" "[%s:%d]\n  " "PON mode error. \n" , jiffies, strrchr("/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy_tx.c", '/') + 1, 234) ; };
  return (1);
 }
    ...
    if(rogue_mode == (1))
 {
   ...
   read_data = regReadPhy32((0xbfaf0100 +0x00FC)) ;
   write_data = read_data | (0x01<<28);
   iowrite32(write_data, (void *)((0xbfaf0100 +0x00FC)));



   read_data = regReadPhy32((0xbfaf0400 +0x00A0)) ;
   write_data = read_data | 0x05;
   iowrite32(write_data, (void *)((0xbfaf0400 +0x00A0)));

   read_data = regReadPhy32((0xbfaf0400 +0x00A4)) ;
   write_data = read_data | 0x01;
   iowrite32(write_data, (void *)((0xbfaf0400 +0x00A4)));
   ...
   { if(gpPhyPriv->debugLevel & PHY_MSG_DBG) printk("[%lu]" "0ms" "[%s:%d]\n  " "Phy_Rogue_PRBS mode\n" , jiffies, strrchr("/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy_tx.c", '/') + 1, 275) ; };
        }
  else
  {
     if(PHY_GPON_CONFIG == gpPhyPriv->phyCfg.flags.mode)
   ...
   iowrite32(write_data, (void *)((0xbfaf0400 +0x00A4)));
         ...
         iowrite32(0x40, (void *)((0xbfaf0500 +0x00F4))) ;
# 309 "/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy_tx.c"
        }else if (PHY_EPON_CONFIG == gpPhyPriv->phyCfg.flags.mode){
   ...
   iowrite32(write_data, (void *)((0xbfaf0100 +0x0008)));
        ...
        gpPhyPriv->phyCfg.flags.rogue = 0;
            ...
            { if(gpPhyPriv->debugLevel & PHY_MSG_DBG) printk("[%lu]" "0ms" "[%s:%d]\n  " "Phy_NO_Rogue_PRBS mode\n" , jiffies, strrchr("/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy_tx.c", '/') + 1, 319) ; };
        }

  return (0);
}
# 335 "/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy_tx.c"
int phy_tx_burst_config(unchar burst_mode)
{
 if((burst_mode != (0)) && (burst_mode != (1)))
 {
  { if(gpPhyPriv->debugLevel & PHY_MSG_ERR) printk("[%lu]" "0ms" "[%s:%d]\n  " "error input : burst_mode. \n" , jiffies, strrchr("/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy_tx.c", '/') + 1, 339) ; };
  return (1);
 }
 else
 {
  ...
  uint read_data = 0;
  read_data = regReadPhy32((0xbfaf0100 +0x0008));
  write_data = (read_data & 0xffffff5f) | (burst_mode * 0xa0);
  { if(gpPhyPriv->debugLevel & PHY_MSG_DBG) printk("[%lu]" "0ms" "[%s:%d]\n  " "Phy_Tx_Burst_Config read_data:0x%.8x\n" , jiffies, strrchr("/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy_tx.c", '/') + 1, 348, read_data) ; };
  { if(gpPhyPriv->debugLevel & PHY_MSG_DBG) printk("[%lu]" "0ms" "[%s:%d]\n  " "Phy_Tx_Burst_Config write_data:0x%.8x\n" , jiffies, strrchr("/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy_tx.c", '/') + 1, 349, write_data) ; };
  iowrite32(write_data, (void *)((0xbfaf0100 +0x0008)));

  if(phy_los_status() == (0x01))
  {
  ...
  gpPhyPriv->phyCfg.flags.txLongFlag = ((burst_mode==(1))?(1):(0));

  if (burst_mode == (0)){
   phy_tx_power_config((1));
...
# 383 "/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy_tx.c"
...
# 410 "/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy_tx.c"
int phy_tx_amp_setting(unchar amp_level)
{
 if((amp_level & 0xf0) != 0x0)
 {
  { if(gpPhyPriv->debugLevel & PHY_MSG_ERR) printk("[%lu]" "0ms" "[%s:%d]\n  " "error input : amp_level. \n" , jiffies, strrchr("/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy_tx.c", '/') + 1, 414) ; };
  return (1);
 }
 else
 {
  uint read_data = 0;
  uint write_data = 0;
  read_data = regReadPhy32((0xbfaf0100 +0x00A0));
  write_data = (read_data & 0xfff0ffff) | (amp_level << 16);
  iowrite32(write_data, (void *)((0xbfaf0100 +0x00A0)));
  return (0);
 }
}
# 438 "/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy_tx.c"
int phy_trans_tx_setting(PPHY_TransConfig_T trans_status)
{
 uint read_data = 0;
 uint write_data = 0;
 read_data = regReadPhy32((0xbfaf0100 +0x0038));
 if((trans_status->trans_tx_sd_inv_status == (1)) || (trans_status->trans_tx_sd_inv_status == (0)) )
  read_data = (read_data & 0xffffffef) | (trans_status->trans_tx_sd_inv_status << 4);
 else
  { if(gpPhyPriv->debugLevel & PHY_MSG_ERR) printk("[%lu]" "0ms" "[%s:%d]\n  " "error input : tx_sd_inv.\n" , jiffies, strrchr("/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy_tx.c", '/') + 1, 446) ; };

 if((trans_status->trans_burst_en_inv_status == (1)) || (trans_status->trans_burst_en_inv_status == (0)) )
  read_data = (read_data & 0xffffff7f) | (trans_status->trans_burst_en_inv_status<< 7);
 else
  { if(gpPhyPriv->debugLevel & PHY_MSG_ERR) printk("[%lu]" "0ms" "[%s:%d]\n  " "error input : burst_en_inv.\n" , jiffies, strrchr("/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy_tx.c", '/') + 1, 451) ; };

 if((trans_status->trans_tx_fault_inv_status == (1)) || (trans_status->trans_tx_fault_inv_status == (0)) )
  read_data = (read_data & 0xffffffdf) | (trans_status->trans_tx_fault_inv_status << 5);
 else
  { if(gpPhyPriv->debugLevel & PHY_MSG_ERR) printk("[%lu]" "0ms" "[%s:%d]\n  " "error input : tx_fault_inv.\n" , jiffies, strrchr("/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy_tx.c", '/') + 1, 456) ; };

 write_data = read_data;
 iowrite32(write_data, (void *)((0xbfaf0100 +0x0038)));
 return (0);
}
# 474 "/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy_tx.c"
...
# 505 "/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy_tx.c"
int phy_tx_alarm(void)
{
 ...
 uint return_value = PHY_TRANS_NO_ALARM;
  ...
  unchar ptr[1];
  ushort u2ByteCnt;
  phy_I2C_read(0, gpPhyPriv->i2c_u2_clk_div, 0x51, 1,0x70, ptr, 1);
  read_data = ptr[0];
 ...
 {
  { if(gpPhyPriv->debugLevel & PHY_MSG_DBG) printk("[%lu]" "0ms" "[%s:%d]\n  " "Tx power is below low alarm. \n" , jiffies, strrchr("/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy_tx.c", '/') + 1, 523) ; };
  return_value = return_value | PHY_TRANS_TX_LOW_POWER_ALARM;
 }

 if( (read_data & (0x02)) == 0x02 )
 {
  { if(gpPhyPriv->debugLevel & PHY_MSG_DBG) printk("[%lu]" "0ms" "[%s:%d]\n  " "Tx power exceeds high alarm. \n" , jiffies, strrchr("/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy_tx.c", '/') + 1, 529) ; };
  return_value = return_value | PHY_TRANS_TX_HIGH_POWER_ALARM;
 }

 if( (read_data & (0x04)) == 0x04 )
 {
  { if(gpPhyPriv->debugLevel & PHY_MSG_DBG) printk("[%lu]" "0ms" "[%s:%d]\n  " "Bias Current is below low alarm. \n" , jiffies, strrchr("/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy_tx.c", '/') + 1, 535) ; };
  return_value = return_value | PHY_TRANS_TX_LOW_CUR_ALARM;
 }

 if( (read_data & (0x08)) == 0x08 )
 {
  { if(gpPhyPriv->debugLevel & PHY_MSG_DBG) printk("[%lu]" "0ms" "[%s:%d]\n  " "Bias Current exceeds high alarm. \n" , jiffies, strrchr("/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy_tx.c", '/') + 1, 541) ; };
  return_value = return_value | PHY_TRANS_TX_HIGH_CUR_ALARM;
 }
 return return_value;
}
# 559 "/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy_tx.c"
int phy_tx_frame_counter(void)
{
 ...
 write_data = read_data | (1<<3);
 iowrite32(write_data, (void *)((0xbfaf0400 +0x0024)));
 read_data = regReadPhy32((0xbfaf0400 +0x0034));
 { if(gpPhyPriv->debugLevel & PHY_MSG_DBG) printk("[%lu]" "0ms" "[%s:%d]\n  " "Phy Tx Frame Counter : %.8x\n" , jiffies, strrchr("/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy_tx.c", '/') + 1, 568, read_data) ; };
 return read_data;



}
# 585 "/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy_tx.c"
int phy_tx_burst_counter(void)
{
 ...
 write_data = read_data | (1<<3);
 iowrite32(write_data, (void *)((0xbfaf0400 +0x0024)));
 read_data = regReadPhy32((0xbfaf0400 +0x0038));
 { if(gpPhyPriv->debugLevel & PHY_MSG_DBG) printk("[%lu]" "0ms" "[%s:%d]\n  " "Phy Tx Burst Counter : %.8x\n" , jiffies, strrchr("/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy_tx.c", '/') + 1, 594, read_data) ; };



}
# 610 "/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy_tx.c"
void phy_tx_test_pattern(uint pattern)
{
 ...
 {
  case 0x00 :
   iowrite32(0, (void *)((0xbfaf0400 +0x00A4)));
   iowrite32(pattern, (void *)((0xbfaf0400 +0x00A0)));
   break;
  case 0x01 :
  case 0x02 :
  case 0x03 :
  ...
  case 0x07 :
   iowrite32(pattern, (void *)((0xbfaf0400 +0x00A0)));
   iowrite32(1, (void *)((0xbfaf0400 +0x00A4)));
   break;
  case 0x0b:
   iowrite32(2, (void *)((0xbfaf0500 +0x0020)));
   iowrite32(1, (void *)((0xbfaf0500 +0x0010)));
   break;
  case 0x0c:
   iowrite32(0, (void *)((0xbfaf0400 +0x00A4)));
   iowrite32(0, (void *)((0xbfaf0400 +0x00A0)));
   iowrite32(0, (void *)((0xbfaf0500 +0x0020)));
   iowrite32(0, (void *)((0xbfaf0500 +0x0010)));
   read_data = regReadPhy32((0xbfaf0400 +0x002C))&0xfffffffd;
   write_data = (read_data|~0xfffffffd);
   iowrite32(write_data, (void *)((0xbfaf0400 +0x002C)));
   iowrite32(read_data, (void *)((0xbfaf0400 +0x002C)));
  default :
   iowrite32(0, (void *)((0xbfaf0400 +0x00A4)));
   iowrite32(0, (void *)((0xbfaf0400 +0x00A0)));
   break;
...
# 701 "/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy_tx.c"
int phy_byte_delay_manual(unchar byte_dly_en, unchar byte_dly)
{
 ...
 if(byte_dly_en == (1))
 {
  if((byte_dly & 0xfc) != 0x00)
  {
   { if(gpPhyPriv->debugLevel & PHY_MSG_ERR) printk("[%lu]" "0ms" "[%s:%d]\n  " "error input : byte dly. \n" , jiffies, strrchr("/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy_tx.c", '/') + 1, 709) ; };
   return (1);
  }
  read_data = regReadPhy32((0xbfaf0400 +0x0030));
  write_data = (read_data & 0xffffff8f) | (1<<4) | (byte_dly<<5);
  iowrite32(write_data, (void *)((0xbfaf0400 +0x0030)));
  { if(gpPhyPriv->debugLevel & PHY_MSG_DBG) printk("[%lu]" "0ms" "[%s:%d]\n  " "Byte delay manual enable setting success. \n" , jiffies, strrchr("/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy_tx.c", '/') + 1, 715) ; };
  return (0);
 }
 else if(byte_dly_en == (0))
 {
  read_data = regReadPhy32((0xbfaf0400 +0x0030));
  write_data = (read_data & 0xffffff8f);
  iowrite32(write_data, (void *)((0xbfaf0400 +0x0030)));
  { if(gpPhyPriv->debugLevel & PHY_MSG_DBG) printk("[%lu]" "0ms" "[%s:%d]\n  " "Byte delay manual disable setting success. \n" , jiffies, strrchr("/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy_tx.c", '/') + 1, 723) ; };
  return (0);
 }
 else
  return (1);
}
# 740 "/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy_tx.c"
int phy_tx_fec_manual(unchar tx_fec_en)
{
 ...
 {
  read_data = regReadPhy32((0xbfaf0400 +0x0030));
  write_data = (read_data & 0xfffffff3) | (1<<2) | (1<<3);
  iowrite32(write_data, (void *)((0xbfaf0400 +0x0030)));
  { if(gpPhyPriv->debugLevel & PHY_MSG_DBG) printk("[%lu]" "0ms" "[%s:%d]\n  " "Tx FEC manual enable setting success. \n" , jiffies, strrchr("/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy_tx.c", '/') + 1, 749) ; };
  return (0);
 }
 else if(tx_fec_en == (0))
 {
  read_data = regReadPhy32((0xbfaf0400 +0x0030));
  write_data = (read_data & 0xfffffff3);
  iowrite32(write_data, (void *)((0xbfaf0400 +0x0030)));
  { if(gpPhyPriv->debugLevel & PHY_MSG_DBG) printk("[%lu]" "0ms" "[%s:%d]\n  " "Tx FEC manual disable setting success. \n" , jiffies, strrchr("/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy_tx.c", '/') + 1, 757) ; };
  return (0);
 }
 else
  return (1);
...
void phy_tx_ctl(unchar val)
{
 if((1) == val)
  ...
  { if(gpPhyPriv->debugLevel & PHY_MSG_ERR) printk("[%lu]" "0ms" "[%s:%d]\n  " "PHY Tx ctl type error. \n" , jiffies, strrchr("/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy_tx.c", '/') + 1, 771) ; };
}
...
struct work_struct work_mt7570_safe_circuit_reset = { .data = { (WORK_STRUCT_NO_CPU | WORK_STRUCT_STATIC) }, .entry = { &(work_mt7570_safe_circuit_reset).entry, &(work_mt7570_safe_circuit_reset).entry }, .func = (mt7570_safe_circuit_reset_for_work_queue), };
# 793 "/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy_tx.c"
int phy_trans_power_switch(unchar trans_switch)
{
 ...
 if(mt7570_select == 1)
 {
        ...
        {
   phy_tx_ctl((0));
   { if(gpPhyPriv->debugLevel & PHY_MSG_DBG) printk("[%lu]" "0ms" "[%s:%d]\n  " "turn off transceiver power success! \n" , jiffies, strrchr("/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy_tx.c", '/') + 1, 809) ; };
            return (0);
        }
    ...
    if(mt7570_select==1 && ((void *)0) != i2c_access_queue){
     queue_work(i2c_access_queue, &work_mt7570_safe_circuit_reset);
    }

    { if(gpPhyPriv->debugLevel & PHY_MSG_DBG) printk("[%lu]" "0ms" "[%s:%d]\n  " "turn on transceiver power success! \n" , jiffies, strrchr("/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy_tx.c", '/') + 1, 821) ; };
             }
   return (0);
  }
  else
  {
   { if(gpPhyPriv->debugLevel & PHY_MSG_DBG) printk("[%lu]" "0ms" "[%s:%d]\n  " "setting transceiver power fail. \n" , jiffies, strrchr("/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy_tx.c", '/') + 1, 827) ; };
   return (1);
  }
# 845 "/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy_tx.c"
}
