...
static const struct usb_device_id option_ids[] = {
	...
	#ifdef TC_SUPPORT_3G 
	{ USB_DEVICE(0x19d2, 0x0039) },//For D-Link DWM-156 
	{ USB_DEVICE(0x19d2, 0x0117) },//For ZTE 190  
	{ USB_DEVICE(0x19d2, 0x1515) },//For ZTE 195 
	{ USB_DEVICE(0x12d1, 0x1c05) },//For HUAWEI E173s
	{ USB_DEVICE(0x07d1, 0x7e11) },//For D-Link 156
	{ USB_DEVICE(0x2020, 0x1005) },//for ASB W720
	{ USB_DEVICE(0x19d2, 0x0031) },//for ZTE MF110 MF636
	{ USB_DEVICE(0x1bbb, 0x0017) },//for ZTE MF110
	//{ USB_DEVICE(0x19d2, 0x1519) },//for ZTE MF192
	//{ USB_DEVICE(0x19d2, 0x0082) },//for ZTE MF190
	{ USB_DEVICE(0x19d2, 0x1209) },//white
	{ USB_DEVICE(0x19d2, 0x0104) },//for ZTE Vodafone
	{ USB_DEVICE(0x19d2, 0x0017) },//for pink
	#endif 
