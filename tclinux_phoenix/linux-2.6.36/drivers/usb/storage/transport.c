...
/*fht modules need jiffies ,so export this value */
unsigned int fiberhome_usbstorage_led_newjiffies = 0;
EXPORT_SYMBOL(fiberhome_usbstorage_led_newjiffies);
#endif
...
void usb_stor_invoke_transport(struct scsi_cmnd *srb, struct us_data *us)
{
	...
	int result;
#ifdef TCSUPPORT_XPON_HAL_API_EXT	
	fiberhome_usbstorage_led_newjiffies = jiffies;
#endif	
