# 1 "/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy.c"
# 1 "<built-in>"
# 1 "<命令行>"
...
# 7 "/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy.c" 2
...
# 15 "/opt/tclinux_phoenix/linux-2.6.36/arch/mips/include/asm/thread_info.h"
...
# 16 "/opt/tclinux_phoenix/linux-2.6.36/arch/mips/include/asm/thread_info.h" 2
...
# 8 "/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy.c" 2
...
# 9 "/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy.c" 2
...
# 11 "/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy.c" 2
...
# 47 "include/ecnt_hook/ecnt_hook.h" 2
...
static inline __attribute__((always_inline)) void ECNT_API_XPON_SN_SET(unsigned char sn[8])
{
...
# 15 "/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy.c" 2

# 1 "/opt/tclinux_phoenix/modules/private/xpon_phy/inc/phy_global.h" 1
...
extern int netdev_info(const struct net_device *dev, const char *format, ...)
 __attribute__ ((format (printf, 2, 3)));
# 7 "/opt/tclinux_phoenix/modules/private/xpon_phy/inc/phy_global.h" 2
...
# 8 "/opt/tclinux_phoenix/modules/private/xpon_phy/inc/phy_global.h" 2
...
# 11 "/opt/tclinux_phoenix/modules/private/xpon_phy/inc/phy_global.h" 2
# 1 "/opt/tclinux_phoenix/modules/private/xpon_phy/inc/phy.h" 1
...
# 6 "/opt/tclinux_phoenix/modules/private/xpon_phy/inc/phy.h" 2

# 1 "/opt/tclinux_phoenix/modules/private/xpon_phy/inc/phy_def.h" 1
...
# 4 "/opt/tclinux_phoenix/modules/private/xpon_phy/inc/phy_def.h" 2




# 1 "/opt/tclinux_phoenix/modules/private/xpon_phy/inc/phy_reg.h" 1



# 1 "/opt/tclinux_phoenix/modules/private/xpon_phy/inc/phy_reg_util.h" 1




# 1 "/opt/tclinux_phoenix/modules/private/xpon_phy/inc/i2c.h" 1
# 107 "/opt/tclinux_phoenix/modules/private/xpon_phy/inc/i2c.h"
int i2c_init(void) ;
void i2c_exit(void) ;
...
# 6 "/opt/tclinux_phoenix/modules/private/xpon_phy/inc/phy_reg_util.h" 2
# 50 "/opt/tclinux_phoenix/modules/private/xpon_phy/inc/phy_reg_util.h"
...
# 74 "/opt/tclinux_phoenix/modules/private/xpon_phy/inc/phy_reg_util.h"
...
# 87 "/opt/tclinux_phoenix/modules/private/xpon_phy/inc/phy_reg_util.h"
...
# 5 "/opt/tclinux_phoenix/modules/private/xpon_phy/inc/phy_reg.h" 2
# 9 "/opt/tclinux_phoenix/modules/private/xpon_phy/inc/phy_def.h" 2
# 331 "/opt/tclinux_phoenix/modules/private/xpon_phy/inc/phy_def.h"
typedef enum {
...
# 367 "/opt/tclinux_phoenix/modules/private/xpon_phy/inc/phy_def.h"
typedef struct
{
...
# 8 "/opt/tclinux_phoenix/modules/private/xpon_phy/inc/phy.h" 2
...
static inline __attribute__((always_inline)) void XPON_MAC_EVENT_HANDLER(PON_PHY_Event_data_t * pEvent)
{
    struct xpon_mac_hook_data_s data = {0} ;
...
static inline __attribute__((always_inline)) void REPORT_EVENT_TO_MAC(PHY_Event_Type_t id)
{
...
# 12 "/opt/tclinux_phoenix/modules/private/xpon_phy/inc/phy_global.h" 2



extern PHY_GlbPriv_T *gpPhyPriv ;
# 17 "/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy.c" 2
# 1 "/opt/tclinux_phoenix/modules/private/xpon_phy/inc/i2c.h" 1
# 18 "/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy.c" 2
# 1 "/opt/tclinux_phoenix/modules/private/xpon_phy/inc/phy.h" 1
# 19 "/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy.c" 2
# 1 "/opt/tclinux_phoenix/modules/private/xpon_phy/inc/phy_def.h" 1
# 20 "/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy.c" 2
# 1 "/opt/tclinux_phoenix/modules/private/xpon_phy/inc/phy_api.h" 1





# 1 "/opt/tclinux_phoenix/modules/private/xpon_phy/inc/phy_types.h" 1
# 16 "/opt/tclinux_phoenix/modules/private/xpon_phy/inc/phy_types.h"
typedef unsigned int UINT32 ;
typedef unsigned short UINT16 ;
typedef unsigned char UINT8 ;

typedef unsigned int FIELD;
# 7 "/opt/tclinux_phoenix/modules/private/xpon_phy/inc/phy_api.h" 2
...
# 21 "/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy.c" 2
# 1 "/opt/tclinux_phoenix/modules/private/xpon_phy/inc/phy_debug.h" 1
...
# 49 "/opt/tclinux_phoenix/modules/private/xpon_phy/inc/phy_debug.h"
extern int xpon_phy_print_open;
# 22 "/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy.c" 2
# 1 "/opt/tclinux_phoenix/modules/private/xpon_phy/inc/mt7570_reg.h" 1
# 23 "/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy.c" 2
# 1 "/opt/tclinux_phoenix/modules/private/xpon_phy/inc/mt7570_def.h" 1
# 24 "/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy.c" 2
...
void ledTask(void);
# 26 "/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy.c" 2


# 1 "/opt/tclinux_phoenix/modules/private/xpon_phy/inc/phy_init.h" 1




# 1 "/opt/tclinux_phoenix/modules/private/xpon_phy/inc/phy_global.h" 1
# 6 "/opt/tclinux_phoenix/modules/private/xpon_phy/inc/phy_init.h" 2
...
static inline __attribute__((always_inline)) int is_phy_sync(void)
{
    return ((phy_ready_status() == (1)) && (phy_los_status() == (0x00)) );
}

static inline __attribute__((always_inline)) int get_phy_mode(void)
{
    return gpPhyPriv->phyCfg.flags.mode ;
}

extern struct workqueue_struct * i2c_access_queue;
# 29 "/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy.c" 2

# 1 "/opt/tclinux_phoenix/modules/private/xpon_phy/inc/phy_tx.h" 1
# 47 "/opt/tclinux_phoenix/modules/private/xpon_phy/inc/phy_tx.h"
...
# 31 "/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy.c" 2
...
extern int mt7570_version;
int phy_version = 103;
extern int phy_date_version;
...
# 118 "/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy.c"
extern int los_status;
# 130 "/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy.c"
void phy_counter_clear(unchar counter_type)
{
 uint read_data = 0;
 uint write_data = 0;
 if((counter_type & PHY_ERR_CNT_CLR)== PHY_ERR_CNT_CLR)
  iowrite32((1<<1), (void *)((0xbfaf0200 +0x0034)));
 if((counter_type & PHY_BIP_CNT_CLR)== PHY_BIP_CNT_CLR)
  iowrite32((1<<3), (void *)((0xbfaf0200 +0x0034)));
 if((counter_type & PHY_RXFRAME_CNT_CLR)== PHY_RXFRAME_CNT_CLR)
  iowrite32((1<<5), (void *)((0xbfaf0200 +0x0034)));

 if((counter_type & PHY_TXFRAME_CNT_CLR)== PHY_TXFRAME_CNT_CLR)
 {
  read_data = regReadPhy32((0xbfaf0400 +0x0024));
  write_data = read_data | (1<<2);
  iowrite32(write_data, (void *)((0xbfaf0400 +0x0024)));
 }

 if((counter_type & PHY_EPON_ERR_CNT_CLR)== PHY_EPON_ERR_CNT_CLR)
  iowrite32((1<<4), (void *)((0xbfaf0200 +0x0098)));


}
# 187 "/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy.c"
void phy_int_enable(uint int_mask)
{
 uint write_data = 0;
 uint read_data = 0;
 read_data = regReadPhy32((0xbfaf0500 +0x00F0));
 write_data = (read_data & 0xFF ) | (int_mask & 0xFF ) ;

 iowrite32(write_data, (void *)((0xbfaf0500 +0x00F0))) ;
}
...
void phy_int_disable(uint int_mask)
{
 ...
 iowrite32((int_mask & 0xFF ), (void *)((0xbfaf0500 +0x00F4))) ;
...
# 220 "/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy.c"
int phy_int_config(uint int_type)
{
 uint write_data = 0;
 uint read_data = 0;
 ...
 { if(gpPhyPriv->debugLevel & PHY_MSG_DBG) printk("[%lu]" "0ms" "[%s:%d]\n  " "Phy_Int_Config read_data:0x%.8x\n" , jiffies, strrchr("/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy.c", '/') + 1, 227, read_data) ; };
 { if(gpPhyPriv->debugLevel & PHY_MSG_DBG) printk("[%lu]" "0ms" "[%s:%d]\n  " "Phy_Int_Config write_data:0x%.8x\n" , jiffies, strrchr("/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy.c", '/') + 1, 228, write_data) ; };
 iowrite32(write_data, (void *)((0xbfaf0500 +0x00F0)));
 return (0);
}
# 244 "/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy.c"
int phy_int_getting(void)
{
 return regReadPhy32((0xbfaf0500 +0x00F0));
}
# 261 "/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy.c"
unchar phy_gpon_mode(void)
{
 uint read_data ;

 read_data = regReadPhy32((0xbfaf0100 +0x0024)) ;
 return ((read_data&(1<<31)) ? 1 : 0) ;
}
# 279 "/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy.c"
int phy_mode_config(Xpon_Phy_Mode_t xpon_mode, int tx_enable)
{
 uint write_data = 0 ;
 uint read_data = 0 ;
 ...
 if(xpon_mode == PHY_GPON_CONFIG) {
  ...
  read_data = regReadPhy32((0xbfaf0100 +0x0008)) ;
  write_data = read_data & 0xffffffdf;
  iowrite32(write_data, (void *)((0xbfaf0100 +0x0008)));
...
# 387 "/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy.c"
int phy_set_epon_ts_continue_mode(uint mode)
{
 uint read_data = 0;
 ...
 if (mode == (1))
 {
  read_data = regReadPhy32((0xbfaf0100 +0x0024));
  read_data |= (0x01 << 26);
  iowrite32(read_data, (void *)((0xbfaf0100 +0x0024)));
 }
 else if (mode == (0))
 {
  read_data = regReadPhy32((0xbfaf0100 +0x0024));
...
# 418 "/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy.c"
ushort phy_round_trip_delay_sof(void)
{
   uint read_data = 0;
   ushort round_trip_delay_sof=0;

   read_data = regReadPhy32((0xbfaf0200 +0x00D4));
...
int eponMode_phy_reset(void)
{
 ...
 read_data = ioread32((void *)(0xbfbf0204));



 { if(gpPhyPriv->debugLevel & PHY_MSG_DBG) printk("[%lu]" "0ms" "[%s:%d]\n  " "eponMode_phy_reset 1:isPowerDisable = %d,read_data=0x%.8x\n" , jiffies, strrchr("/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy.c", '/') + 1, 444, isPowerDisable,read_data) ; } ;
 ...
 if(mt7570_select == 1)
  ...
  tmp_data = (1<<25);
# 461 "/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy.c"
 ...
 {
  isPowerDisable = 1;
  { if(gpPhyPriv->debugLevel & PHY_MSG_DBG) printk("[%lu]" "0ms" "[%s:%d]\n  " "eponMode_phy_reset:isPowerDisable = %d\n" , jiffies, strrchr("/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy.c", '/') + 1, 471, isPowerDisable) ; } ;
 }



 phy_trans_power_switch((0));
 { if(gpPhyPriv->debugLevel & PHY_MSG_DBG) printk("[%lu]" "0ms" "[%s:%d]\n  " "eponMode_phy_reset 1:isPowerDisable = %d,read_data=0x%.8x\n" , jiffies, strrchr("/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy.c", '/') + 1, 477, isPowerDisable,read_data) ; } ;
 ...
 if(isPowerDisable == 0){
  ...
  phy_trans_power_switch((1));
  { if(gpPhyPriv->debugLevel & PHY_MSG_DBG) printk("[%lu]" "0ms" "[%s:%d]\n  " "eponMode_phy_reset 1:isPowerDisable = %d,read_data=0x%.8x\n" , jiffies, strrchr("/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy.c", '/') + 1, 510, isPowerDisable,read_data) ; } ;
 }else if (gpPhyPriv->phyCfg.flags.txPowerEnFlag == 1)
 {
  phy_trans_power_switch((1));
  { if(gpPhyPriv->debugLevel & PHY_MSG_DBG) printk("[%lu]" "0ms" "[%s:%d]\n  " "eponMode_phy_reset 1:isPowerDisable = %d,read_data=0x%.8x\n" , jiffies, strrchr("/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy.c", '/') + 1, 514, isPowerDisable,read_data) ; } ;
 }

 return (0) ;
}
# 531 "/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy.c"
int phy_ready_status(void)
{
  uint read_data = 0;
  read_data = regReadPhy32((0xbfaf0100 +0x0030));
  if(((read_data >> 18) & 0x07) == 0x06)
  {
...
# 558 "/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy.c"
int phy_los_status(void)
{
  uint read_data = 0;
  read_data = regReadPhy32((0xbfaf0500 +0x00E0));
  if( (read_data & 0x01) == 0x01)
  {
   { if(gpPhyPriv->debugLevel & PHY_MSG_DBG) printk("[%lu]" "0ms" "[%s:%d]\n  " "Phy LOS. \n" , jiffies, strrchr("/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy.c", '/') + 1, 564) ; };
   return (0x01);
  }
  else
  {
...
# 588 "/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy.c"
int phy_lof_status(void)
{
 uint read_data = 0;
 read_data = regReadPhy32((0xbfaf0500 +0x00F0));
 if((read_data & 0x02) != 0x02)
 {
  { if(gpPhyPriv->debugLevel & PHY_MSG_DBG) printk("[%lu]" "0ms" "[%s:%d]\n  " "LOF Interrupt is not turned on. \n" , jiffies, strrchr("/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy.c", '/') + 1, 594) ; };
  return (0);
 }
 else
 {
  read_data = regReadPhy32((0xbfaf0500 +0x00F8));
  if((read_data & 0x02) == 0x02)
  {
   { if(gpPhyPriv->debugLevel & PHY_MSG_DBG) printk("[%lu]" "0ms" "[%s:%d]\n  " "Phy LOF. \n" , jiffies, strrchr("/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy.c", '/') + 1, 602) ; };
   return (1);
  }
  else
  {
   { if(gpPhyPriv->debugLevel & PHY_MSG_DBG) printk("[%lu]" "0ms" "[%s:%d]\n  " "Phy not LOF. \n" , jiffies, strrchr("/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy.c", '/') + 1, 607) ; };
   return (0);
  }
 }

}
# 624 "/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy.c"
int phy_reset_counter(void)
{
# 641 "/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy.c"
 uint read_data = 0;
 uint write_data = 0;
  iowrite32((1<<1), (void *)((0xbfaf0200 +0x0034)));
  iowrite32((1<<3), (void *)((0xbfaf0200 +0x0034)));
...
# 670 "/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy.c"
int phy_cnt_enable(unchar errcnt_en, unchar bipcnt_en, unchar fmcnt_en)
{
 uint write_data = 0;
 uint read_data = 0;
 uint clear_type = 0;
 read_data = regReadPhy32((0xbfaf0200 +0x0030));
 ...
 __udelay(1);
 iowrite32(write_data, (void *)((0xbfaf0200 +0x0030)));
 phy_counter_clear(clear_type);
 return (0);
}
# 714 "/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy.c"
...
# 742 "/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy.c"
 ...
 {"MENTECHOPTO", "NOE22-LD6C-NT", 0x1cf},
 {"SUPERXON LTD.", "SOEB3466-FSGF", 0x1cf},
 {"EOPTOLINK INC", "EOLF-GUA-25-DZTE", 0x14f},
 {"MENTECHOPTO", "NOG22-D6C-ND", 0x14f},
 {"SUPERXON LTD.", "SOGP3412-FSGA", 0x14f},
 {"SUPERXON LTD.", "SOEB3466-FUGF", 0x1cf},
 {"WTD", "RTXM167-407", 0x1cf},
        {"XUGUANG LTD.", "XTEC3411F-C", 0x1cf},
 {"XUGUANG LTD.", "XTGP3434FRS-A", 0x14f},
 ...
 {"T&W", "TW2362G-CDEH", 0x10f},
 {"EOPTOLINK INC", "EOLF-GEUA-25-D1A", 0x1cf},
 {"Q-STAR", "BYFS-462A4-HB-12", 0x14f},
 {"Q-STAR", "BYFS-44234-LB-12", 0x1cf},
 {"MENTECHOPTO", "NOG22-D6C-SD", 0x14f},
 {"MENTECHOPTO", "NOE22-LD6C-SD", 0x1cf},
 {"MENTECHOPTO", "NOG22-LD6C-ST", 0x14f},
 {"MENTECHOPTO", "NOE22-LD6C-ST", 0x1cf},
 {"FIBERTOWER", "FEU3411S-2DC-0C", 0x1cf},
...
void phy_trans_model_setting(void)
{
 ...
 static unchar vendor_id[16 +1]={0};
 static unchar vendor_pn[16 +1]={0};



 struct phy_trans_bsten_info *pTrans = ((void *)0);


 if ( (strlen(vendor_id) == 0)
  && (strlen(vendor_pn) == 0))
 {
  phy_I2C_read(0, gpPhyPriv->i2c_u2_clk_div, 0x50, 1, 0x14 , vendor_id, 16);
  phy_I2C_read(0, gpPhyPriv->i2c_u2_clk_div, 0x50, 1, 0x28 , vendor_pn, 16);
  vendor_pn[16]='\0';
  vendor_id[16]='\0';
 ...
 while (strcmp(pTrans->vendor_id, "") != 0){
  if ((strncmp(pTrans->vendor_id, vendor_id, (((strlen(pTrans->vendor_id))>(strlen(vendor_id)))?(strlen(pTrans->vendor_id)):(strlen(vendor_id)))) == 0) &&
   (strncmp(pTrans->vendor_pn, vendor_pn, (((strlen(pTrans->vendor_pn))>(strlen(vendor_pn)))?(strlen(pTrans->vendor_pn)):(strlen(vendor_pn)))) == 0)){
   if(disp!=0)
    printk("Match Vendor\n");
   iowrite32(pTrans->phy_csr_xpon_val, (void *)((0xbfaf0100 +0x0038)));
# 841 "/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy.c"
   break;
  }
  pTrans ++;
 }
# 869 "/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy.c"
 }
}
# 886 "/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy.c"
...

{
  ...
  phy_I2C_read(0, gpPhyPriv->i2c_u2_clk_div, 0x51, 1, 0x60, transceiver_param, sizeof(PHY_TransParam_T));
# 955 "/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy.c"
}
# 967 "/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy.c"
void phy_trans_alarm_getting(PPHY_TransAlarm_T transceiver_alarm)
{
  ...
  phy_I2C_read(0, gpPhyPriv->i2c_u2_clk_div, 0x51, 1, 0x20, ptr, 2);
   transceiver_alarm->rx_power_high_alarm_thod = (ptr[1] | (ptr[0]<<8));

  phy_I2C_read(0, gpPhyPriv->i2c_u2_clk_div, 0x51, 1, 0x22, ptr, 2);
   transceiver_alarm->rx_power_low_alarm_thod = (ptr[1] | (ptr[0]<<8));

  phy_I2C_read(0, gpPhyPriv->i2c_u2_clk_div, 0x51, 1, 0x18, ptr, 2);
   transceiver_alarm->tx_power_high_alarm_thod = (ptr[1] | (ptr[0]<<8));

  phy_I2C_read(0, gpPhyPriv->i2c_u2_clk_div, 0x51, 1, 0x1A, ptr, 2);
   transceiver_alarm->tx_power_low_alarm_thod = (ptr[1] | (ptr[0]<<8));
# 1016 "/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy.c"
   { if(gpPhyPriv->debugLevel & PHY_MSG_DBG) printk("[%lu]" "0ms" "[%s:%d]\n  " "rx power high alarm threshold: %.8x\n" , jiffies, strrchr("/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy.c", '/') + 1, 1016, transceiver_alarm->rx_power_high_alarm_thod) ; };
   { if(gpPhyPriv->debugLevel & PHY_MSG_DBG) printk("[%lu]" "0ms" "[%s:%d]\n  " "rx power low alarm threshold: %.8x\n" , jiffies, strrchr("/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy.c", '/') + 1, 1017, transceiver_alarm->rx_power_low_alarm_thod) ; };
   { if(gpPhyPriv->debugLevel & PHY_MSG_DBG) printk("[%lu]" "0ms" "[%s:%d]\n  " "tx power high alarm threshold: %.8x\n" , jiffies, strrchr("/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy.c", '/') + 1, 1018, transceiver_alarm->tx_power_high_alarm_thod) ; };
   { if(gpPhyPriv->debugLevel & PHY_MSG_DBG) printk("[%lu]" "0ms" "[%s:%d]\n  " "rx power low alarm threshold: %.8x\n" , jiffies, strrchr("/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy.c", '/') + 1, 1019, transceiver_alarm->tx_power_low_alarm_thod) ; };
# 1031 "/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy.c"
}
# 1044 "/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy.c"
int phy_bit_delay(unchar delay_value)
{
 uint write_data = 0;
 uint read_data = 0;
 ...
 {
# 1066 "/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy.c"
  read_data = regReadPhy32((0xbfaf0100 +0x0010));
  write_data = (read_data & 0xff87ffff) | (delay_value << 19) | (1<<23);
  iowrite32(write_data, (void *)((0xbfaf0100 +0x0010)));
  return (0);

 }
 else
 {
  { if(gpPhyPriv->debugLevel & PHY_MSG_DBG) printk("[%lu]" "0ms" "[%s:%d]\n  " "error input : delay_value. \n" , jiffies, strrchr("/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy.c", '/') + 1, 1074) ; };
  return (1);
 }
}
# 1090 "/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy.c"
void phy_calibration_test(void)
{
 ...
 for(index; index<100; index++)
 {
  ...
  iowrite32(write_data, (void *)((0xbfaf0100 +0x0008)));
  iowrite32(read_data, (void *)((0xbfaf0100 +0x0008)));
  { if(gpPhyPriv->debugLevel & PHY_MSG_ERR) printk("[%lu]" "0ms" "[%s:%d]\n  " "GPON calibration done. \n" , jiffies, strrchr("/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy.c", '/') + 1, 1104) ; };
  read_data = regReadPhy32((0xbfaf0100 +0x0044));
  { if(gpPhyPriv->debugLevel & PHY_MSG_ERR) printk("[%lu]" "0ms" "[%s:%d]\n  " "VCO calibration output : tx[15:8]: %.8x\n" , jiffies, strrchr("/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy.c", '/') + 1, 1106, (read_data & 0xff00)>>8) ; };
  { if(gpPhyPriv->debugLevel & PHY_MSG_ERR) printk("[%lu]" "0ms" "[%s:%d]\n  " "VCO calibration output : rx[7:0]: %.8x\n" , jiffies, strrchr("/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy.c", '/') + 1, 1107, (read_data & 0xff)) ; };
  { if(gpPhyPriv->debugLevel & PHY_MSG_ERR) printk("[%lu]" "0ms" "[%s:%d]\n  " "PI calibration output : %.8x\n" , jiffies, strrchr("/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy.c", '/') + 1, 1108, (read_data & 0xff0000)>>16) ; };
  read_data = regReadPhy32((0xbfaf0100 +0x0040));
  { if(gpPhyPriv->debugLevel & PHY_MSG_ERR) printk("[%lu]" "0ms" "[%s:%d]\n  " "imp calibration output : tx[4:0]: %.8x\n" , jiffies, strrchr("/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy.c", '/') + 1, 1110, (read_data & 0x1f)) ; };
  { if(gpPhyPriv->debugLevel & PHY_MSG_ERR) printk("[%lu]" "0ms" "[%s:%d]\n  " "imp calibration output : rx[12:8]: %.8x\n" , jiffies, strrchr("/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy.c", '/') + 1, 1111, (read_data & 0x1f00)>>8) ; };
  { if(gpPhyPriv->debugLevel & PHY_MSG_ERR) printk("[%lu]" "0ms" "[%s:%d]\n  " "SQTH calibration output[19:16]: %.8x\n" , jiffies, strrchr("/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy.c", '/') + 1, 1112, (read_data & 0xf0000)>>16) ; };

  read_data = regReadPhy32((0xbfaf0100 +0x002C));


  read_data = regReadPhy32((0xbfaf0100 +0x00F4));
  { if(gpPhyPriv->debugLevel & PHY_MSG_ERR) printk("[%lu]" "0ms" "[%s:%d]\n  " "TDC calibration output : gain[10:0]: %.8x\n" , jiffies, strrchr("/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy.c", '/') + 1, 1118, (read_data & 0x7ff)) ; };
  { if(gpPhyPriv->debugLevel & PHY_MSG_ERR) printk("[%lu]" "0ms" "[%s:%d]\n  " "TDC calibration output : offset[21:11]: %.8x\n" , jiffies, strrchr("/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy.c", '/') + 1, 1119, (read_data & 0x3ff800)>>11) ; };
  msleep(1);
  read_data = regReadPhy32((0xbfaf0100 +0x0024));
  write_data = read_data & ~((1<<31));
  iowrite32(write_data, (void *)((0xbfaf0100 +0x0024)));
  ...
  iowrite32(write_data, (void *)((0xbfaf0100 +0x0008)));
  iowrite32(read_data, (void *)((0xbfaf0100 +0x0008)));
  { if(gpPhyPriv->debugLevel & PHY_MSG_ERR) printk("[%lu]" "0ms" "[%s:%d]\n  " "EPON calibration done. \n" , jiffies, strrchr("/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy.c", '/') + 1, 1128) ; };
  read_data = regReadPhy32((0xbfaf0100 +0x0044));
  { if(gpPhyPriv->debugLevel & PHY_MSG_ERR) printk("[%lu]" "0ms" "[%s:%d]\n  " "VCO calibration output : tx[15:8]: %.8x\n" , jiffies, strrchr("/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy.c", '/') + 1, 1130, (read_data & 0xff00)>>8) ; };
  { if(gpPhyPriv->debugLevel & PHY_MSG_ERR) printk("[%lu]" "0ms" "[%s:%d]\n  " "VCO calibration output : rx[7:0]: %.8x\n" , jiffies, strrchr("/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy.c", '/') + 1, 1131, (read_data & 0xff)) ; };
  { if(gpPhyPriv->debugLevel & PHY_MSG_ERR) printk("[%lu]" "0ms" "[%s:%d]\n  " "PI calibration output : %.8x\n" , jiffies, strrchr("/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy.c", '/') + 1, 1132, (read_data & 0xff0000)>>16) ; };
  read_data = regReadPhy32((0xbfaf0100 +0x0040));
  { if(gpPhyPriv->debugLevel & PHY_MSG_ERR) printk("[%lu]" "0ms" "[%s:%d]\n  " "imp calibration output : tx[4:0]: %.8x\n" , jiffies, strrchr("/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy.c", '/') + 1, 1134, (read_data & 0x1f)) ; };
  { if(gpPhyPriv->debugLevel & PHY_MSG_ERR) printk("[%lu]" "0ms" "[%s:%d]\n  " "imp calibration output : rx[12:8]: %.8x\n" , jiffies, strrchr("/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy.c", '/') + 1, 1135, (read_data & 0x1f00)>>8) ; };
  { if(gpPhyPriv->debugLevel & PHY_MSG_ERR) printk("[%lu]" "0ms" "[%s:%d]\n  " "SQTH calibration output[19:16]: %.8x\n" , jiffies, strrchr("/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy.c", '/') + 1, 1136, (read_data & 0xf0000)>>16) ; };

  read_data = regReadPhy32((0xbfaf0100 +0x002C));
  { if(gpPhyPriv->debugLevel & PHY_MSG_ERR) printk("[%lu]" "0ms" "[%s:%d]\n  " "snese amp calibration output : DCD[6:0]: %.8x\n" , jiffies, strrchr("/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy.c", '/') + 1, 1139, (read_data & 0x7f)) ; };
  { if(gpPhyPriv->debugLevel & PHY_MSG_ERR) printk("[%lu]" "0ms" "[%s:%d]\n  " "snese amp calibration output : DCE[14:8]: %.8x\n" , jiffies, strrchr("/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy.c", '/') + 1, 1140, (read_data & 0x7f00)>>8) ; };
  { if(gpPhyPriv->debugLevel & PHY_MSG_ERR) printk("[%lu]" "0ms" "[%s:%d]\n  " "snese amp calibration output : DCEYE[22:16]: %.8x\n" , jiffies, strrchr("/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy.c", '/') + 1, 1141, (read_data & 0x7f0000)>>16) ; };

  read_data = regReadPhy32((0xbfaf0100 +0x00F4));
  { if(gpPhyPriv->debugLevel & PHY_MSG_ERR) printk("[%lu]" "0ms" "[%s:%d]\n  " "TDC calibration output : gain[10:0]: %.8x\n" , jiffies, strrchr("/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy.c", '/') + 1, 1144, (read_data & 0x7ff)) ; };
  { if(gpPhyPriv->debugLevel & PHY_MSG_ERR) printk("[%lu]" "0ms" "[%s:%d]\n  " "TDC calibration output : offset[21:11]: %.8x\n" , jiffies, strrchr("/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy.c", '/') + 1, 1145, (read_data & 0x3ff800)>>11) ; };
  msleep(1);
 }
...
void phy_pbus_stress_test(void)
{
 ...
 original[0] = write_bank_data[0] = read_bank_data[0] = regReadPhy32((0xbfaf0100 +0x0064));
 original[1] = write_bank_data[1] = read_bank_data[1] = regReadPhy32((0xbfaf0200 +0x0000));
 original[2] = write_bank_data[2] = read_bank_data[2] = regReadPhy32((0xbfaf0300 +0x00A0));
 original[3] = write_bank_data[3] = read_bank_data[3] = regReadPhy32((0xbfaf0400 +0x0000));
 original[4] = write_bank_data[4] = read_bank_data[4] = regReadPhy32((0xbfaf0500 +0x0034));
 phyreg[0]=(0xbfaf0100 +0x0064);
 phyreg[1]=(0xbfaf0200 +0x0000);
 phyreg[2]=(0xbfaf0300 +0x00A0);
 phyreg[3]=(0xbfaf0400 +0x0000);
 phyreg[4]=(0xbfaf0500 +0x0034);
 ...
 for(index; index < 100000 ; index++)
 {
  ...
  {
   read_bank_data[bank_select1] = regReadPhy32(phyreg[bank_select1]);
  }
  else
  {
   iowrite32(write_bank_data[bank_select1], (void *)(phyreg[bank_select1]));
  }
  if(read_write_index2 == 0)
  {
   read_bank_data[bank_select2] = regReadPhy32(phyreg[bank_select2]);
  }
  else
  {
   iowrite32(write_bank_data[bank_select2], (void *)(phyreg[bank_select2]));
  }
 }
...
# 1239 "/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy.c"
int phy_fw_ready(unchar fwrdy_en)
{

 uint read_data = 0;
 uint write_data = 0;
 read_data = regReadPhy32((0xbfaf0100 +0x0004));
 if(fwrdy_en == (1))
  ...
  return (1);
 { if(gpPhyPriv->debugLevel & PHY_MSG_DBG) printk("[%lu]" "0ms" "[%s:%d]\n  " "Phy_Fw_Ready function success. \n" , jiffies, strrchr("/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy.c", '/') + 1, 1251) ; };

 iowrite32(write_data, (void *)((0xbfaf0100 +0x0004)));


 return (0);
}
# 1271 "/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy.c"
int phy_freq_meter(unchar freq_en, unchar freq_sele)
{
 uint read_data = 0;
 uint write_data = 0;
 if((freq_en == (1)))
 {
  if((freq_sele & 0xf0) != 0x00)
  {
   { if(gpPhyPriv->debugLevel & PHY_MSG_ERR) printk("[%lu]" "0ms" "[%s:%d]\n  " "error input : freq_sele. \n" , jiffies, strrchr("/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy.c", '/') + 1, 1279) ; };
   return (1);
  }
  read_data = regReadPhy32((0xbfaf0100 +0x0008));
  write_data = read_data & ~((1<<24));
  iowrite32(write_data, (void *)((0xbfaf0100 +0x0008)));
  read_data = regReadPhy32((0xbfaf0100 +0x0028));
  read_data = read_data & 0xf0ffffff;
  write_data = read_data | (freq_sele << 24);
  iowrite32(write_data, (void *)((0xbfaf0100 +0x0028)));
  write_data = read_data & ~((1<<16)) | ((1<<16)) ;
  iowrite32(write_data, (void *)((0xbfaf0100 +0x0028)));
  do
  {
   read_data = regReadPhy32((0xbfaf0100 +0x004C));
  }while( (read_data & (1<<16)) == (1<<16));
  if((read_data & (1<<16)) == (1<<16))
  {
   { if(gpPhyPriv->debugLevel & PHY_MSG_DBG) printk("[%lu]" "0ms" "[%s:%d]\n  " "Phy Freq Meter enable success. \n" , jiffies, strrchr("/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy.c", '/') + 1, 1297) ; };
   read_data = regReadPhy32((0xbfaf0100 +0x0028));
   read_data = read_data & (0x7fff);
   { if(gpPhyPriv->debugLevel & PHY_MSG_DBG) printk("[%lu]" "0ms" "[%s:%d]\n  " "freq meter result : 0x%.8x\n" , jiffies, strrchr("/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy.c", '/') + 1, 1300, read_data) ; };
   return (0);
  }
 ...
 {
  read_data = regReadPhy32((0xbfaf0100 +0x0008));
  write_data = read_data & ~((1<<24)) | ((1<<24));
  iowrite32(write_data, (void *)((0xbfaf0100 +0x0008)));
  read_data = regReadPhy32((0xbfaf0100 +0x0028));
  write_data = read_data & ~((1<<16));
  iowrite32(write_data, (void *)((0xbfaf0100 +0x0028)));
  { if(gpPhyPriv->debugLevel & PHY_MSG_DBG) printk("[%lu]" "0ms" "[%s:%d]\n  " "Phy Freq Meter disable success. \n" , jiffies, strrchr("/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy.c", '/') + 1, 1319) ; };
  return (0);
 }
 else
  return (1);
}
# 1336 "/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy.c"
void pon_phy_status (void)
{
uint read_data = 0;
unchar ptr[4];
unchar vendor_id[16 +1];
unchar vendor_pn[16 +1];
  ...
  read_data = regReadPhy32((0xbfaf0200 +0x001C));
...
# 1431 "/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy.c"
void pon_register (int regsiter)
{
 uint read_data = 0;
 read_data = regReadPhy32(regsiter);
 printk("0x%x = 0x%x \n",regsiter,read_data);

}
# 1451 "/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy.c"
void phy_eye_monitor(ushort eye_cnt, unchar step, int offset)
{
 ...
 int x_buffer = 0;
 pon_phy_deinit();
 read_data = regReadPhy32((0xbfaf0100 +0x001C));
 { if(gpPhyPriv->debugLevel & PHY_MSG_DBG) printk("[%lu]" "0ms" "[%s:%d]\n  " "eye register 0x11C read_data :0x%.8x\n" , jiffies, strrchr("/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy.c", '/') + 1, 1459, read_data) ; };
 read_data = (read_data & 0xffff0000) | eye_cnt;
 read_data = (read_data & ~((1<<27))) | (1<<27);
 write_data = read_data;
 { if(gpPhyPriv->debugLevel & PHY_MSG_DBG) printk("[%lu]" "0ms" "[%s:%d]\n  " "eye register 0x11C write_data :0x%.8x\n" , jiffies, strrchr("/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy.c", '/') + 1, 1463, write_data) ; };
 iowrite32(write_data, (void *)((0xbfaf0100 +0x001C)));
 read_data = regReadPhy32((0xbfaf0100 +0x0010));
 { if(gpPhyPriv->debugLevel & PHY_MSG_DBG) printk("[%lu]" "0ms" "[%s:%d]\n  " "eye register 0x110 read_data :0x%.8x\n" , jiffies, strrchr("/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy.c", '/') + 1, 1466, read_data) ; };
 write_data = (read_data & ~((1<<11))) | ((1<<11));
 msleep(1);
 { if(gpPhyPriv->debugLevel & PHY_MSG_DBG) printk("[%lu]" "0ms" "[%s:%d]\n  " "eye register 0x110 write_data :0x%.8x\n" , jiffies, strrchr("/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy.c", '/') + 1, 1469, write_data) ; };
 iowrite32(write_data, (void *)((0xbfaf0100 +0x0010)));
 ...
 for (x_axis = 64 ; x_axis > (0 - offset) ; x_axis = x_axis - step)
 {
  ...
  read_data = regReadPhy32((0xbfaf0100 +0x002C));
  { if(gpPhyPriv->debugLevel & PHY_MSG_DBG) printk("[%lu]" "0ms" "[%s:%d]\n  " "eye register 0x12C read_data :0x%.8x\n" , jiffies, strrchr("/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy.c", '/') + 1, 1478, read_data) ; };
  write_data = (read_data & 0x80ffffff) | (((x_buffer + 0x40) & 0x7f )<< 24);
  { if(gpPhyPriv->debugLevel & PHY_MSG_DBG) printk("[%lu]" "0ms" "[%s:%d]\n  " "eye register 0x12C write_data :0x%.8x\n" , jiffies, strrchr("/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy.c", '/') + 1, 1480, write_data) ; };
  iowrite32(write_data, (void *)((0xbfaf0100 +0x002C)));
 }

 int y_index = 0;
 int y_step = 0;
 for (x_axis = (0 - offset) ; x_axis<(128-offset) ; x_axis = x_axis + step)
 {
  x_buffer = x_axis;
  if(x_axis < 0)
   x_buffer = x_buffer + 128;
  ...
  read_data = regReadPhy32((0xbfaf0100 +0x002C));
  { if(gpPhyPriv->debugLevel & PHY_MSG_DBG) printk("[%lu]" "0ms" "[%s:%d]\n  " "eye register 0x12C read_data :0x%.8x\n" , jiffies, strrchr("/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy.c", '/') + 1, 1502, read_data) ; };
  write_data = (read_data & 0x80ffffff) | (((x_buffer + 0x40) & 0x7f )<< 24);
  { if(gpPhyPriv->debugLevel & PHY_MSG_DBG) printk("[%lu]" "0ms" "[%s:%d]\n  " "eye register 0x12C write_data :0x%.8x\n" , jiffies, strrchr("/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy.c", '/') + 1, 1504, write_data) ; };
  iowrite32(write_data, (void *)((0xbfaf0100 +0x002C)));
  for (y_axis = y_index ; (y_axis<128) && (y_axis>-1); y_axis = y_axis + y_step)
  {
   read_data = regReadPhy32((0xbfaf0100 +0x0018));
   { if(gpPhyPriv->debugLevel & PHY_MSG_DBG) printk("[%lu]" "0ms" "[%s:%d]\n  " "eye register 0x118 read_data :0x%.8x\n" , jiffies, strrchr("/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy.c", '/') + 1, 1509, read_data) ; };
   write_data = (read_data & 0xffffff80) | ((y_axis + 0x40) & 0x7f);
   schedule();
   { if(gpPhyPriv->debugLevel & PHY_MSG_DBG) printk("[%lu]" "0ms" "[%s:%d]\n  " "eye register 0x118 write_data :0x%.8x\n" , jiffies, strrchr("/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy.c", '/') + 1, 1512, write_data) ; };
   iowrite32(write_data, (void *)((0xbfaf0100 +0x0018)));
   read_data = regReadPhy32((0xbfaf0100 +0x0010));
   { if(gpPhyPriv->debugLevel & PHY_MSG_DBG) printk("[%lu]" "0ms" "[%s:%d]\n  " "eye register 0x110 read_data :0x%.8x\n" , jiffies, strrchr("/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy.c", '/') + 1, 1515, read_data) ; };
   write_data = (read_data & ~((1<<12))) | ((1<<12));

   { if(gpPhyPriv->debugLevel & PHY_MSG_DBG) printk("[%lu]" "0ms" "[%s:%d]\n  " "eye register 0x110 write_data :0x%.8x\n" , jiffies, strrchr("/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy.c", '/') + 1, 1518, write_data) ; };
   iowrite32(write_data, (void *)((0xbfaf0100 +0x0010)));
   do
   {
    read_data = regReadPhy32((0xbfaf0100 +0x003C));
   }while((read_data & 0x00000400) != 0x400);
   read_data = regReadPhy32((0xbfaf0100 +0x0048));
   read_data = read_data & 0x000fffff;
   printk("%d %d %d \n",x_buffer ,y_axis, read_data);
   read_data = regReadPhy32((0xbfaf0100 +0x0010));
   { if(gpPhyPriv->debugLevel & PHY_MSG_DBG) printk("[%lu]" "0ms" "[%s:%d]\n  " "eye register 0x110 read_data :0x%.8x\n" , jiffies, strrchr("/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy.c", '/') + 1, 1528, read_data) ; };
   write_data = (read_data & ~((1<<12)));

   { if(gpPhyPriv->debugLevel & PHY_MSG_DBG) printk("[%lu]" "0ms" "[%s:%d]\n  " "eye register 0x110 write_data :0x%.8x\n" , jiffies, strrchr("/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy.c", '/') + 1, 1531, write_data) ; };
   iowrite32(write_data, (void *)((0xbfaf0100 +0x0010)));
  }
 }
 read_data = regReadPhy32((0xbfaf0100 +0x0010));
 write_data = (read_data & ~((1<<11)));

 for (x_axis = (127-offset) ; x_axis > 64; x_axis = x_axis - step)
 {
  read_data = regReadPhy32((0xbfaf0100 +0x002C));
  { if(gpPhyPriv->debugLevel & PHY_MSG_DBG) printk("[%lu]" "0ms" "[%s:%d]\n  " "eye register 0x12C read_data :0x%.8x\n" , jiffies, strrchr("/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy.c", '/') + 1, 1541, read_data) ; };
  write_data = (read_data & 0x80ffffff) | (((x_axis + 0x40) & 0x7f )<< 24);
  { if(gpPhyPriv->debugLevel & PHY_MSG_DBG) printk("[%lu]" "0ms" "[%s:%d]\n  " "eye register 0x12C write_data :0x%.8x\n" , jiffies, strrchr("/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy.c", '/') + 1, 1543, write_data) ; };
  iowrite32(write_data, (void *)((0xbfaf0100 +0x002C)));
 }
...
static int phy_info_read_proc(char *buf, char **start, off_t off, int count, int *eof, void *data)
{
 ...
 uint phy_rdy_val = regReadPhy32((0xbfaf0100 +0x0030));
 uint phy_los_val = regReadPhy32((0xbfaf0500 +0x00E0));
 uint phy_rx_sync_val = regReadPhy32((0xbfaf0200 +0x001C));
...
# 1634 "/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy.c"
static int phy_read_proc(char *buf, char **start, off_t off, int count, int *eof, void *data)
{
 ...
 int mpd_current = 0x0;
 temperature_code = mt7570_ADC_temperature_get();
 vcc_code = mt7570_ADC_voltage_get();
 bias_current = mt7570_information_output(0x03);
 modulation_current = mt7570_information_output(0x04);
 rssi_current = mt7570_RSSI_current();
 mpd_current = mt7570_MPD_current();
# 1664 "/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy.c"
 off_t pos=0, begin=0 ;
...
# 1720 "/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy.c"
 ...
 else if (!strcmp(cmd, "7570_Vtemp_ADC")){
  mt7570_Vtemp_ADC_get();
 }
 else if (!strcmp(cmd, "EnvTemp_cal")){
  set_flash_register_EnvTemp(value1);
 }
 else if (!strcmp(cmd, "set_flash_register_Tx_data")){
  set_flash_register_Tx_data();
 }
 else if (!strcmp(cmd, "LUT")){
  mt7570_show_LUT();
 }
 ...
 else if (!strcmp(cmd, "DOL_flash_dump")){
  DOL_flash_dump();
 }
 else if (!strcmp(cmd, "GPON_Tx_calibration")){
  GPON_Tx_calibration();
 }
 else if (!strcmp(cmd, "EPON_Tx_calibration")){
  EPON_Tx_calibration();
 }
 else if (!strcmp(cmd, "restart_ERC")){
  mt7570_restart_ERC();
 }
 else if (!strcmp(cmd, "LOS_calibration")){
  LOS_calibration(value1,value2);
 }
 else if (!strcmp(cmd, "set_flash_register_BiasModCurrent")){
  set_flash_register_BiasModCurrent();
 }
 else if (!strcmp(cmd, "set_flash_register_P0P1")){
  set_flash_register_P0P1();
 }
 else if (!strcmp(cmd, "set_flash_register_APD")){
  set_flash_register_APD(value1,value2,value3);
 }
 else if (!strcmp(cmd, "set_flash_register_LOS")){
  set_flash_register_LOS();
 }
 else if (!strcmp(cmd, "set_flash_register_DDMI_TxPower")){
  set_flash_register_DDMI_TxPower(value1,value2);
 }
 else if (!strcmp(cmd, "set_flash_register_DDMI_RxPower")){
  set_flash_register_DDMI_RxPower(value1,value2);
 }
 else if (!strcmp(cmd, "DDMI_check_8472")){
  DDMI_check_8472();
 }
 else if (!strcmp(cmd, "set_flash_register_TIAGAIN")){
  set_flash_register_TIAGAIN();
 }
 else if (!strcmp(cmd, "temperature_calibration")){
  set_flash_register_temperature_offset(value1,value2);
 }
 else if (!strcmp(cmd, "GPON_BER")){
  GPON_BER(value1);
 }
 else if (!strcmp(cmd, "EPON_BER")){
  EPON_BER(value1);
 }
 else if (!strcmp(cmd, "show_BoB_information")){
  show_BoB_information();
 }
 else if (!strcmp(cmd, "GPON_pattern")){
  mt7570_calibration_pattern(PHY_GPON_CONFIG);
 }
 else if (!strcmp(cmd, "EPON_pattern")){
  mt7570_calibration_pattern(PHY_EPON_CONFIG);
 }
 else if (!strcmp(cmd, "dis_pattern")){
  mt7570_disable_pattern();
 }
 else if (!strcmp(cmd, "pon_phy_status")){
  pon_phy_status();
 }
 else if (!strcmp(cmd, "open_loop")){
  mt7570_OpenLoopMode();
 }
 else if (!strcmp(cmd, "closed_loop")){
  mt7570_DualClosedLoopMode();
 }
 else if (!strcmp(cmd, "sg_closed_loop")){
  mt7570_SingleClosedLoopMode();
 }
 else if (!strcmp(cmd, "pon_register")){
  pon_register(value1);
 }
 else if (!strcmp(cmd, "Ibias_temperature_set")){
  Ibias_temperature_set();
 }
 else if (!strcmp(cmd, "restart_ERC_P0")){
  mt7570_restart_ERC_P0();
 }
 else if (!strcmp(cmd, "ADC_calibration")){
  mt7570_ADC_calibration();
 }
 else if (!strcmp(cmd, "dis_ddmi")){
  internal_DDMI = 0;
  printk("DDMI disabled\n");
 }
 else if (!strcmp(cmd, "rebuild_LUT")){
  mt7570_LUT_recover();
 }
...
# 2136 "/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy.c"
...
# 2183 "/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy.c"
...
# 2220 "/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy.c"
...
# 2257 "/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy.c"
...
# 2294 "/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy.c"
...
# 2330 "/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy.c"
...
# 2368 "/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy.c"
...
static int phy_proc_apd_control_write_proc(struct file *file, const char *buffer, unsigned long count, void *data)
{
 char val_string[64] ;
 unchar ptr[1];
 int apd_value;
...
static struct proc_dir_entry *phy_proc_dir=((void *)0), *phy_proc=((void *)0), *phy_rogue=((void *)0), *phy_info=((void *)0);
static struct proc_dir_entry *phy_proc_ddmi=((void *)0);
static struct proc_dir_entry *phy_proc_temperature=((void *)0);
static struct proc_dir_entry *phy_proc_vcc=((void *)0);
static struct proc_dir_entry *phy_proc_bias=((void *)0);
static struct proc_dir_entry *phy_proc_modulation=((void *)0);
static struct proc_dir_entry *phy_proc_rssi=((void *)0);
static struct proc_dir_entry *phy_proc_mpd=((void *)0);
static struct proc_dir_entry *phy_proc_apd_control=((void *)0);
...
int phy_debug_init(void)
{
 ...
 phy_proc_dir = proc_mkdir("pon_phy", ((void *)0));
 if(phy_proc_dir){
...
phy_debug_deinit(void){
 ...
 if (phy_proc_apd_control)
 {
  remove_proc_entry("APDVolControl",phy_proc_dir);
    ...
    remove_proc_entry("pon_phy",((void *)0));
 return 0 ;
}

void phy_tx_power_config(unchar enable){
 gpPhyPriv->phyCfg.flags.txPowerEnFlag = enable;
 { if(gpPhyPriv->debugLevel & PHY_MSG_DBG) printk("[%lu]" "0ms" "[%s:%d]\n  " "PON PHY set txPowerEnFlag to %d.\n" , jiffies, strrchr("/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy.c", '/') + 1, 2557, enable) ; };
}
# 2567 "/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy.c"
...
int los_status_init(void)
{
 struct proc_dir_entry *los_proc = ((void *)0);

 los_proc = create_proc_entry("tc3162/los_status", 0, ((void *)0));
 if(((void *)0) == los_proc)
 {
...
# 2648 "/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy.c"
void phy_tx_fault_reset(void)
{
 if(mt7570_select==1)
...
void phy_event_poll(ulong data)
{
    ...
    if(0 == gpPhyPriv->is_phy_start){
        return;
    }

    do { do { ({ unsigned long __dummy; typeof(flags) __dummy2; (void)(&__dummy == &__dummy2); 1; }); flags = _raw_spin_lock_irqsave(spinlock_check(&gpPhyPriv->event_handle_lock)); } while (0); } while (0);
    if(PHY_LINK_STATUS_READY == gpPhyPriv->phy_status)
    {
        if(!is_phy_sync())
        {
            do{ if(xpon_phy_print_open) printk("[%lu" "0ms" "]%s:%d " "los detected by polling\n" , jiffies, (__func__), 2668) ; }while(0);
            gpPhyPriv->phy_status = PHY_LINK_STATUS_LOS;
            do{ if(xpon_phy_print_open) printk("[%lu" "0ms" "]%s:%d " "[%s] event los polled\n" , jiffies, (__func__), 2670, (__func__)) ; }while(0);
 ...
 else
    {
        if(is_phy_sync())
        {
            do{ if(xpon_phy_print_open) printk("[%lu" "0ms" "]%s:%d " "ready detected by polling\n" , jiffies, (__func__), 2679) ; }while(0);
            gpPhyPriv->phy_status = PHY_LINK_STATUS_READY;
            do{ if(xpon_phy_print_open) printk("[%lu" "0ms" "]%s:%d " "[%s] event ready polled\n" , jiffies, (__func__), 2681, (__func__)) ; }while(0);
    ...
    { mod_timer(&gpPhyPriv->event_poll_timer, (jiffies + ((gpPhyPriv->event_poll_timer.data*100)/1000))) ; } ;
}

void phy_event_handler(PON_PHY_Event_data_t * pEvent_data)
{
    do{ if(xpon_phy_print_open) printk("[%lu" "0ms" "]%s:%d " "[%s] event:%d, src:%d\n" , jiffies, (__func__), 2694, (__func__), pEvent_data->id, pEvent_data->src) ; }while(0);
