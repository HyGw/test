# 1 "/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy_rx.c"
# 1 "<built-in>"
# 1 "<命令行>"
...
# 8 "/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy_rx.c" 2
...
# 9 "/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy_rx.c" 2
...
# 10 "/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy_rx.c" 2
...
extern PHY_GlbPriv_T *gpPhyPriv ;
# 12 "/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy_rx.c" 2
# 1 "/opt/tclinux_phoenix/modules/private/xpon_phy/inc/i2c.h" 1
# 13 "/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy_rx.c" 2
# 1 "/opt/tclinux_phoenix/modules/private/xpon_phy/inc/phy.h" 1
# 14 "/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy_rx.c" 2
# 1 "/opt/tclinux_phoenix/modules/private/xpon_phy/inc/phy_def.h" 1
# 15 "/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy_rx.c" 2
...
# 16 "/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy_rx.c" 2
# 28 "/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy_rx.c"
void phy_rx_fec_counter(PPHY_FecCount_T fec_counter)
{
 iowrite32((1), (void *)((0xbfaf0200 +0x0034)));
 fec_counter->correct_bytes = regReadPhy32((0xbfaf0200 +0x0038));
 fec_counter->correct_codewords = regReadPhy32((0xbfaf0200 +0x003C));
 fec_counter->uncorrect_codewords = regReadPhy32((0xbfaf0200 +0x0040));
 fec_counter->total_rx_codewords = regReadPhy32((0xbfaf0200 +0x0044));
 fec_counter->fec_seconds = regReadPhy32((0xbfaf0200 +0x0048));

 { if(gpPhyPriv->debugLevel & PHY_MSG_DBG) printk("[%lu]" "0ms" "[%s:%d]\n  " "correct_bytes: %.8x\n" , jiffies, strrchr("/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy_rx.c", '/') + 1, 37, fec_counter->correct_bytes) ; };
 { if(gpPhyPriv->debugLevel & PHY_MSG_DBG) printk("[%lu]" "0ms" "[%s:%d]\n  " "correct_codewords: %.8x\n" , jiffies, strrchr("/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy_rx.c", '/') + 1, 38, fec_counter->correct_codewords) ; };
 { if(gpPhyPriv->debugLevel & PHY_MSG_DBG) printk("[%lu]" "0ms" "[%s:%d]\n  " "uncorrect_codewords: %.8x\n" , jiffies, strrchr("/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy_rx.c", '/') + 1, 39, fec_counter->uncorrect_codewords) ; };
 { if(gpPhyPriv->debugLevel & PHY_MSG_DBG) printk("[%lu]" "0ms" "[%s:%d]\n  " "total_rx_codewords: %.8x\n" , jiffies, strrchr("/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy_rx.c", '/') + 1, 40, fec_counter->total_rx_codewords) ; };
 { if(gpPhyPriv->debugLevel & PHY_MSG_DBG) printk("[%lu]" "0ms" "[%s:%d]\n  " "fec_seconds: %.8x\n" , jiffies, strrchr("/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy_rx.c", '/') + 1, 41, fec_counter->fec_seconds) ; };

}
# 57 "/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy_rx.c"
int phy_bip_counter(void)
{
   int bip_err_cnt = 0;
   iowrite32(((1<<2)), (void *)((0xbfaf0200 +0x0034)));
   bip_err_cnt = regReadPhy32((0xbfaf0200 +0x004C));
   { if(gpPhyPriv->debugLevel & PHY_MSG_DBG) printk("[%lu]" "0ms" "[%s:%d]\n  " "Phy BIP Counter : %.8x\n" , jiffies, strrchr("/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy_rx.c", '/') + 1, 62, bip_err_cnt) ; };
...
# 83 "/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy_rx.c"
void phy_rx_frame_counter(PPHY_FrameCount_T frame_counter)
{
 iowrite32(((1<<4)), (void *)((0xbfaf0200 +0x0034)));
 frame_counter->frame_count_high = regReadPhy32((0xbfaf0200 +0x0054));
 frame_counter->frame_count_low = regReadPhy32((0xbfaf0200 +0x0050));
 if(phy_gpon_mode())
  frame_counter->lof_counter = regReadPhy32((0xbfaf0200 +0x0058));

 { if(gpPhyPriv->debugLevel & PHY_MSG_DBG) printk("[%lu]" "0ms" "[%s:%d]\n  " "frame_count_high: %.8x\n" , jiffies, strrchr("/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy_rx.c", '/') + 1, 91, frame_counter->frame_count_high) ; };
 { if(gpPhyPriv->debugLevel & PHY_MSG_DBG) printk("[%lu]" "0ms" "[%s:%d]\n  " "frame_count_low: %.8x\n" , jiffies, strrchr("/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy_rx.c", '/') + 1, 92, frame_counter->frame_count_low) ; };
 if(phy_gpon_mode())
  { if(gpPhyPriv->debugLevel & PHY_MSG_DBG) printk("[%lu]" "0ms" "[%s:%d]\n  " "lof_counter: %.8x\n" , jiffies, strrchr("/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy_rx.c", '/') + 1, 94, frame_counter->lof_counter) ; };

}
# 109 "/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy_rx.c"
int phy_rx_fec_setting(unchar fec_control)
{
 if(fec_control == (1))
 {
  { if(gpPhyPriv->debugLevel & PHY_MSG_DBG) printk("[%lu]" "0ms" "[%s:%d]\n  " "Rx FEC Enable\n" , jiffies, strrchr("/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy_rx.c", '/') + 1, 113) ; };
  iowrite32(0x1, (void *)((0xbfaf0200 +0x0068)));
  return (0);
 }
 else if(fec_control == (0))
 {
  { if(gpPhyPriv->debugLevel & PHY_MSG_DBG) printk("[%lu]" "0ms" "[%s:%d]\n  " "Rx FEC Disable\n" , jiffies, strrchr("/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy_rx.c", '/') + 1, 119) ; };
  iowrite32(0x0, (void *)((0xbfaf0200 +0x0068)));
  return (0);
 }
 else
  return (1);
}
# 140 "/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy_rx.c"
int phy_rx_fec_getting(void)
{
 return regReadPhy32((0xbfaf0200 +0x0068));
}
# 158 "/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy_rx.c"
int phy_rx_fec_status(void)
{
 ...
 {
  { if(gpPhyPriv->debugLevel & PHY_MSG_DBG) printk("[%lu]" "0ms" "[%s:%d]\n  " "RX FEC on.\n" , jiffies, strrchr("/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy_rx.c", '/') + 1, 164) ; };
  return (1);
 }
 else
 {
  { if(gpPhyPriv->debugLevel & PHY_MSG_DBG) printk("[%lu]" "0ms" "[%s:%d]\n  " "RX FEC off.\n" , jiffies, strrchr("/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy_rx.c", '/') + 1, 169) ; };
  return (0);
 }

}
# 185 "/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy_rx.c"
int phy_trans_rx_setting(unchar rx_sd_inv)
{
 ...
 if((rx_sd_inv == (1)))
  write_data = (read_data & ~((1<<6))) | ((1<<6));
 else if((rx_sd_inv == (0)))
  write_data = (read_data & ~((1<<6))) | ((0<<6));
 else
 {
  { if(gpPhyPriv->debugLevel & PHY_MSG_DBG) printk("[%lu]" "0ms" "[%s:%d]\n  " "error input : rx_sd_inv.\n" , jiffies, strrchr("/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy_rx.c", '/') + 1, 197) ; };
  return (1);
 }
 { if(gpPhyPriv->debugLevel & PHY_MSG_DBG) printk("[%lu]" "0ms" "[%s:%d]\n  " "rx_sd_inv success \n" , jiffies, strrchr("/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy_rx.c", '/') + 1, 200) ; };
 iowrite32(write_data, (void *)((0xbfaf0100 +0x0038)));
 return (0);
}
# 218 "/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy_rx.c"
...
# 238 "/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy_rx.c"
int phy_ber_alarm(void)
{
 ...
 if(bip < 100)
 {
  { if(gpPhyPriv->debugLevel & PHY_MSG_DBG) printk("[%lu]" "0ms" "[%s:%d]\n  " "unknown BER \n" , jiffies, strrchr("/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy_rx.c", '/') + 1, 259) ; };
  return 0;
 }
 else
 {
 ...
 { if(gpPhyPriv->debugLevel & PHY_MSG_DBG) printk("[%lu]" "0ms" "[%s:%d]\n  " "ber_counter = %d \n" , jiffies, strrchr("/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy_rx.c", '/') + 1, 274, ber_counter) ; };
 { if(gpPhyPriv->debugLevel & PHY_MSG_DBG) printk("[%lu]" "0ms" "[%s:%d]\n  " "BER_order = %d \n" , jiffies, strrchr("/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy_rx.c", '/') + 1, 275, ber_order) ; };
 return ber_order;
}
# 292 "/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy_rx.c"
int phy_gpon_psync_setting(PPHY_GponRxCtl_T rx_control)
{
 uint read_data = 0;
 uint write_data = 0;
 read_data = regReadPhy32((0xbfaf0200 +0x000C));

 if((rx_control->mask & PHY_GPON_M1_LMT_EN) == PHY_GPON_M1_LMT_EN )
 {
  if((rx_control->gpon_m1_lmt & 0xF8) != 0x00 )
  {
   { if(gpPhyPriv->debugLevel & PHY_MSG_ERR) printk("[%lu]" "0ms" "[%s:%d]\n  " "error input : gpon_m1_lmt. \n" , jiffies, strrchr("/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy_rx.c", '/') + 1, 302) ; };
   return (1);
  }
  read_data = (read_data & 0xfffffff8) | rx_control->gpon_m1_lmt;
 }
 if((rx_control->mask & PHY_GPON_M2_LMT_EN) == PHY_GPON_M2_LMT_EN)
 {
  if((rx_control->gpon_m2_lmt & 0xF8) != 0x00 )
  {
   { if(gpPhyPriv->debugLevel & PHY_MSG_ERR) printk("[%lu]" "0ms" "[%s:%d]\n  " "error input : gpon_m2_lmt. \n" , jiffies, strrchr("/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy_rx.c", '/') + 1, 311) ; };
   return (1);
  }
  read_data = (read_data & 0xffffffC7) | (rx_control->gpon_m2_lmt << 3);
 }
 if((rx_control->mask & PHY_PRESYNC_MIS_LMT_EN) == PHY_PRESYNC_MIS_LMT_EN)
 {
  if((rx_control->presync_mismatch_lmt & 0xF8) != 0x00 )
  {
   { if(gpPhyPriv->debugLevel & PHY_MSG_ERR) printk("[%lu]" "0ms" "[%s:%d]\n  " "error input : presync_mismatch_lmt. \n" , jiffies, strrchr("/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy_rx.c", '/') + 1, 320) ; };
   return (1);
  }
  read_data = (read_data & 0xfffff8ff) | (rx_control->presync_mismatch_lmt<< 8);
 }
 if((rx_control->mask & PHY_INSYNC_MIS_LMT_EN) == PHY_INSYNC_MIS_LMT_EN)
 {
  if((rx_control->insync_mismatch_lmt & 0xF8) != 0x00 )
  {
   { if(gpPhyPriv->debugLevel & PHY_MSG_ERR) printk("[%lu]" "0ms" "[%s:%d]\n  " "error input : insync_mismatch_lmt. \n" , jiffies, strrchr("/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy_rx.c", '/') + 1, 329) ; };
   return (1);
  }
  read_data = (read_data & 0xffffc7ff) | (rx_control->insync_mismatch_lmt<< 11);
 }
 if((rx_control->mask & PHY_GPON_GSYNC_PROT_EN) == PHY_GPON_GSYNC_PROT_EN)
 {
  if((rx_control->gpon_gsync_prot & 0xFE) != 0x00 )
  {
   { if(gpPhyPriv->debugLevel & PHY_MSG_ERR) printk("[%lu]" "0ms" "[%s:%d]\n  " "error input : gpon_gsync_prot. \n" , jiffies, strrchr("/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy_rx.c", '/') + 1, 338) ; };
   return (1);
  }
  read_data = read_data & (0xffffbfff) & (rx_control->gpon_gsync_prot << 14);
 }

 write_data = read_data;
 iowrite32(write_data, (void *)((0xbfaf0200 +0x000C)));
 return (0);

}
# 365 "/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy_rx.c"
int phy_epon_frame_err_cnt(void)
{

 iowrite32((1<<5), (void *)((0xbfaf0200 +0x0098)));
 { if(gpPhyPriv->debugLevel & PHY_MSG_DBG) printk("[%lu]" "0ms" "[%s:%d]\n  " "Phy Epon Frame Error Counter : %.8x\n" , jiffies, strrchr("/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy_rx.c", '/') + 1, 369, regReadPhy32((0xbfaf0200 +0x0028))) ; };
 return regReadPhy32((0xbfaf0200 +0x0028));



}
# 390 "/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy_rx.c"
int phy_rx_power_alarm(void)
{
 ...
 uint return_value = PHY_TRANS_NO_ALARM;
  ...
  unchar ptr[1];
  ushort u2ByteCnt;
  phy_I2C_read(0, gpPhyPriv->i2c_u2_clk_div, 0x51, 1,0x71, ptr, 1);
  alarm_data= ptr[0];
 ...
 if( (alarm_data & (0x40)) == 0x40 )
 {

  { if(gpPhyPriv->debugLevel & PHY_MSG_DBG) printk("[%lu]" "0ms" "[%s:%d]\n  " "Rx power is below low alarm. \n" , jiffies, strrchr("/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy_rx.c", '/') + 1, 409) ; };
  return_value = return_value | PHY_TRANS_RX_LOW_POWER_ALARM;
 }

 if( (alarm_data & (0x80)) == 0x80 )
 {
  { if(gpPhyPriv->debugLevel & PHY_MSG_DBG) printk("[%lu]" "0ms" "[%s:%d]\n  " "Rx power exceeds high alarm. \n" , jiffies, strrchr("/opt/tclinux_phoenix/modules/private/xpon_phy/src/phy_rx.c", '/') + 1, 415) ; };
