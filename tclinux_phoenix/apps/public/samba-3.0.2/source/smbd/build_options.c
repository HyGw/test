...
/* Output various other options (as gleaned from include/config.h.in) */
	...
	output(screen, "   HAVE_LDAP_DOMAIN2HOSTLIST\n");
#endif
	...
	output(screen, "   WITH_LDAP_SAMCONFIG\n");
#endif
...
#endif
#ifdef auth_rhosts_init
	output(screen, "   auth_rhosts_init\n");
#endif
#ifdef auth_sam_init
...
#endif
#ifdef pdb_guest_init
	output(screen, "   pdb_guest_init\n");
#endif
#ifdef pdb_ldap_init
	output(screen, "   pdb_ldap_init\n");
#endif
#ifdef pdb_mysql_init
	output(screen, "   pdb_mysql_init\n");
#endif
#ifdef pdb_pgsql_init
	output(screen, "   pdb_pgsql_init\n");
#endif
...
#endif
#ifdef pdb_xml_init
	output(screen, "   pdb_xml_init\n");
#endif
#ifdef pid_t
	output(screen, "   pid_t\n");
#endif
#ifdef rpc_dfs_init
	output(screen, "   rpc_dfs_init\n");
#endif
#ifdef rpc_echo_init
