...
g_print("%s:interface name=%s!\n", __FUNCTION__ , interface_name);
  ...
  else if ((g_strcmp0 (interface_name, "org.freedesktop.DBus.Properties") == 0  || g_strcmp0 (interface_name, "com.ctc.igd1.Properties") == 0)  &&
                        ...
                        GDBusMessage    *message)
{
  ...
  if  (1) //(G_UNLIKELY (_g_dbus_debug_incoming ()))
    {
      _g_dbus_debug_print_lock ();
      g_print ("========================================================================\n"
