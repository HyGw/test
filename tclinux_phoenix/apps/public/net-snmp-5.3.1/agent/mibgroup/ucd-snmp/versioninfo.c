                       ...
                       size_t * var_len, WriteMethod ** write_method)
{
    ...
    case VERDATE:
        sprintf(errmsg, "$Date: 2016/10/14 $");
        *var_len = strlen(errmsg);
        return ((u_char *) errmsg);
    case VERCDATE:
        curtime = time(NULL);
    ...
    case VERIDENT:
        sprintf(errmsg,
                "$Id: //BBN_Linux/Branch/Branch_for_Rel_CMCC_7526_20161014/tclinux_phoenix/apps/public/net-snmp-5.3.1/agent/mibgroup/ucd-snmp/versioninfo.c#1 $");
        *var_len = strlen(errmsg);
        return ((u_char *) errmsg);
    case VERCONFIG:
#ifdef CONFIGURE_OPTIONS
