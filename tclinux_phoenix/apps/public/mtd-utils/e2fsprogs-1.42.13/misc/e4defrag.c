...
int fallocate64(int fd, int mode, __off64_t offset,
		__off64_t len)
{
	int ret;
#if 0	
...
#else
	//ret = syscall(47, fd, mode, 0, offset, offset, len, len);
	ret = syscall(4320, fd, mode, 0, 	OFF64_HI_LO (offset), OFF64_HI_LO (len));
