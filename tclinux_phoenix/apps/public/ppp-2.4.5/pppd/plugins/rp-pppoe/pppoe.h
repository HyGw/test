...
*
* $Id: //BBN_Linux/Branch/Branch_for_Rel_CMCC_7526_20161014/tclinux_phoenix/apps/public/ppp-2.4.5/pppd/plugins/rp-pppoe/pppoe.h#1 $
*
***********************************************************************/
...
//yanbing: PADI_TIMEOUT midified to 2 with compile option TCSUPPORT_CZ_GENERAL
#if !defined(TCSUPPORT_CZ_OTE) && !defined(TCSUPPORT_CZ_H168N) && !defined(TCSUPPORT_CZ_GENERAL)
