...
struct options
{
  ...
  int tr069_flag;  /* tr069 http method flag */
  char *tr069_waniface; /* tr069 http data will on this wan */
#endif
#if defined(TCSUPPORT_CT_TR143_WGET_DOWNLOAD)
  char *tr143_logfile; /* logfile for tr143 */
  char *tr143_pidfile; /* pidfile for tr143 */
  char *tr143_waniface; /* tr143 http data will on this wan */
  int tr143_flag; /* tr143 http method flag */
  int tr143_ethernet_priority; /* tr143 ethernet priority value */
#endif
#if defined(TCSUPPORT_CT_JOYME)
  char *writestatus; /* write return status to temp file */
#endif
};
