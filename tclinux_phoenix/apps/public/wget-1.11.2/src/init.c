...
static const struct {
  ...
  { "ratetesttime", 	 &opt.ratetesttime, 	   cmd_number },
#endif
  ...
  { "tr069flag",          &opt.tr069_flag,	   cmd_number },
  { "tr069interface", &opt.tr069_waniface,	  cmd_string },
#endif
#if defined(TCSUPPORT_CT_TR143_WGET_DOWNLOAD)
  { "tr143ethpriority", &opt.tr143_ethernet_priority, cmd_number },
  { "tr143flag",		&opt.tr143_flag,		cmd_number },
  { "tr143interface",   &opt.tr143_waniface,	  cmd_string },
  { "tr143logfile", 	&opt.tr143_logfile, 	cmd_file },
  { "tr143pidfile", 	&opt.tr143_pidfile, 	cmd_file },
#endif
  ...
  { "writestatus",		&opt.writestatus,		cmd_file },
#endif
};
