...
#define VOIPTEST_ENTRYNUMBER 1
#if defined(TCSUPPORT_CUC_CWMP_PARAMETER)
#define VOIPBASIC_ENTRYNUMBER 1
#define VOIPSIMULATETEST_ENTRYNUMBER 1
#define INFOVOIP_ENTRYNUMBER 2
#else
#define VOIPBASIC_ENTRYNUMBER 2
#define VOIPSIMULATETEST_ENTRYNUMBER 2
#define INFOVOIP_ENTRYNUMBER 1
#endif
#define VOIPCODECS_ENTRYNUMBER 9
#define INFOVOIP_COMMONNUMBER 6
#define VOIPTEST_MAXENTRY 2
