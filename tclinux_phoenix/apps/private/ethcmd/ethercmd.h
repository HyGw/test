...
#define HELP_QUEUE_RATE_CONTROLL	"queueratectl <port: 0-6> <queue: 1-4> <rate(kbps): 1-1000000)>\n"
...
#define HELP_DSTQ		"dstq [mode][fc]\n" \
						 "mode <state>:   0: Disable\n" \
						 "                1: down stream to gdm\n" \
						 "                2: down stream to qdma\n"\
						 "fc <state>:     0: Disable flow control \n" \
						 "                1: Enable flow control\n"

#define HELP_PORT_MATRIX "portmatirx group_id_for_port0~3\n" \
                         "port0~3 is software port id: \n" \
                         "   0:eth0.1, 1:eth0.2, 2:eth0.3 3:eth0.4\n"
//#endif //SQA_VERIFY
