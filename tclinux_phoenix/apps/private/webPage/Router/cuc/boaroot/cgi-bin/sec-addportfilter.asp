    ...
    <td height="1"> <table width="808"  height="117" border="0" cellpadding="0" cellspacing="0" background="/img/framelogo.jpg" >
      ...
      <table border="0" cellpadding="0" cellspacing="0" width="808" height="100" id="table2">
        <tr> 
          ...
          <td height="33" width="434" bgcolor="#427594" class=CucBgColorTD_1> <p align="right"><font color="#FFFFFF" face="黑体"><b><font face="黑体" size="6" color="#FFFFFF"> 
...
document.write(top.gateWayName);
          ...
          <td height="33" width="211" bgcolor="#EF8218" class=CucBgColorTD_1> <p align="center" class="GatewayType">型号: 
              <script language="javascript">
...
MakeMenu(getElById ('Selected_Menu').value);
  ...
  <tr> 
    <td valign="top"> <table height="100%" border="0" cellpadding="0" cellspacing="0">
        <tr> 
          <td width="157" class="Item_L1" height="30"><p>端口过滤</p></td>
  ...
  <tr> 
    <td height="1"> <table border="0" cellpadding="0" cellspacing="0" width="808" height="35" id="table7">
        <tr> 
          ...
          <td width="196" bgcolor="#427594" class=CucBgColorTD_2> <p align="center"><img src="/img/ok.gif" width="80" height="23" border="0" id="btnOK" onClick="btnSaveIP()">&nbsp;&nbsp;<a href="#"><img src="/img/cancel.gif" width="80" height="23" border="0" id="btnCancel" onClick="RefreshPage()"> 
          </td>
