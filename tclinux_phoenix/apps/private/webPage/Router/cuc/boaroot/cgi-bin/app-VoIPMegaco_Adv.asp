                  		...
                  		<TABLE border=0 cellSpacing=0 cellPadding=0 width="100%">
				                        ...
				                        <tr>
				                            ...
				                            <td class="table1_right">
				                                ...
				                                <option value="all" <%if tcWebApi_get("VoIPMedia_Common", "G711FAXControlType", "h") = "all" then asp_Write("selected") end if %>>软交换全控</option>
				                                <option value="other" <%if tcWebApi_get("VoIPMedia_Common", "G711FAXControlType", "h") = "other" then asp_Write("selected") end if %>>网关自协商</option>
				                           		</select>
				                           	</td>
				                        </tr>                
				                        <tr>
