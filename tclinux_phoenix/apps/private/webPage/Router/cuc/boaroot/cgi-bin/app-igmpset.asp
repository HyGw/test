...
%>
<HTML><HEAD><TITLE>IGMP/MLD设置</TITLE>
...
border=0>
        ...
        <TR>
          ...
          <TD width=434 bgColor=#427594 height=33 class=CucBgColorTD_1>
            ...
            value="应用->IGMP/MLD设置" name=Selected_Menu> </FONT></B><SPAN 
...
<SCRIPT language=JavaScript type=text/javascript>
	...
	<input type="hidden" name="ProxyActive" value="0">
			...
			{
				if(( vEntryName[i].indexOf('_INTERNET_')<0 && vEntryName[i].indexOf('_OTHER_')<0  && vEntryName[i].indexOf('IPTV')<0) || (vEntryName[i].indexOf('_B_')>-1) )
					continue;
