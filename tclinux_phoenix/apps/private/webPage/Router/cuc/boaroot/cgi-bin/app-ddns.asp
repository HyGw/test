				...
				document.writeln("<option id=" + vEntryIndex[i] + " " + "value=" + vEntryValue[i] +">" + vEntryName[i] + "</option>");
                  ...
                  <TABLE cellSpacing=0 cellPadding=0 border=0>
                    ...
                    <TR>
					  ...
					  <OPTION value="Chinatelecom" <%if tcWebApi_get("Ddns_Entry","DDNS_Name","h") = "China Telecom" then asp_Write("selected") elseif tcWebApi_get("Ddns_Entry","DDNS_Name","h") = "N/A" then asp_Write("selected") end if %>>中国联通</OPTION> 
					  </SELECT> </TD></TR>
