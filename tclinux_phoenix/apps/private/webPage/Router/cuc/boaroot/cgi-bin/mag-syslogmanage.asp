...
<script language="JavaScript" type='text/javascript'>
	...
	for(i=0;i<8;i++)
	{
        ...
        <TR>
          ...
          <TD width=157 class=Item_L1 height=30>
            <P>维护</P></TD>
          <TD bgColor=#ef8218 class=CucBgColorTD_2>　</TD>
          <TD></TD></TR>          	
        <TR>
          <TD vAlign=top width=157 bgColor=#e7e7e7 height=10></TD>
          <TD width=7 background=/img/panel3.gif> 　</TD>
          <TD><P align=center>
          <input type="button" value="维护结束上报"  name="buttonmaintend"  onClick="window.location.href='/cgi-bin/maintainreport.cgi';" >
          <BR></P></TD></TR>
        <TR>
    ...
    <TD height=1>
      <TABLE id=table7 height=35 cellSpacing=0 cellPadding=0 width=808 
	    ...
	    <P align=center><IMG id=btnOK onclick=SubmitChange() height=23 
          ...
          <TD width=170  bgColor=#313031 class=CucBgColorTD_2>　</TD></TR></TBODY></TABLE></TD></TR></TBODY></TABLE></BODY></HTML>
