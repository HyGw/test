...
function loadMCSList()
{
	...
	document.forms[0].wlMcs[0] = new Option("Auto", "33");
	if (Wlan[0].TxRxStream == '1')
	{
		if ("0" == getSelectVal('bwControl'))
		{
			...
			{
				document.forms[0].wlMcs[1] = new Option("6.5 Mbps", "0");
				document.forms[0].wlMcs[2] = new Option("13 Mbps", "1");
				document.forms[0].wlMcs[3] = new Option("19.5 Mbps", "2");
				document.forms[0].wlMcs[4] = new Option("26 Mbps", "3");
				document.forms[0].wlMcs[5] = new Option("39 Mbps", "4");
				document.forms[0].wlMcs[6] = new Option("52 Mbps", "5");
				document.forms[0].wlMcs[7] = new Option("58.5 Mbps", "6");
				document.forms[0].wlMcs[8] = new Option("65 Mbps", "7");
			}
			else if ("1" == getSelectVal('giControl'))
			{
				document.forms[0].wlMcs[1] = new Option("7.2 Mbps", "0");
				document.forms[0].wlMcs[2] = new Option("14.4 Mbps", "1");
				document.forms[0].wlMcs[3] = new Option("21.7 Mbps", "2");
				document.forms[0].wlMcs[4] = new Option("28.9 Mbps", "3");
				document.forms[0].wlMcs[5] = new Option("43.3 Mbps", "4");
				document.forms[0].wlMcs[6] = new Option("57.8 Mbps", "5");
				document.forms[0].wlMcs[7] = new Option("65 Mbps", "6");
				document.forms[0].wlMcs[8] = new Option("72.2 Mbps", "7");
			}
		}
		else if ("1" == getSelectVal('bwControl'))
		{
			if ("0" == getSelectVal('giControl'))
			{
				document.forms[0].wlMcs[1] = new Option("13.5 Mbps", "0");
				document.forms[0].wlMcs[2] = new Option("27 Mbps", "1");
				document.forms[0].wlMcs[3] = new Option("40.5 Mbps", "2");
				document.forms[0].wlMcs[4] = new Option("54 Mbps", "3");
				document.forms[0].wlMcs[5] = new Option("81 Mbps", "4");
				document.forms[0].wlMcs[6] = new Option("108 Mbps", "5");
				document.forms[0].wlMcs[7] = new Option("121.5 Mbps", "6");
				document.forms[0].wlMcs[8] = new Option("135 Mbps", "7");
			}
			else if ("1" == getSelectVal('giControl'))
			{
				document.forms[0].wlMcs[1] = new Option("15 Mbps", "0");
				document.forms[0].wlMcs[2] = new Option("30 Mbps", "1");
				document.forms[0].wlMcs[3] = new Option("45 Mbps", "2");
				document.forms[0].wlMcs[4] = new Option("60 Mbps", "3");
				document.forms[0].wlMcs[5] = new Option("90 Mbps", "4");
				document.forms[0].wlMcs[6] = new Option("120 Mbps", "5");
				document.forms[0].wlMcs[7] = new Option("135 Mbps", "6");
				document.forms[0].wlMcs[8] = new Option("150 Mbps", "7");
			}
		}
	}
	else if (Wlan[0].TxRxStream == '2')
	{
		if ("0" == getSelectVal('bwControl'))
		{
			if ("0" == getSelectVal('giControl'))
			{
				document.forms[0].wlMcs[1] = new Option("13 Mbps", "8");
				document.forms[0].wlMcs[2] = new Option("26 Mbps", "9");
				document.forms[0].wlMcs[3] = new Option("39 Mbps", "10");
				document.forms[0].wlMcs[4] = new Option("52 Mbps", "11");
				document.forms[0].wlMcs[5] = new Option("78 Mbps", "12");
				document.forms[0].wlMcs[6] = new Option("104 Mbps", "13");
				document.forms[0].wlMcs[7] = new Option("117 Mbps", "14");
				document.forms[0].wlMcs[8] = new Option("130 Mbps", "15");
			}
			else if ("1" == getSelectVal('giControl'))
			{
				document.forms[0].wlMcs[1] = new Option("14.4 Mbps", "8");
				document.forms[0].wlMcs[2] = new Option("28.9 Mbps", "9");
				document.forms[0].wlMcs[3] = new Option("43.3 Mbps", "10");
				document.forms[0].wlMcs[4] = new Option("57.8 Mbps", "11");
				document.forms[0].wlMcs[5] = new Option("86.7 Mbps", "12");
				document.forms[0].wlMcs[6] = new Option("115.6 Mbps", "13");
				document.forms[0].wlMcs[7] = new Option("130.0 Mbps", "14");
				document.forms[0].wlMcs[8] = new Option("144.4 Mbps", "15");
			}
		}
		else if ("1" == getSelectVal('bwControl'))
		{
			if ("0" == getSelectVal('giControl'))
			{
				document.forms[0].wlMcs[1] = new Option("27 Mbps", "8");
				document.forms[0].wlMcs[2] = new Option("54 Mbps", "9");
				document.forms[0].wlMcs[3] = new Option("81 Mbps", "10");
				document.forms[0].wlMcs[4] = new Option("108 Mbps", "11");
				document.forms[0].wlMcs[5] = new Option("162 Mbps", "12");
				document.forms[0].wlMcs[6] = new Option("216 Mbps", "13");
				document.forms[0].wlMcs[7] = new Option("243 Mbps", "14");
				document.forms[0].wlMcs[8] = new Option("270 Mbps", "15");
			}
			else if ("1" == getSelectVal('giControl'))
			{
				document.forms[0].wlMcs[1] = new Option("30 Mbps", "8");
				document.forms[0].wlMcs[2] = new Option("60 Mbps", "9");
				document.forms[0].wlMcs[3] = new Option("90 Mbps", "10");
				document.forms[0].wlMcs[4] = new Option("120 Mbps", "11");
				document.forms[0].wlMcs[5] = new Option("180 Mbps", "12");
				document.forms[0].wlMcs[6] = new Option("240 Mbps", "13");
				document.forms[0].wlMcs[7] = new Option("270 Mbps", "14");
				document.forms[0].wlMcs[8] = new Option("300 Mbps", "15");
			}
		}
	}
...
function loadRateList() {
	...
	{ 
		if (mode == "b" )
		{ 
			document.forms[0].wlRate[0] = new Option("Auto", "Auto");
			document.forms[0].wlRate[1] = new Option("1 Mbps", "1");
			document.forms[0].wlRate[2] = new Option("2 Mbps", "2");
			document.forms[0].wlRate[3] = new Option("5.5 Mbps", "5.5");
			document.forms[0].wlRate[4] = new Option("11 Mbps", "11");
		}
		else
		{
			document.forms[0].wlRate[0] = new Option("Auto", "Auto");
			...
			document.forms[0].wlRate[2] = new Option("2 Mbps", "2");
			document.forms[0].wlRate[3] = new Option("5.5 Mbps", "5.5");
			document.forms[0].wlRate[4] = new Option("6 Mbps", "6");
			document.forms[0].wlRate[5] = new Option("9 Mbps", "9");
			document.forms[0].wlRate[6] = new Option("11 Mbps", "11");
			document.forms[0].wlRate[7] = new Option("12 Mbps", "12");
			document.forms[0].wlRate[8] = new Option("18 Mbps", "18");
			document.forms[0].wlRate[9] = new Option("24 Mbps", "24");
			document.forms[0].wlRate[10] = new Option("36 Mbps", "36");
			document.forms[0].wlRate[11] = new Option("48 Mbps", "48");
			document.forms[0].wlRate[12] = new Option("54 Mbps", "54");
		}
	}
	else if (band == "1")
	{ 
		document.forms[0].wlRate[0] = new Option("Auto", "Auto");
		document.forms[0].wlRate[1] = new Option("6 Mbps", "6");
		document.forms[0].wlRate[2] = new Option("9 Mbps", "9");
		document.forms[0].wlRate[3] = new Option("12 Mbps", "12");
		document.forms[0].wlRate[4] = new Option("18 Mbps", "18");
		document.forms[0].wlRate[5] = new Option("24 Mbps", "24");
		document.forms[0].wlRate[6] = new Option("36 Mbps", "36");
		document.forms[0].wlRate[7] = new Option("48 Mbps", "48");
		document.forms[0].wlRate[8] = new Option("54 Mbps", "54");
	}
	else
	{
		document.forms[0].wlRate[0] = new Option("Auto", "Auto");
			...
			getElement("11NgiControl").style.display = "none";
                  ...
                  <TABLE cellSpacing=0 cellPadding=0 border=0>
                    ...
                    <TR>
                      ...
                      <TD width=172><INPUT style="FONT-FAMILY: '宋体'" 
                        type=password maxLength=65 
                  name=wlWpaPsk></TD></TR></TBODY></TABLE></DIV>
                  ...
                  <TABLE cellSpacing=0 cellPadding=0 border=0>
                    ...
                    <TR>
                      ...
                      <TD><INPUT style="FONT-FAMILY: '宋体'" type=password 
                        maxLength=80 name=wlRadiusKey></TD></TR></TBODY></TABLE></DIV>
                  <DIV id=wlWpaD>
                  <TABLE cellSpacing=0 cellPadding=0 border=0>
                    <TBODY>
                    <TR>
