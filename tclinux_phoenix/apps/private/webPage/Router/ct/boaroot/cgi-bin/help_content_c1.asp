...
<form name=test>
  <table width="100%" border="0" cellspacing="0" cellpadding="0" id=tab name=tab>
    <tr>
      <td class="topHelpTitle" colspan="2">帮&nbsp;助&nbsp;文&nbsp;档</td>
    </tr>
    <tr>
      <td colspan="2">&nbsp;</td>
    </tr>
    <tr>
      <td class="tabHelpdata" colspan=2 bgcolor=#CCCCCC>一、状态<a name=状态></a></td>
    </tr>
    ...
    <tr> 
      <td width=20>&nbsp;</td>
      <td class="tabdataleft"> <ul>
          <li id=statusNetwork_1>显示连接信息和DSL信息。 连接信息显示网络侧连接状态，各条PVC的IP地址、子网掩码，默认网关，DNS服务器信息，PVC及封装信息；DSL信息显示DSL的当前同步状态，连接状态，上下行速率，噪声裕量，交织深度，线路协议，线路衰减，输出功率，信道类型等。 
          </li>
        </ul></td>
    </tr>
    ...
    <tr name=ntwk_cfgWan id=ntwk_cfgWan> 
      ...
      <td class="tabdataleft"><ul>
          ...
          <ul>
            ...
            <li>PPPoE:ISP将提供帐号，填入包括如下信息:用户名、密码、服务名称，并配置拨号方式。该模式系统将通过PPPoE动态获得IP。 
            </li>
            ...
            <li id=ntwk_cfgWan_3>服务类别:UBR Without PCR、UBR With PCR、CBR、Non-Real 
              Time VBR、Realtime VBR。</li>
...
document.write( '<td class="tabdataleft" >1.WLAN配置<a name=WLAN配置 id="WLAN配置"></a></td>');
    ...
    <tr name=ntwk_cfgQoS_1 id=ntwk_cfgQoS_1> 
      <td>&nbsp;</td>
      <td class="tabdataleft"><ul>
          <li>QoS 设置（仅联通维护帐号可使用）:出厂时可预置和业务相关的配置模板，使用时根据具体开通业务进行选择和配置。</li>
        </ul></td>
    </tr>
    ...
    <tr name=ntwk_cfgSNTP_4 id=ntwk_cfgSNTP_4> 
      ...
      <td class="tabdataleft"><ul>
          ...
          <ul>
            ...
            <li>服务器即可设置域名也可设置IP地址，如果想选择列表框以外的SNTP服务器，在列表框中选择“Other”，在后面输入SNTP服务器的域名或IP地址。 
            </li>
    ...
    <tr name=landingPage id=landingPage> 
      <td>&nbsp;</td>
      <td class="tabdataleft">8.门户控制<a name=门户控制 id="门户控制"></a></td>
    </tr>
    <tr name=landing_page id=landing_page> 
      <td>&nbsp;</td>
      <td class="tabdataleft"><ul>
          <li>用于是否开启门户控制功能，注：该功能需要重启生效.</li>
        </ul></td>
    </tr>
    <tr> 
    ...
    <tr> 
      ...
      <td class="tabdataleft"><ul>
          <li>设置</li>
          <ul>
            <li>启用广域网过滤:启动或关闭广域网访问功能，默认为“<strong>关闭</strong>”。设置完成后，界面上显示新的广域网访问状态。 
            </li>
    ...
    <tr> 
      ...
      <td class="tabdataleft"><ul>
          <li>设置</li>
          <ul>
            <li>启用广域网MAC过滤:启动或关闭广域网访问功能，默认为“<strong>关闭</strong>”。设置完成后，界面上显示新的广域网访问状态。 
            </li>
    ...
    <tr name=securityPort_4 id=securityPort_4> 
      ...
      <td class="tabdataleft"><ul>
          <li>设置</li>
          <ul>
            <li>启用广域网端口过滤:启动或关闭广域网访问功能，默认为“<strong>关闭</strong>”。设置完成后，界面上显示新的广域网访问状态。 
            </li>
            <li>过滤模式:“<b>黑名单”</b>或“<b>白名单”</b>；此操作修改当前的过滤模式。</li>
          ...
          <li>过滤规则可设置“过滤名称”，可将“协议”、“源IP起始地址”、“源IP结束地址”、“源端口”、“目的IP起始地址”、“目的IP结束地址”、“目的端口”作为过滤条件进行设置。 
          </li>
        </ul></td>
    </tr>
    <tr id="apptitle"> 
    ...
    <tr name=appIGMP_4 id=appIGMP_4> 
      ...
      <td class="tabdataleft"><ul>
          ...
          <li>IGMP Proxy设置:使用该操作，启用或者停用每条WAN连接IGMP Proxy功能，设置完成后，界面上显示每条WAN连接的IGMP 
            Proxy设置状态。</li>
        </ul></td>
    </tr>
...
document.write( '<td class="tabdataleft" >1.日常应用<a name=日常应用 id="日常应用"></a></td>');
    ...
    <tr name=manageSyslog_1 id=manageSyslog_1> 
      <td>&nbsp;</td>
      <td class="tabdataleft"><ul>
          <li>日志写入等级设置:可以启用或者禁用写入日志文件。在启用写入日志文件的情况下，可以设置写入和显示日志文件的等级。</li>
    ...
    <tr name=manageDiag_1 id=manageDiag_1> 
      <td width=20>&nbsp;</td>
      <td class="tabdataleft"><ul>
          <li>维护结束上报:当联通维护人员在维护中使用了联通维护帐号时，通过该界面操作通知ITMS更新联通维护帐号的密码。</li>
        </ul></td>
    </tr>
    ...
    <tr name=networkDiag_1 id=networkDiag_1> 
      ...
      <td class="tabdataleft"><ul>
          ...
          <li>Inform手动上报:支持Infrom手动上报，并且正确显示手动Inform上报的状态。</li>
        </ul></td>
    </tr>
  </table>
