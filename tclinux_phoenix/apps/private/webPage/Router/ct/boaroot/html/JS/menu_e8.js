...
if(vPageMap[2][0] == '1'){
	if(vPageMap[2][1] == '1')
		...
		MenuArray[iCount++] = new MenuNodeConstruction(1, "网络", "/cgi-bin/net-landingpage.asp", "");												
}
if(vPageMap[2][1] == '1')
...
if(vPageMap[2][8] == '1')
	MenuArray[iCount++] = new MenuNodeConstruction(2, "门户控制", "/cgi-bin/net-landingpage.asp", "");
//Sec->3
if(vPageMap[3][0] == '1'){
	if(vPageMap[3][1] == '1')
