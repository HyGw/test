...
function generatePerLineTable()
{
  // Generate the table
   if (document.body.innerHTML) {
      ...
      var data = "<select name='lineEnabled0'>" + selectOptions1.join("") + "<\/select>";
      ...
      var data = "<select name='lineEnabled1'>" + selectOptions1.join("") + "<\/select>";
      tableHtmlOutput += "<td align=center>" + data + "</td>";         
      tableHtmlOutput += "</tr>";
      ...
      tableHtmlOutput += "<td class='hd'>显示号码<\/td>"
     	var data = "<input type='text' size=20 maxlength=40 name=\'dispName0\' value=\'<%if tcWebAPI_get("VoIPBasic_Entry0", "SIPDisplayNumber", "h") <> "N/A" then tcWebAPI_get("VoIPBasic_Entry0", "SIPDisplayNumber", "s") else asp_Write("") end if %>\'>";
     	tableHtmlOutput += "<td align=center>" + data + "</td>";
     	var data = "<input type='text' size=20 maxlength=40 name=\'dispName1\' value=\'<%if tcWebAPI_get("VoIPBasic_Entry1", "SIPDisplayNumber", "h") <> "N/A" then tcWebAPI_get("VoIPBasic_Entry1", "SIPDisplayNumber", "s") else asp_Write("") end if %>\'>";
     	tableHtmlOutput += "<td align=center>" + data + "</td>";     	
      tableHtmlOutput += "</tr>";
      ...
      var data = "<input type='text' size=20 maxlength=40 name=\'authName0\' value=\'<%if tcWebAPI_get("VoIPBasic_Entry0", "SIPAuthenticationName", "h") <> "N/A" then tcWebAPI_get("VoIPBasic_Entry0", "SIPAuthenticationName", "s") else asp_Write("") end if %>\'>";
      tableHtmlOutput += "<td align=center>" + data + "</td>";
      var data = "<input type='text' size=20 maxlength=40 name=\'authName1\' value=\'<%if tcWebAPI_get("VoIPBasic_Entry1", "SIPAuthenticationName", "h") <> "N/A" then tcWebAPI_get("VoIPBasic_Entry1", "SIPAuthenticationName", "s") else asp_Write("") end if %>\'>";
      tableHtmlOutput += "<td align=center>" + data + "</td>";
      ...
      var data = "<input type='Password' size=20 maxlength=40 name=\'password0\' value=\'<%if tcWebAPI_get("VoIPBasic_Entry0", "SIPPassword", "h") <> "N/A" then tcWebAPI_get("VoIPBasic_Entry0", "SIPPassword", "s") else asp_Write("") end if %>\'>";
      tableHtmlOutput += "<td align=center>" + data + "</td>";
      var data = "<input type='Password' size=20 maxlength=40 name=\'password1\' value=\'<%if tcWebAPI_get("VoIPBasic_Entry1", "SIPPassword", "h") <> "N/A" then tcWebAPI_get("VoIPBasic_Entry1", "SIPPassword", "s") else asp_Write("") end if %>\'>";
      tableHtmlOutput += "<td align=center>" + data + "</td>";
...
function enableEditBoxes()
{
   if ( sm == "1" )
   {
    	...
    	document.getElementById('edit_proxyAddr').style.display = "none";
    	document.getElementById('edit_proxyPort').style.display = "none";
    	document.getElementById('edit_obProxyAddr').style.display = "none";
    	document.getElementById('edit_obProxyPort').style.display = "none";
    	document.getElementById('edit_obProxyAddr2').style.display = "none";
    	document.getElementById('edit_obProxyPort2').style.display = "none";
    }
    else
    {
    	...
    	document.getElementById('edit_proxyAddr').style.display = "";
    	document.getElementById('edit_proxyPort').style.display = "";
    	document.getElementById('edit_obProxyAddr').style.display = "";
    	document.getElementById('edit_obProxyPort').style.display = "";
    	document.getElementById('edit_obProxyAddr2').style.display = "";
    	document.getElementById('edit_obProxyPort2').style.display = "";    
    }
}	
