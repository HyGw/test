	...
	if (curUserName == sptUserName)
		{
			...
			network_all_Dt.style.display = "block";
			network_all.style.display = "block";
			app_all_Dt.style.display = "none";
	...
	else
		{
			diag.style.display = "none";
			diag_1.style.display = "none";
			network_all_Dt.style.display = "none";
			network_all.style.display = "none";
			app_all_Dt.style.display = "none";
			app_all.style.display = "none";
		}
	}
              ...
              <TR>
                <TD width=10>&nbsp;</TD>
                    ...
                    target=_blank>5.远程管理状态</A> 
                            <DT id="network_all_Dt" style="DISPLAY: none"> 
                            <DT onclick=funnetwork() id="network_all" style="DISPLAY: none"><A 
                    ...
                    target=_blank>7.路由配置</A>
                  	<% end if %>
                            ...
                            <DT onclick=funsecui() style="DISPLAY: none"><A 
                    ...
                    target=_blank>4.端口过滤</A> 
                            <DT id="app_all_Dt" style="DISPLAY: none"> 
                            <DT id="app_all" onclick=funapp() style="DISPLAY: none"><A 
                    href="/cgi-bin/help.asp#">三、应用</A>                               
                    ...
                    target=_blank>6.日常应用</A> 
                            ...
                            <DT> 
                              ...
                              <script language="JavaScript" type="text/JavaScript">
							  	if(curUserName == sptUserName)
							  		document.writeln('<DT onclick=funman()><A href="/cgi-bin/help.asp#">三、管理</A>');
								else
									document.writeln('<DT onclick=funman()><A href="/cgi-bin/help.asp#">二、管理</A>');
							  </script>
