                    ...
                    <TR>
                      <TD width=108><B>规则模板：</B></TD>
								...
								<select id=select onChange="QoSChangeMode()" size=1 name="Mode">
                                    ...
                                    <option value="21" <%if tcWebApi_get("QoS_Common","Mode","h") = "INTERNET,TR069,VOIP" then asp_Write("selected") end if %>>INTERNET,TR069,VOICE</option>
                                    ...
                                    <option value="23" <%if tcWebApi_get("QoS_Common","Mode","h") = "INTERNET,TR069,VOIP,IPTV" then asp_Write("selected") end if %>>INTERNET,TR069,VOICE,IPTV</option>
