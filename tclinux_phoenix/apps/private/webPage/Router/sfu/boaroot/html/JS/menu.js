...
if(vPageMap[2][0] == '1'){
	if(vPageMap[2][1] == '1')
		...
		MenuArray[iCount++] = new MenuNodeConstruction(1, "网络", "/cgi-bin/net-loidset.asp", "");
...
if(vPageMap[2][5] == '1')
	MenuArray[iCount++] = new MenuNodeConstruction(2, "LOID配置管理", "/cgi-bin/net-loidset.asp", "");
if(vPageMap[2][6] == '1')
...
function MakeMenu_L1(Menu_Text)
{
	...
	for (iCount = 0; MenuArray[iCount].Level != 0; iCount++)
	{
		...
		if (MenuArray[iCount].Level == 1)
		{
			if (MenuArray[iCount].Text != Menu_Text)
			{
				Code += '<td bgcolor="#DA6825" height="30px"><a href="javascript:' + str + '" target="' + MenuArray[iCount].Target + '" class="Menu_L1_Link"><p align="center"><font color=#FFFFFF>' + MenuArray[iCount].Text + '</font></p></a></td>';
			}
			else
			{
				Code += '<td bgcolor="#FFFFFF" height="30px"><a href="javascript:' + str + '" target="' + MenuArray[iCount].Target + '" class="Menu_L1_Active"><p align="center"><font color=#DA6825>' + MenuArray[iCount].Text + '</font></p></a></td>';
			}
		}
	}
	Code += '</tr></table>';
...
{
	var Code = '<table border="0" cellpadding="0" cellspacing="0" height="15px"><tr><td width="10px"><td width="7px" class="Menu_L2_Link"><p><font color=#DA6825>|</font></p></td>';
	for (var iCount = Start; (MenuArray[iCount].Level != 0) && (MenuArray[iCount].Level != 1); iCount++)
	{
		...
		if (MenuArray[iCount].Level == 2)
		{
			if (MenuArray[iCount].Text != Menu_Text)
			{				
				Code += '<td height="30px"><p align="center"><a href="javascript:' + str + '" target="' + MenuArray[iCount].Target + '" class="Menu_L2_Link"><p><font color=#DA6825> ' + MenuArray[iCount].Text + ' </font></p></a></td>';
			}
			else
			{
				Code += '<td height="30px"><p align="center"><a href="javascript:' + str + '" target="' + MenuArray[iCount].Target + '" class="Menu_L2_Active"><p><font color=#DA6825> ' + MenuArray[iCount].Text + ' </font></p></a></td>';
			}
			Code += '<td width="7px" class="Menu_L2_Link"><p><font color=#DA6825>|</font></p></td>';
		}
	}
	Code += '</tr></table>';
