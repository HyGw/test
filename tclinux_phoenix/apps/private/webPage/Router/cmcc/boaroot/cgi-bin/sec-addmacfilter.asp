...
<tr>
<td width="157" bgcolor="#e7e7e7" height="30"><p class="Item_L1">MAC过滤</p></td>
...
<tr>
<td valign='top'><a href="/cgi-bin/help_content.asp#MAC过滤" target="_blank"><img src="/img/help.gif" width="40" height="34" border="0"></a></td>
</tr>
<% if tcwebApi_get("WebCustom_Entry","isCYE8SFUSupported","h") = "Yes" then %>
              <TR>
