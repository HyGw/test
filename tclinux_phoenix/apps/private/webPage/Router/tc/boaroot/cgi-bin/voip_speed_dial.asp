...
<FORM METHOD="POST" ACTION="/cgi-bin/voip_speed_dial.asp" name="VOIP_SPEED_DIAL_form"><table width="760" border="0" align=center cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
	...
	<tr>
		...
		<INPUT TYPE="HIDDEN" NAME="VoIPDestinationTmp" VALUE="Proxy">
		<INPUT TYPE="HIDDEN" NAME="VoIPDestination" VALUE="Proxy">
	...
	<tr>
		...
		<td class="tabdata" align=center>:</td>
		<td class="tabdata">
			<INPUT TYPE="TEXT" NAME="VoIPSpeedDialNumber" SIZE="14" MAXLENGTH="12" VALUE="<%if TCWebAPI_get("VoIPSpeed_Entry", "SpeedDialNumber", "h") <> "N/A" then TCWebAPI_get("VoIPSpeed_Entry", "SpeedDialNumber", "s") else asp_Write("") end if %>">
		</td></tr>
	<tr>
		<td class="light-orange">&nbsp;</td><td class="light-orange"></td>
		...
		<td class="tabdata" align=center>:</td>
		<td class="tabdata">
			<INPUT TYPE="TEXT" NAME="VoIPUserId" SIZE="14" MAXLENGTH="12" VALUE="<%if TCWebAPI_get("VoIPSpeed_Entry", "UserId", "h") <> "N/A" then TCWebAPI_get("VoIPSpeed_Entry", "UserId", "s") else asp_Write("") end if %>">
		</td></tr>
