...
<%if tcWebApi_get("WebCustom_Entry","isCZH168NSupported","h") = "Yes"  then%>
  if (value < 1 || value > 5){
    alert("DTIM value must be between 1 and 5");		return true;
	}
<%else%>
...
function doSave(){
	...
	if(WEPSelectIndex == 1){ 
	  ...
	  if(((document.WLAN.DefWEPKey3[0].checked) && (document.WLAN.WEP_Key13.value.length==0))||
	  ((document.WLAN.DefWEPKey3[1].checked) && (document.WLAN.WEP_Key23.value.length==0))||
	  ((document.WLAN.DefWEPKey3[2].checked) && (document.WLAN.WEP_Key33.value.length==0))||
	  ((document.WLAN.DefWEPKey3[3].checked) && (document.WLAN.WEP_Key43.value.length==0)))
		{
		 	alert("Invalid Key Value");
			return false;
		}
	...
	if(WEPSelectIndex == 2){ 
		document.WLAN.hRekeyMethod.value = "DISABLE";
		if(((document.WLAN.DefWEPKey4[0].checked) && (document.WLAN.WEP_Key14.value.length==0))||
	  ((document.WLAN.DefWEPKey4[1].checked) && (document.WLAN.WEP_Key24.value.length==0))||
	  ((document.WLAN.DefWEPKey4[2].checked) && (document.WLAN.WEP_Key34.value.length==0))||
	  ((document.WLAN.DefWEPKey4[3].checked) && (document.WLAN.WEP_Key44.value.length==0)))
		{
			alert("Invalid Key Value");
			return false;
		}
...
function RefreshPage(){
	...
	if(document.WLAN.SSID_INDEX.selectedIndex==0){
		document.getElementById("PERSSID_SWITCH_id").style.display="none";
	}else{
		document.getElementById("PERSSID_SWITCH_id").style.display="";
	}
	<%end if%>
	var vAuthMode = document.WLAN.WEP_Selection.value;
...
function deavtiveWifi(){
		alert("Shut down WIFI will close FON service!");
		return true;
}
<%end if%>
...
<table width="760" border="0" align=center cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
	...
	<% If tcWebApi_get("WebCustom_Entry","isFonV2Support","h") = "Yes" Then%>
			<INPUT TYPE="RADIO" NAME="wlan_APenable" VALUE="0" onClick="deavtiveWifi();" <% if tcWebApi_get("WLan_Common","APOn","h") = "0" then asp_Write("checked") end if %> <% if tcWebApi_get("WLan_Common","APOn","h") = "N/A" then asp_Write("checked") end if %> ><font color="#000000">Deactivated</font>
	<% Else %>  
...
<script language="JavaScript" type='text/javascript'>
	...
	<tr>
		...
		<td class="tabdata"><div align=center>:</div></td>
		<td class="tabdata">
			<INPUT TYPE="TEXT" NAME="DTIM" SIZE="7" MAXLENGTH="5" VALUE="<%If tcWebApi_get("WLan_Common","DtimPeriod","h") <> "N/A" then tcWebApi_get("WLan_Common","DtimPeriod","s") else asp_Write("1") end if%>" ><font color="#000000"><%if tcWebApi_get("WebCustom_Entry","isCZH168NSupported","h") = "Yes"  then asp_Write("(range: 1~5)") else asp_Write("(range: 1~255)") end if%></font>
		</td>
	</tr>
	<tr>
		<td class="light-orange">&nbsp;</td>
  ...
  <tr>
    ...
    <td class="tabdata"><div align="center">:</div></td>
      <td class="tabdata"> <select name="WLANChannelBandwidth" onChange="doChannelBandwidthChange();">
		<option value="0" 
		<% if tcWebApi_get("WLan_Common","HT_BW","h") = "0" then asp_Write("selected") end if %>>20 MHz</option>
		<% if tcWebApi_get("WebCustom_Entry","isHTBW40M","h") = "Yes" then %>
			<option value="1" 
			...
			<%End If%>
			<% if tcWebApi_get("WLan_Common","HT_BW","h") = "N/A" then asp_Write("selected") end if %>>20/40 MHz</option>
			<option value="2" 
...
<% if tcWebApi_get("WLan_Common","rt_device","h") = "5392" then %>
  ...
  <% If tcWebApi_get("Info_WLan","is11nSpecComply","h") = "Yes" Then %>	
	<tr>
		<td class="light-orange"></td>
		<td class="light-orange"></td>
		<td class="tabdata"><div align=right><font color="#000000">AMPDU(BA)</font></div></td>
		<td class="tabdata"><div align=center>:</div></td>
		<td class="tabdata">
			<INPUT TYPE="RADIO" NAME="wlan_AMPDU" VALUE="1" <% if tcWebApi_get("WLan_Common","HT_AutoBA","h") <> "0" then asp_Write("checked") end if %> ><font color="#000000">Enable</font>        
			<INPUT TYPE="RADIO" NAME="wlan_AMPDU" VALUE="0" <% if tcWebApi_get("WLan_Common","HT_AutoBA","h") = "0" then asp_Write("checked") end if %> ><font color="#000000">Disable</font>
		</td>
	</tr>
	<tr>
		<td class="light-orange"></td>
		<td class="light-orange"></td>
		<td class="tabdata"><div align=right><font color="#000000">AMSDU</font></div></td>
		<td class="tabdata"><div align=center>:</div></td>
		<td class="tabdata">
			<INPUT TYPE="RADIO" NAME="wlan_AMSDU" VALUE="1" <% if tcWebApi_get("WLan_Common","HT_AMSDU","h") = "1" then asp_Write("checked") end if %> ><font color="#000000">Enable</font>        
			<INPUT TYPE="RADIO" NAME="wlan_AMSDU" VALUE="0" <% if tcWebApi_get("WLan_Common","HT_AMSDU","h") <> "1" then asp_Write("checked") end if %>><font color="#000000">Disable</font>
		</td>
	</tr>
	<tr>
		<td class="light-orange"></td>
		<td class="light-orange"></td>
		<td class="tabdata"><div align=right><font color="#000000">Greenfiled</font></div></td>
		<td class="tabdata"><div align=center>:</div></td>
		<td class="tabdata">
			<INPUT TYPE="RADIO" NAME="wlan_Greenfiled" VALUE="1" <% if tcWebApi_get("WLan_Common","HT_OpMode","h") = "1" then asp_Write("checked") end if %> ><font color="#000000">Enable</font>        
			<INPUT TYPE="RADIO" NAME="wlan_Greenfiled" VALUE="0" <% if tcWebApi_get("WLan_Common","HT_OpMode","h") = "0" then asp_Write("checked") end if %> >Disable</font>
		</td>
	</tr>
	<tr>
		<td class="light-orange"></td>
		<td class="light-orange"></td>
		<td class="tabdata"><div align=right><font color="#000000">STBC</font></div></td>
		<td class="tabdata"><div align=center>:</div></td>
		<td class="tabdata">
			<INPUT TYPE="RADIO" NAME="wlan_STBC" VALUE="1" <% if tcWebApi_get("WLan_Common","HT_STBC","h") <> "0" then asp_Write("checked") end if %> ><font color="#000000">Enable</font>        
			<INPUT TYPE="RADIO" NAME="wlan_STBC" VALUE="0" <% if tcWebApi_get("WLan_Common","HT_STBC","h") = "0" then asp_Write("checked") end if %> ><font color="#000000">Disable</font>
		</td>
	</tr>	
	<tr>
		<td class="light-orange"></td>
		<td class="light-orange"></td>
		<td class="tabdata"><div align=right><font color="#000000">Disallow TKIP</font></div></td>
		<td class="tabdata"><div align=center>:</div></td>
		<td class="tabdata">
			<INPUT TYPE="RADIO" NAME="wlan_DisallowTKIP" VALUE="1" <% if tcWebApi_get("WLan_Common","HT_DisallowTKIP","h") <> "0" then asp_Write("checked") end if %> ><font color="#000000">Enable</font>        
			<INPUT TYPE="RADIO" NAME="wlan_DisallowTKIP" VALUE="0" <% if tcWebApi_get("WLan_Common","HT_DisallowTKIP","h") = "0" then asp_Write("checked") end if %> ><font color="#000000">Disable</font>
		</td>
	</tr>	
	<%End If%>
  </table>
...
<% if tcWebApi_get("WebCustom_Entry","isWPSSupported","h") = "Yes"  then %>
  ...
  <%If tcWebApi_get("WebCustom_Entry","isCZGeneralSupported","h") = "0" then %>
  <tr>
    <td class="light-orange">&nbsp;</td>
    <td class="light-orange">&nbsp;</td>
    <td class="tabdata"><div align="right"></div></td>
...
<table width="760" border="0" align=center cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
	...
	<tr>
      ...
      <tr> 
        ...
        <td class="tabdata"><div align="center">:</div></td>
        <td class="tabdata"> <input name="radiusSVR_Key1" type="text" value="<%if tcWebApi_get("WLan_Entry","RADIUS_Key","h") <> "N/A" then tcWebApi_get("WLan_Entry","RADIUS_Key","s") end if%>" size="48" maxlength="64" onBlur="RadiusKeyCheck(this)"><font color="#000000">(8~63 characters or 64 Hex string)</font></td>
      </tr> 
    ...
    <td class="light-orange"></td>
      ...
      <tr> 
        ...
        <td class="tabdata"><div align="right">Radius Share secret </div></td>
        <td class="tabdata"><div align="center">:</div></td>
        <td class="tabdata"> <input name="radiusSVR_Key2" type="text" value="<%if tcWebApi_get("WLan_Entry","RADIUS_Key","h") <> "N/A" then tcWebApi_get("WLan_Entry","RADIUS_Key","s") end if%>" size="48" maxlength="64" onBlur="RadiusKeyCheck(this)"><font color="#000000">(8~63 characters or 64 Hex string)</font> 
        </td>
      </tr>
	  <% if tcWebApi_get("Info_WLan","isDot1XEnhanceSupported","h") = "Yes" then %>
	  <tr> 
	...
	<tr>		
      ...
      <tr> 
        ...
        <td class="tabdata"><div align="right">Radius Share secret </div></td>
        <td class="tabdata"><div align="center">:</div></td>
        <td class="tabdata"> <input name="radiusSVR_Key3" type="text" value="<%if tcWebApi_get("WLan_Entry","RADIUS_Key","h") <> "N/A" then tcWebApi_get("WLan_Entry","RADIUS_Key","s") end if%>" size="48" maxlength="64" onBlur="RadiusKeyCheck(this)"><font color="#000000">(8~63 characters or 64 Hex string)</font> 
        </td>
      </tr>
	  <% if tcWebApi_get("Info_WLan","isDot1XEnhanceSupported","h") = "Yes" then %>
	  <tr> 
      ...
      <tr> 
        ...
        <td class="tabdata"> <SELECT NAME="TKIP_Selection1" onChange="doEncryptionChange(this)" SIZE="1">
            ...
            <OPTION value="TKIPAES" <% if tcWebApi_get("WLan_Entry","EncrypType","h") = "TKIPAES" then asp_Write("selected") end if %>>TKIP/AES 
          </SELECT> </td>
      </tr>
	  <tr>
     	<td class="light-orange">&nbsp;</td>
	...
	<table width="760" border="0" align=center cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
      ...
      <tr> 
        ...
        <td class="tabdata"><div align="right">Radius Share secret </div></td>
        <td class="tabdata"><div align="center">:</div></td>
        <td class="tabdata"> <input name="radiusSVR_Key4" type="text" value="<%if tcWebApi_get("WLan_Entry","RADIUS_Key","h") <> "N/A" then tcWebApi_get("WLan_Entry","RADIUS_Key","s") end if%>" size="48" maxlength="64" onBlur="RadiusKeyCheck(this)"><font color="#000000">(8~63 characters or 64 Hex string)</font> 
        </td>
      </tr>
	  <% if tcWebApi_get("Info_WLan","isDot1XEnhanceSupported","h") = "Yes" then %>
	  <tr> 
	  ...
	  <tr>
		<td class="light-orange"></td>
		<td class="light-orange"></td>
		<td class="tabdata"><div align=right><font color="#000000">Pre-authentication</font></div></td>
		<td class="tabdata"><div align=center>:</div></td>
		<td class="tabdata">
			<INPUT TYPE="RADIO" NAME="wlan_PreAuth" VALUE="1" <% if tcWebApi_get("WLan_Entry","PreAuth","h") = "1" then asp_Write("checked") end if %> ><font color="#000000">Enable</font>        
			<INPUT TYPE="RADIO" NAME="wlan_PreAuth" VALUE="0" <% if tcWebApi_get("WLan_Entry","PreAuth","h") <> "1" then asp_Write("checked") end if %> ><font color="#000000">Disable</font>
		</td>
	</tr>
	<%end if%>
	  <tr>
	...
	<table width="760" border="0" align=center cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
      ...
      <tr> 
        ...
        <td class="tabdata"><div align="right">Radius Share secret </div></td>
        <td class="tabdata"><div align="center">:</div></td>
        <td class="tabdata"> <input name="radiusSVR_Key5" type="text" value="<%if tcWebApi_get("WLan_Entry","RADIUS_Key","h") <> "N/A" then tcWebApi_get("WLan_Entry","RADIUS_Key","s") end if%>" size="48" maxlength="64" onBlur="RadiusKeyCheck(this)"><font color="#000000">(8~63 characters or 64 Hex string)</font>
        </td>
      </tr>
	  <% if tcWebApi_get("Info_WLan","isDot1XEnhanceSupported","h") = "Yes" then %>
	  <tr> 
    ...
    <td class="tabdata"><div align="center">:</div></td>
 		<td class="tabdata">
			<INPUT TYPE="TEXT" NAME="WLANFLT_MAC1" SIZE="20" MAXLENGTH="20" 
	 		<%if tcwebApi_get("WebCustom_Entry", "isCZGeneralSupported", "h")="Yes" Then%>
			 	VALUE= "<% if tcWebApi_get("WLan_Entry","WLan_MAC0","h") <> "N/A" then tcWebApi_get("WLan_Entry","WLan_MAC0","s") else asp_Write("00:00:00:00:00:00") end if%>" 
			<%else%>
				VALUE= "<% if tcWebApi_get("WLan_Entry","WLan_MAC0","h") <> "N/A" then tcWebApi_get("WLan_Entry","WLan_MAC0","s") end if%>" 	
			<%end if%>
			onBlur="doMACcheck(this)">
		</td>
	</tr>
	<tr>
		<td class="light-orange">&nbsp;</td>
    ...
    <td class="tabdata"><div align="center">:</div></td>
 		<td class="tabdata">
			<INPUT TYPE="TEXT" NAME="WLANFLT_MAC2" SIZE="20" MAXLENGTH="20" 
	 		<%if tcwebApi_get("WebCustom_Entry", "isCZGeneralSupported", "h")="Yes" Then%>
			 	VALUE= "<% if tcWebApi_get("WLan_Entry","WLan_MAC1","h") <> "N/A" then tcWebApi_get("WLan_Entry","WLan_MAC1","s") else asp_Write("00:00:00:00:00:00") end if%>" 
			<%else%>
				VALUE= "<% if tcWebApi_get("WLan_Entry","WLan_MAC1","h") <> "N/A" then tcWebApi_get("WLan_Entry","WLan_MAC1","s") end if%>" 	
			<%end if%>
			onBlur="doMACcheck(this)">
		</td>
	</tr>
	<tr>
		...
		<td class="tabdata"><div align="center">:</div></td>
 		<td class="tabdata">
			<INPUT TYPE="TEXT" NAME="WLANFLT_MAC3" SIZE="20" MAXLENGTH="20" 
	 		<%if tcwebApi_get("WebCustom_Entry", "isCZGeneralSupported", "h")="Yes" Then%>
			 	VALUE= "<% if tcWebApi_get("WLan_Entry","WLan_MAC2","h") <> "N/A" then tcWebApi_get("WLan_Entry","WLan_MAC2","s") else asp_Write("00:00:00:00:00:00") end if%>" 
			<%else%>
				VALUE= "<% if tcWebApi_get("WLan_Entry","WLan_MAC2","h") <> "N/A" then tcWebApi_get("WLan_Entry","WLan_MAC2","s") end if%>" 	
			<%end if%>
			onBlur="doMACcheck(this)">
		</td>
	</tr>
    ...
    <td class="tabdata"><div align="center">:</div></td>
		<td class="tabdata">
			<INPUT TYPE="TEXT" NAME="WLANFLT_MAC4" SIZE="20" MAXLENGTH="20" 
	 		<%if tcwebApi_get("WebCustom_Entry", "isCZGeneralSupported", "h")="Yes" Then%>
			 	VALUE= "<% if tcWebApi_get("WLan_Entry","WLan_MAC3","h") <> "N/A" then tcWebApi_get("WLan_Entry","WLan_MAC3","s") else asp_Write("00:00:00:00:00:00") end if%>" 
			<%else%>
				VALUE= "<% if tcWebApi_get("WLan_Entry","WLan_MAC3","h") <> "N/A" then tcWebApi_get("WLan_Entry","WLan_MAC3","s") end if%>" 	
			<%end if%>
			onBlur="doMACcheck(this)">
		</td>
	</tr>
	<tr>
		...
		<td class="tabdata"><div align="center">:</div></td>
		<td class="tabdata">
			<INPUT TYPE="TEXT" NAME="WLANFLT_MAC5" SIZE="20" MAXLENGTH="20" 
	 		<%if tcwebApi_get("WebCustom_Entry", "isCZGeneralSupported", "h")="Yes" Then%>
			 	VALUE= "<% if tcWebApi_get("WLan_Entry","WLan_MAC4","h") <> "N/A" then tcWebApi_get("WLan_Entry","WLan_MAC4","s") else asp_Write("00:00:00:00:00:00") end if%>" 
			<%else%>
				VALUE= "<% if tcWebApi_get("WLan_Entry","WLan_MAC4","h") <> "N/A" then tcWebApi_get("WLan_Entry","WLan_MAC4","s") end if%>" 	
			<%end if%>
			onBlur="doMACcheck(this)">
		</td>
	</tr>
	<tr>
		...
		<td class="tabdata"><div align="center">:</div></td>
		<td class="tabdata">
			<INPUT TYPE="TEXT" NAME="WLANFLT_MAC6" SIZE="20" MAXLENGTH="20" 
	 		<%if tcwebApi_get("WebCustom_Entry", "isCZGeneralSupported", "h")="Yes" Then%>
			 	VALUE= "<% if tcWebApi_get("WLan_Entry","WLan_MAC5","h") <> "N/A" then tcWebApi_get("WLan_Entry","WLan_MAC5","s") else asp_Write("00:00:00:00:00:00") end if%>" 
			<%else%>
				VALUE= "<% if tcWebApi_get("WLan_Entry","WLan_MAC5","h") <> "N/A" then tcWebApi_get("WLan_Entry","WLan_MAC5","s") end if%>" 	
			<%end if%>
			onBlur="doMACcheck(this)">
		</td>
	</tr>
    ...
    <td class="tabdata"><div align="center">:</div></td>
		<td class="tabdata">
			<INPUT TYPE="TEXT" NAME="WLANFLT_MAC7" SIZE="20" MAXLENGTH="20" 
	 		<%if tcwebApi_get("WebCustom_Entry", "isCZGeneralSupported", "h")="Yes" Then%>
			 	VALUE= "<% if tcWebApi_get("WLan_Entry","WLan_MAC6","h") <> "N/A" then tcWebApi_get("WLan_Entry","WLan_MAC6","s") else asp_Write("00:00:00:00:00:00") end if%>" 
			<%else%>
				VALUE= "<% if tcWebApi_get("WLan_Entry","WLan_MAC6","h") <> "N/A" then tcWebApi_get("WLan_Entry","WLan_MAC6","s") end if%>" 	
			<%end if%>
			onBlur="doMACcheck(this)">
		</td>
	</tr>
	<tr>
		...
		<td class="tabdata"><div align="center">:</div></td>
		<td class="tabdata">
			<INPUT TYPE="TEXT" NAME="WLANFLT_MAC8" SIZE="20" MAXLENGTH="20" 
	 		<%if tcwebApi_get("WebCustom_Entry", "isCZGeneralSupported", "h")="Yes" Then%>
			 	VALUE= "<% if tcWebApi_get("WLan_Entry","WLan_MAC7","h") <> "N/A" then tcWebApi_get("WLan_Entry","WLan_MAC7","s") else asp_Write("00:00:00:00:00:00") end if%>" 
			<%else%>
				VALUE= "<% if tcWebApi_get("WLan_Entry","WLan_MAC7","h") <> "N/A" then tcWebApi_get("WLan_Entry","WLan_MAC7","s") end if%>" 	
			<%end if%>
			onBlur="doMACcheck(this)">
		</td>
	</tr>
