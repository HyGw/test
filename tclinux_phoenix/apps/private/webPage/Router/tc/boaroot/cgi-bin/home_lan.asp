...
function doPoolRangeAlias()
{
	...
	if( !ip_poolcheck(sIP,Pool_num,mask_local,lanip_local) ){
		alert("DHCP IP Pool can not contain Router Local IP!!");
		return false;
	}
...
<tr>
    <td class="light-orange">&nbsp;</td><td class="light-orange"></td><td class="tabdata"><div align=right>
<%if tcwebApi_get("WebCustom_Entry","isSNOOPSupported","h") = "Yes" then%>	
    <font color="#000000">Snoop</font>    </div></td><td class="tabdata"><div align=center>:</div></td><td class="tabdata">
 <%else%>
    <font color="#000000">IgmpSnooping</font>    </div></td><td class="tabdata"><div align=center>:</div></td><td class="tabdata">
<%end if%>
   <%if tcwebApi_get("WebCustom_Entry","isSNOOPSupported","h") = "Yes" then%>
   <INPUT NAME="lan_snoop" TYPE="RADIO" VALUE="Yes" <% If TCWebApi_get("Lan_Snoop","snoopEnable","h") = "Yes" then asp_Write("checked") end if%> >		<font color="#000000">Activated</font>		
		<INPUT TYPE="RADIO" NAME="lan_snoop" VALUE="No" <% If TCWebApi_get("Lan_Snoop","snoopEnable","h") = "No" then asp_Write("checked") end if%> >		<font color="#000000">Deactivated</font>	</td></tr>
   <%else%> 
...
<%if tcwebApi_get("WebCustom_Entry","isMLDSupported","h") = "Yes" then%>
	<tr>
    <td class="light-orange">&nbsp;</td><td class="light-orange"></td><td class="tabdata"><div align=right>
    <font color="#000000">MldSnooping</font>    </div></td><td class="tabdata"><div align=center>:</div></td><td class="tabdata">
  ...
  <tr height="42" >
    ...
    <td width="160" class="black">&nbsp;</td><td width="160" class="orange">&nbsp;</td><td width="440" class="orange">
        ...
        <INPUT TYPE="button" NAME="SaveBtn" VALUE="SAVE" onClick="uiSave()">        
		 <% If tcWebApi_get("WebCustom_Entry","isCZGeneralSupported","h") = "Yes" Then%>
		 <INPUT TYPE="button" NAME="lan_cancel" VALUE="CANCEL" onClick="location.href=location.href;">
		 <%else%>
