...
<%TCWebApi_get(VLAN_INDEX)%>
    ...
    <font color="#000000"><%If TCWebApi_get("WebCustom_Entry", "haveXPON", "h") = "Yes" Then%>WANs<%ElseIf%>ATM VCs<%End If%></font>    </div></td><td class="tabdata"><div align=center>:</div></td><td width="440" height="80" class="tabdata">
