...
<table width="760" border="0" align=center cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
	...
	<tr>
		...
		<INPUT TYPE="RADIO" NAME="Stat_Radio" VALUE="4" <%If tcWebApi_get("WebCurSet_Entry","statis_type","h") = "4" then asp_Write("checked") end if%>  onClick="document.Stat_Form.submit()">
		<font color="#000000"><%if tcWebApi_get("XPON_LinkCfg","LinkSta","h") = "1" then%>GPON<%elseif tcWebApi_get("XPON_LinkCfg","LinkSta","h") = "2" then%>EPON<%else%>xPON<%end if%></font>
		<%end if%>
...
<% If tcWebApi_get("WebCurSet_Entry","statis_type","h") = "1" Then %>
		<tr>
			<td class='tabdata'>&nbsp;&nbsp;Transmit Total PDUs</td><td class='tabdata'><div align='center'><% if Request_Form("clearFlag")="1" then asp_Write("0") else tcWebApi_get("Info_Adsl","outPkts","s") end if %></div></td>
			<td class='tabdata'>&nbsp;&nbsp;Receive Total PDUs</td><td class='tabdata'><div align='center'><% if Request_Form("clearFlag")="1" then asp_Write("0") else tcWebApi_get("Info_Adsl","inPkts","s") end if %></div></td></tr>
		<tr>
			<td class='tabdata'>&nbsp;&nbsp;Transmit Total Error Counts</td><td class='tabdata'><div align='center'><% if Request_Form("clearFlag")="1" then asp_Write("0") else tcWebApi_get("Info_Adsl","outDiscards","s") end if %></div></td>
			<td class='tabdata'>&nbsp;&nbsp;Receive Total Error Counts</td><td class='tabdata'><div align='center'><% if Request_Form("clearFlag")="1" then asp_Write("0") else tcWebApi_get("Info_Adsl","inDiscards","s") end if %></div></td></tr>
...
<% Elseif tcWebApi_get("WebCurSet_Entry","statis_type","h") = "2" Then %>
		<tr>
			<td class='tabdata'>&nbsp;&nbsp;Tx Frames Count</td><td class='tabdata'><div align='center'><% if Request_Form("clearFlag")="1" then asp_Write("0") else tcWebApi_get("Info_WLan","wlanTxFrames","s") end if %></div></td>
			<td class='tabdata'>&nbsp;&nbsp;Rx Frames Count</td><td class='tabdata'><div align='center'><% if Request_Form("clearFlag")="1" then asp_Write("0") else tcWebApi_get("Info_WLan","wlanRxFrames","s") end if %></div></td></tr>
		<tr>
			<td class='tabdata'>&nbsp;&nbsp;Tx Errors Count</td><td class='tabdata'><div align='center'><% if Request_Form("clearFlag")="1" then asp_Write("0") else tcWebApi_get("Info_WLan","wlanTxErrFrames","s") end if %></div></td>
			<td class='tabdata'>&nbsp;&nbsp;Rx Errors Count</td><td class='tabdata'><div align='center'><% if Request_Form("clearFlag")="1" then asp_Write("0") else tcWebApi_get("Info_WLan","wlanRxErrFrames","s") end if %></div></td></tr>
		<tr>
			<td class='tabdata'>&nbsp;&nbsp;Tx Drops Count</td><td class='tabdata'><div align='center'><% if Request_Form("clearFlag")="1" then asp_Write("0") else tcWebApi_get("Info_WLan","wlanTxDropFrames","s") end if %></div></td>
			<td class='tabdata'>&nbsp;&nbsp;Rx Drops Count</td><td class='tabdata'><div align='center'><% if Request_Form("clearFlag")="1" then asp_Write("0") else tcWebApi_get("Info_WLan","wlanRxDropFrames","s") end if %></div></td></tr>

 <% ElseIf tcWebApi_get("WebCurSet_Entry","statis_type","h") = "3" Then %>
		<tr>
			<td class='tabdata'>&nbsp;&nbsp;Transmit Frames</td><td class='tabdata'><div align='center'><% if Request_Form("clearFlag")="1" then asp_Write("0") else tcWebApi_get("Info_Wan0","txFrames","s") end if %></div></td>
			<td class='tabdata'>&nbsp;&nbsp;Receive Frames</td><td class='tabdata'><div align='center'><% if Request_Form("clearFlag")="1" then asp_Write("0") else tcWebApi_get("Info_Wan0","rxFrames","s") end if %></div></td></tr>
		<tr>
			<td class='tabdata'>&nbsp;&nbsp;Transmit Multicast Frames</td><td class='tabdata'><div align='center'><% if Request_Form("clearFlag")="1" then asp_Write("0") else tcWebApi_get("Info_Wan0","outMulticastPkts","s") end if %></div></td>
			<td class='tabdata'>&nbsp;&nbsp;Receive Multicast Frame</td><td class='tabdata'><div align='center'><% if Request_Form("clearFlag")="1" then asp_Write("0") else tcWebApi_get("Info_Wan0","inMulticastPkts","s") end if %></div></td></tr>
		<tr>
			<td class='tabdata'>&nbsp;&nbsp;Transmit total Bytes</td><td class='tabdata'><div align='center'><% if Request_Form("clearFlag")="1" then asp_Write("0") else tcWebApi_get("Info_Wan0","outOctets","s") end if %></div></td>
			<td class='tabdata'>&nbsp;&nbsp;Receive total Bytes</td><td class='tabdata'><div align='center'><% if Request_Form("clearFlag")="1" then asp_Write("0") else tcWebApi_get("Info_Wan0","inOctets","s") end if %></div></td></tr>
		<tr>
			<td class='tabdata'>&nbsp;&nbsp;Transmit Collision</td><td class='tabdata'><div align='center'><% if Request_Form("clearFlag")="1" then asp_Write("0") else tcWebApi_get("Info_Wan0","txCollisionCnt","s") end if %></div></td>
			<td class='tabdata'>&nbsp;&nbsp;Receive CRC Errors</td><td class='tabdata'><div align='center'><% if Request_Form("clearFlag")="1" then asp_Write("0") else tcWebApi_get("Info_Wan0","rxCrcErr","s") end if %></div></td></tr>
		<tr>
			<td class='tabdata'>&nbsp;&nbsp;Transmit Error Frames</td><td class='tabdata'><div align='center'><% if Request_Form("clearFlag")="1" then asp_Write("0") else tcWebApi_get("Info_Wan0","outErrors","s") end if %></div></td>
			<td class='tabdata'>&nbsp;&nbsp;Receive Under-size Frames</td><td class='tabdata'><div align='center'><% if Request_Form("clearFlag")="1" then asp_Write("0") else tcWebApi_get("Info_Wan0","txUnderRunCnt","s") end if %></div></td></tr>

<% Else %>
		<tr>
			<td class='tabdata'>&nbsp;&nbsp;Transmit Frames</td><td class='tabdata'><div align='center'><% if Request_Form("clearFlag")="1" then asp_Write("0") else tcWebApi_get("Info_Ether","txFrames","s") end if %></div></td>
			<td class='tabdata'>&nbsp;&nbsp;Receive Frames</td><td class='tabdata'><div align='center'><% if Request_Form("clearFlag")="1" then asp_Write("0") else tcWebApi_get("Info_Ether","rxFrames","s") end if %></div></td></tr>
		<tr>
			<td class='tabdata'>&nbsp;&nbsp;Transmit Multicast Frames</td><td class='tabdata'><div align='center'><% if Request_Form("clearFlag")="1" then asp_Write("0") else tcWebApi_get("Info_Ether","outMulticastPkts","s") end if %></div></td>
			<td class='tabdata'>&nbsp;&nbsp;Receive Multicast Frame</td><td class='tabdata'><div align='center'><% if Request_Form("clearFlag")="1" then asp_Write("0") else tcWebApi_get("Info_Ether","inMulticastPkts","s") end if %></div></td></tr>
		<tr>
			<td class='tabdata'>&nbsp;&nbsp;Transmit total Bytes</td><td class='tabdata'><div align='center'><% if Request_Form("clearFlag")="1" then asp_Write("0") else tcWebApi_get("Info_Ether","outOctets","s") end if %></div></td>
			<td class='tabdata'>&nbsp;&nbsp;Receive total Bytes</td><td class='tabdata'><div align='center'><% if Request_Form("clearFlag")="1" then asp_Write("0") else tcWebApi_get("Info_Ether","inOctets","s") end if %></div></td></tr>
		<tr>
			<td class='tabdata'>&nbsp;&nbsp;Transmit Collision</td><td class='tabdata'><div align='center'><% if Request_Form("clearFlag")="1" then asp_Write("0") else tcWebApi_get("Info_Ether","txCollisionCnt","s") end if %></div></td>
			<td class='tabdata'>&nbsp;&nbsp;Receive CRC Errors</td><td class='tabdata'><div align='center'><% if Request_Form("clearFlag")="1" then asp_Write("0") else tcWebApi_get("Info_Ether","rxCrcErr","s") end if %></div></td></tr>
		<tr>
			<td class='tabdata'>&nbsp;&nbsp;Transmit Error Frames</td><td class='tabdata'><div align='center'><% if Request_Form("clearFlag")="1" then asp_Write("0") else tcWebApi_get("Info_Ether","outErrors","s") end if %></div></td>
			<td class='tabdata'>&nbsp;&nbsp;Receive Under-size Frames</td><td class='tabdata'><div align='center'><% if Request_Form("clearFlag")="1" then asp_Write("0") else tcWebApi_get("Info_Ether","txUnderRunCnt","s") end if %></div></td></tr>
...
<% ElseIf tcWebApi_get("WebCurSet_Entry","statis_type","h") = "4" Then %>
		<tr>
			<td class='tabdata'>&nbsp;&nbsp;Transmit Frames</td><td class='tabdata'><div align='center'><% tcWebApi_get("Info_PonWanStats","TxFrameCnt","s") %></div></td>
			<td class='tabdata'>&nbsp;&nbsp;Receive Frames</td><td class='tabdata'><div align='center'><% tcWebApi_get("Info_PonWanStats","RxFrameCnt","s") %></div></td></tr>
		<tr>
			<td class='tabdata'>&nbsp;&nbsp;Transmit total Bytes</td><td class='tabdata'><div align='center'><% tcWebApi_get("Info_PonWanStats","TxFrameLen","s") %></div></td>
			<td class='tabdata'>&nbsp;&nbsp;Receive total Bytes</td><td class='tabdata'><div align='center'><% tcWebApi_get("Info_PonWanStats","RxFrameLen","s") %></div></td></tr>
		<tr>
			<td class='tabdata'>&nbsp;&nbsp;Transmit Multicast Frames</td><td class='tabdata'><div align='center'><% tcWebApi_get("Info_PonWanStats","TxMulticastCnt","s") %></div></td>
			<td class='tabdata'>&nbsp;&nbsp;Receive Multicast Frame</td><td class='tabdata'><div align='center'><%tcWebApi_get("Info_PonWanStats","RxMulticastCnt","s") %></div></td></tr>
		<tr>
			<td class='tabdata'>&nbsp;&nbsp;Transmit Broadcast Frames</td><td class='tabdata'><div align='center'><% tcWebApi_get("Info_PonWanStats","TxBroadcastCnt","s") %></div></td>
			<td class='tabdata'>&nbsp;&nbsp;Receive Broadcast Frame</td><td class='tabdata'><div align='center'><%tcWebApi_get("Info_PonWanStats","RxBroadcastCnt","s") %></div></td></tr>
		<tr>
			<td class='tabdata'>&nbsp;&nbsp;Transmit Collision</td><td class='tabdata'><div align='center'><% tcWebApi_get("Info_PonWanStats","TxDropCnt","s") %></div></td>
			<td class='tabdata'>&nbsp;&nbsp;Receive CRC Errors</td><td class='tabdata'><div align='center'><% tcWebApi_get("Info_PonWanStats","RxCrcCnt","s") %></div></td></tr>
		<tr>
			<td class='tabdata'>&nbsp;&nbsp;Transmit Under-size Frames</td><td class='tabdata'><div align='center'><% tcWebApi_get("Info_PonWanStats","TxLess64Cnt","s") %></div></td>
			<td class='tabdata'>&nbsp;&nbsp;Receive Under-size Frames</td><td class='tabdata'><div align='center'><% tcWebApi_get("Info_PonWanStats","RxLess64Cnt","s") %></div></td></tr>
...
<% End If %>
	...
	<tr>
		...
		<INPUT TYPE="SUBMIT" NAME="StatRefresh" VALUE="REFRESH">
<%if tcwebApi_get("WebCustom_Entry", "isCZGeneralSupported", "h")="Yes" Then%>
		<INPUT TYPE="BUTTON" NAME="StatClear" VALUE="CLEAR" onClick="uiSave()">
<%end if%></td></tr></table>
</form></body></html>
