...
var aryPVCactive = new Array("<% TcWebApi_get("Wan_PVC0","Active","s")%>", "<% TcWebApi_get("Wan_PVC1","Active","s")%>", "<% TcWebApi_get("Wan_PVC2","Active","s")%>", "<% TcWebApi_get("Wan_PVC3","Active","s")%>", "<% TcWebApi_get("Wan_PVC4","Active","s")%>", "<% TcWebApi_get("Wan_PVC5","Active","s")%>", "<% TcWebApi_get("Wan_PVC6","Active","s")%>", "<% TcWebApi_get("Wan_PVC7","Active","s")%>");
<%end if%>
<%else%>
...
<%if tcWebApi_get("WebCustom_Entry","isCZGeneralSupported","h") = "Yes" then%>	
var aryPVCactive = new Array("<% TcWebApi_get("Wan_PVC0","Active","s")%>","<% TcWebApi_get("Wan_PVC1","Active","s")%>", "<% TcWebApi_get("Wan_PVC2","Active","s")%>", "<% TcWebApi_get("Wan_PVC3","Active","s")%>", "<% TcWebApi_get("Wan_PVC4","Active","s")%>", "<% TcWebApi_get("Wan_PVC5","Active","s")%>", "<% TcWebApi_get("Wan_PVC6","Active","s")%>", "<% TcWebApi_get("Wan_PVC7","Active","s")%>","<% TcWebApi_get("WanExt_PVC8e0","Active","s")%>","<% TcWebApi_get("WanExt_PVC8e1","Active","s")%>","<% TcWebApi_get("WanExt_PVC8e2","Active","s")%>","<% TcWebApi_get("WanExt_PVC8e3","Active","s")%>","<% TcWebApi_get("WanExt_PVC8e4","Active","s")%>","<% TcWebApi_get("WanExt_PVC8e5","Active","s")%>","<% TcWebApi_get("WanExt_PVC8e6","Active","s")%>","<% TcWebApi_get("WanExt_PVC8e7","Active","s")%>","<% TcWebApi_get("WanExt_PVC9e0","Active","s")%>","<% TcWebApi_get("WanExt_PVC9e1","Active","s")%>","<% TcWebApi_get("WanExt_PVC9e2","Active","s")%>","<% TcWebApi_get("WanExt_PVC9e3","Active","s")%>","<% TcWebApi_get("WanExt_PVC9e4","Active","s")%>","<% TcWebApi_get("WanExt_PVC9e5","Active","s")%>","<% TcWebApi_get("WanExt_PVC9e6","Active","s")%>","<% TcWebApi_get("WanExt_PVC9e7","Active","s")%>","<% TcWebApi_get("WanExt_PVC10e0","Active","s")%>","<% TcWebApi_get("WanExt_PVC10e1","Active","s")%>","<% TcWebApi_get("WanExt_PVC10e2","Active","s")%>","<% TcWebApi_get("WanExt_PVC10e3","Active","s")%>","<% TcWebApi_get("WanExt_PVC10e4","Active","s")%>","<% TcWebApi_get("WanExt_PVC10e5","Active","s")%>","<% TcWebApi_get("WanExt_PVC10e6","Active","s")%>","<% TcWebApi_get("WanExt_PVC10e7","Active","s")%>");
<%end if%>
<%else%>
...
<%if tcWebApi_get("WebCustom_Entry","isCZGeneralSupported","h") = "Yes" then%>	
var aryPVCactive = new Array("<% TcWebApi_get("Wan_PVC0","Active","s")%>","<% TcWebApi_get("Wan_PVC1","Active","s")%>", "<% TcWebApi_get("Wan_PVC2","Active","s")%>", "<% TcWebApi_get("Wan_PVC3","Active","s")%>", "<% TcWebApi_get("Wan_PVC4","Active","s")%>", "<% TcWebApi_get("Wan_PVC5","Active","s")%>", "<% TcWebApi_get("Wan_PVC6","Active","s")%>", "<% TcWebApi_get("Wan_PVC7","Active","s")%>","<% TcWebApi_get("Wan_PVC8","Active","s")%>","<% TcWebApi_get("Wan_PVC9","Active","s")%>","<% TcWebApi_get("Wan_PVC10","Active","s")%>");
<%end if%>
<%end if%>
<%end if%>
...
var routecount = 16;
function stStaticRoute(domain,DestIPAddress,staticSubnetMask)
{
	this.domain = domain;
...
function getStaticRouteInfo()
{
	...
	var vstaticSubnetMask = new Array(routecount);
	...
	vstaticSubnetMask[0] = "<% tcWebApi_get("Route_Entry0","Sub_mask","s") %>";
	vstaticSubnetMask[1] = "<% tcWebApi_get("Route_Entry1","Sub_mask","s") %>";
	vstaticSubnetMask[2] = "<% tcWebApi_get("Route_Entry2","Sub_mask","s") %>";
	vstaticSubnetMask[3] = "<% tcWebApi_get("Route_Entry3","Sub_mask","s") %>";
	vstaticSubnetMask[4] = "<% tcWebApi_get("Route_Entry4","Sub_mask","s") %>";
	vstaticSubnetMask[5] = "<% tcWebApi_get("Route_Entry5","Sub_mask","s") %>";
	vstaticSubnetMask[6] = "<% tcWebApi_get("Route_Entry6","Sub_mask","s") %>";
	vstaticSubnetMask[7] = "<% tcWebApi_get("Route_Entry7","Sub_mask","s") %>";
	vstaticSubnetMask[8] = "<% tcWebApi_get("Route_Entry8","Sub_mask","s") %>";
	vstaticSubnetMask[9] = "<% tcWebApi_get("Route_Entry9","Sub_mask","s") %>";
	vstaticSubnetMask[10] = "<% tcWebApi_get("Route_Entry10","Sub_mask","s") %>";
	vstaticSubnetMask[11] = "<% tcWebApi_get("Route_Entry11","Sub_mask","s") %>";
	vstaticSubnetMask[12] = "<% tcWebApi_get("Route_Entry12","Sub_mask","s") %>";
	vstaticSubnetMask[13] = "<% tcWebApi_get("Route_Entry13","Sub_mask","s") %>";
	vstaticSubnetMask[14] = "<% tcWebApi_get("Route_Entry14","Sub_mask","s") %>";
	vstaticSubnetMask[15] = "<% tcWebApi_get("Route_Entry15","Sub_mask","s") %>";
	
	for(var i=0; i<routecount; i++)
	{
		if(vDestIPAddress[i] != "N/A")
			vcurLinks[nCurTemp++] = new stStaticRoute(i, vDestIPAddress[i],vstaticSubnetMask[i]);
	}
...
function doSubmit(index) {
	...
	if(index)
	{
		...
		var stripvalue1 = document.forms[0].staticDestIP.value; 
		var stripvalue2 = document.forms[0].staticSubnetMask.value;		
		if ((strdstIPtmp == "N/A") || ((strdstIPtmp != "N/A") && (stripvalue1 != strdstIPtmp))) {
			for (i = 0; i < StaticRouteInfo.length - 1; i++)
			{
				if ((StaticRouteInfo[i].DestIPAddress == stripvalue1)&&(StaticRouteInfo[i].staticSubnetMask == stripvalue2))
				{
					alert(stripvalue1 + '/' + stripvalue2 + ' has added!');
					return false;
				}
			}
		}
...
<%if tcWebApi_get("WebCustom_Entry","isCZGeneralSupported","h") = "Yes" then%>					
				if(strActive == "No"){
					alert("Can not choose deactive Service!");
					return false;
				}
<%else%>
...
<%if tcWebApi_get("WebCustom_Entry","isCZGeneralSupported","h") = "Yes" then%>	
			if(strActive == "No"){
					alert("Can not choose deactive pvc !");
					return false;
			}
<%else%>
			if ((strisptmp == "0") || (strisptmp == "1")){
...
<%else%>
	<%if tcWebApi_get("WebCustom_Entry","haveXPON","h") = "Yes" then%>
    	<option value="PVC0" <%if Request_form("pvc_index_num") = "0" then asp_Write("selected") end if%>>WAN0
		<option value="PVC1" <%if Request_form("pvc_index_num") = "1" then asp_Write("selected") end if%>>WAN1
		<option value="PVC2" <%if Request_form("pvc_index_num") = "2" then asp_Write("selected") end if%>>WAN2
		<option value="PVC3" <%if Request_form("pvc_index_num") = "3" then asp_Write("selected") end if%>>WAN3
		<option value="PVC4" <%if Request_form("pvc_index_num") = "4" then asp_Write("selected") end if%>>WAN4
		<option value="PVC5" <%if Request_form("pvc_index_num") = "5" then asp_Write("selected") end if%>>WAN5
		<option value="PVC6" <%if Request_form("pvc_index_num") = "6" then asp_Write("selected") end if%>>WAN6
		<option value="PVC7" <%if Request_form("pvc_index_num") = "7" then asp_Write("selected") end if%>>WAN7
	<%else%>
	<%if tcWebApi_get("WebCustom_Entry","haveAtm","h") = "Yes" then%>
