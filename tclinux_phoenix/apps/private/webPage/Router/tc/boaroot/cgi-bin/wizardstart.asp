...
<table width="500" border="0" align="center" cellpadding="2" cellspacing="0">
  <tr>
    ...
    <td colspan="2" class="tabdata">    				
        The Wizard will guide you through these <% if tcWebApi_get("WebCustom_Entry","isC5VOLLCOMMSupport","h") = "Yes" then asp_write("three") else asp_write("four") end if %> quick steps. Begin by 
  ...
  <tr>
    ...
    <% if tcWebApi_get("WebCustom_Entry","isC5VOLLCOMMSupport","h") = "Yes" then asp_write("Step 2. Set your PPP connection") else asp_write("Step 2. Choose your time zone") end if %>    
...
<%end if%>
  <tr>
    ...
    <% if tcWebApi_get("WebCustom_Entry","isC5VOLLCOMMSupport","h") = "Yes" then asp_write("Step 3. Confirm the Configuration and Save it ") else asp_write("Step 4. Confirm the Configuration and Save it ") end if %>
