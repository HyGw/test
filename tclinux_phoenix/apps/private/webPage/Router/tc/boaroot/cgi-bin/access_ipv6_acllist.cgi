...
do
	node_name="Ipv6ACL_Entry$j"
  RuleActive=`/userfs/bin/tcapi get $node_name Activate`
  Ipv6Addr=`/userfs/bin/tcapi get $node_name Ipv6Addr`
  PrefixLen=`/userfs/bin/tcapi get $node_name PrefixLen`
  ...
  Interface=`/userfs/bin/tcapi get $node_name Interface`
	...
	if [ "$Ipv6Addr" = "no attribute information" -o "$APPLICATION" = "no node information" ]
	then
		Ipv6Addr="N/A"
	fi
	if [ "$PrefixLen" = "no attribute information" -o "$APPLICATION" = "no node information" ]
	then
		PrefixLen="N/A"
	fi
	...
	echo "<tr height=\"30\"><td width=\"60\" align=center class=\"tabdata\"><strong><font color=\"#000000\">$j</font></strong></td><td width=\"60\" align=center class=\"tabdata\"><strong><font color=\"#000000\">$RuleActive</font></strong></td><td width=\"180\" align=center class=\"tabdata\"><strong><font color=\"#000000\">$Ipv6Addr/$PrefixLen</font></strong></td><td width=\"90\" align=center class=\"tabdata\"><strong><font color=\"#000000\">$Application</font></strong></td><td width=\"80\" align=center class=\"tabdata\"><strong><font color=\"#000000\">$Interface</font></strong></td></tr>"
