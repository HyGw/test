...
function doAdd() {
  	...
  	<%if tcwebApi_get("WebCustom_Entry", "isCZGeneralSupported", "h")="Yes" Then%>
		if(!confirm("Are you sure you want to set these configurations?")) {
			return;
		}
	<%end if%>	
...
%>
		...
		<tr>
			...
			<td class="tabdata" align=right><font color="#000000">Destination MAC(00:00:00:00:00:00)</font></td>
			<td class="tabdata" align=center>:</td>
			<td class="tabdata">
		...
		<tr>
			...
			<td class="tabdata" align=center>:</td>
			<td class="tabdata">
				<INPUT TYPE="TEXT" NAME="QosDestIpValue" SIZE="39" MAXLENGTH="39" VALUE=
		...
		<tr>
			<td class="light-orange">&nbsp;</td>
			<td class="light-orange"></td>
			<td class="tabdata" align=right><font color="#000000">Source MAC(00:00:00:00:00:00)</font></td>
			<td class="tabdata" align=center>:</td>
			<td class="tabdata">
		...
		<tr>
			...
			<td class="tabdata" align=center>:</td>
			<td class="tabdata">
				<INPUT TYPE="TEXT" NAME="QosSrcIpValue" SIZE="39" MAXLENGTH="39" VALUE=
