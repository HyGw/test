<%
	...
	if request_Form("Add_or_Delete") = "1" then
		...
		if tcWebApi_get("WebCustom_Entry","haveXPON","h") = "Yes" then
			TCWebAPI_set("PortBind_Entry", "p0", "PortBind_PON_Port_0")
			TCWebAPI_set("PortBind_Entry", "p1", "PortBind_PON_Port_1")
			TCWebAPI_set("PortBind_Entry", "p2", "PortBind_PON_Port_2")
			TCWebAPI_set("PortBind_Entry", "p3", "PortBind_PON_Port_3")
			TCWebAPI_set("PortBind_Entry", "p4", "PortBind_PON_Port_4")
			TCWebAPI_set("PortBind_Entry", "p5", "PortBind_PON_Port_5")
			TCWebAPI_set("PortBind_Entry", "p6", "PortBind_PON_Port_6")
			TCWebAPI_set("PortBind_Entry", "p7", "PortBind_PON_Port_7")
		end if	
		...
		if tcWebApi_get("WebCustom_Entry","is3GDongleSupport","h") = "Yes" then
			TCWebAPI_set("PortBind_Entry", "3g0", "PortBind_3G_Port_0")
		end if
...
<%if tcWebApi_get("WebCustom_Entry","haveXPON","h") = "Yes" then%>
function ponOnOffSwitch(on_off)
{
	var port;
	for (port = 0; port < 8; port++) {
		var pt = document.getElementById("PortBind_PON_Port_" + port);
		var Tag = document.getElementById("PortBind_PON_Tag_" + port);
		if (on_off == 0) {
			pt.disabled = true;
			continue;
		}
...
function dongleSwitch(on_off)
{
	var port;
	for (port = 0; port < 1; port++) {
		var pt = document.getElementById("PortBind_3G_Port_" + port);
		var Tag = document.getElementById("PortBind_3G_Tag_" + port);
		if (on_off == 0) {
			pt.disabled = true;
			continue;
		}
...
<%end if%>
	...
	if(document.forms[0].UserMode.value != 1){
		var bssidNum = document.getElementById("MBSSIDNumber").value;
		if (bssidNum >= 2)
			document.getElementById("PortBind_Wireless_Port_1").disabled = true;		
	}else{
		var bssidNum = document.getElementById("MBSSIDNumber").value;
		if (bssidNum >= 2)
			document.getElementById("wlanPort_1").disabled = true;
	}
	<%end if%>
}
...
<%if tcWebApi_get("WebCustom_Entry","haveXPON","h") = "Yes" then%>
	/* pon port */
	for (port = 0; port < 8; port++) {
		var Tag = document.getElementById("PortBind_PON_Port_" + port);
		if (Tag.checked) {
			Tag.value = "Yes";
		}
		else {
...
<%if tcwebApi_get("WebCustom_Entry","is3GDongleSupport","h")="Yes" then%>	
	if(document.PortBind_form.dongleSupport.value ==1){
	/* 3g dongle port */
		for (port = 0; port < 1; port++) {
			var Tag = document.getElementById("PortBind_3G_Port_" + port);
			if (Tag.checked) {
				Tag.value = "Yes";
			}
			else {
...
function doDel(){
	...
	document.PortBind_form.Add_or_Delete.value = 2;
}              
...
<%if tcWebApi_get("WebCustom_Entry","haveXPON","h") = "Yes" then%>
	...
	<td width="150" class="tabdata"> <div align=right><font color="#000000">WANs</font></div></td>
	<td class="tabdata"><div align=center>:</div></td>
	<td width="440" height="80" class="tabdata">
		<table border="1" cellpadding="0" cellspacing="0" bordercolor="#CCCCCC">
			<tr> 
				...
				<td><div align=center> 
					<INPUT TYPE="CHECKBOX" NAME="PortBind_PON_Port_0" ID="PortBind_PON_Port_0" <% if tcWebApi_get("PortBind_Entry", "p0", "h") = "Yes" then asp_write("checked") end if%> >
				</div></td>
				<td><div align=center> 
					<INPUT TYPE="CHECKBOX" NAME="PortBind_PON_Port_1" ID="PortBind_PON_Port_1"<% if tcWebApi_get("PortBind_Entry", "p1", "h") = "Yes" then asp_write("checked") end if%> >
				</div></td>
				<td><div align=center> 
					<INPUT TYPE="CHECKBOX" NAME="PortBind_PON_Port_2" ID="PortBind_PON_Port_2"<%if tcWebApi_get("PortBind_Entry", "p2", "h") = "Yes" then asp_write("checked") end if%> >
				</div></td>
				<td><div align=center> 
					<INPUT TYPE="CHECKBOX" NAME="PortBind_PON_Port_3" ID="PortBind_PON_Port_3"<%if tcWebApi_get("PortBind_Entry", "p3", "h") = "Yes" then asp_write("checked") end if%> >
				</div></td>
				<td><div align=center> 
					<INPUT TYPE="CHECKBOX" NAME="PortBind_PON_Port_4" ID="PortBind_PON_Port_4"<% if tcWebApi_get("PortBind_Entry", "p4", "h") = "Yes" then asp_write("checked") end if%> >
				</div></td>
				<td><div align=center> 
					<INPUT TYPE="CHECKBOX" NAME="PortBind_PON_Port_5" ID="PortBind_PON_Port_5"<% if tcWebApi_get("PortBind_Entry", "p5", "h") = "Yes" then asp_write("checked") end if%> >
				</div></td>
				<td><div align=center> 
					<INPUT TYPE="CHECKBOX" NAME="PortBind_PON_Port_6" ID="PortBind_PON_Port_6"<% if tcWebApi_get("PortBind_Entry", "p6", "h") = "Yes" then asp_write("checked") end if%> >
				</div></td>
				<td><div align=center> 
					<INPUT TYPE="CHECKBOX" NAME="PortBind_PON_Port_7" ID="PortBind_PON_Port_7"<% if tcWebApi_get("PortBind_Entry", "p7", "h") = "Yes" then asp_write("checked") end if%> >
				</div></td>
			</tr>
			<tr class="tabdata"> 
				...
				<INPUT TYPE="HIDDEN" NAME="PortBind_PON_Tag_0" ID="PortBind_PON_Tag_0" VALUE="<%if tcWebApi_get("PortBind_Common", "p0", "h") <> "N/A" then tcWebApi_get("PortBind_Common", "p0", "s") end if%>">
				<INPUT TYPE="HIDDEN" NAME="PortBind_PON_Tag_1" ID="PortBind_PON_Tag_1" VALUE="<%if tcWebApi_get("PortBind_Common", "p1", "h") <> "N/A" then tcWebApi_get("PortBind_Common", "p1", "s") end if%>">
				<INPUT TYPE="HIDDEN" NAME="PortBind_PON_Tag_2" ID="PortBind_PON_Tag_2" VALUE="<%if tcWebApi_get("PortBind_Common", "p2", "h") <> "N/A" then tcWebApi_get("PortBind_Common", "p2", "s") end if%>">
				<INPUT TYPE="HIDDEN" NAME="PortBind_PON_Tag_3" ID="PortBind_PON_Tag_3" VALUE="<%if tcWebApi_get("PortBind_Common", "p3", "h") <> "N/A" then tcWebApi_get("PortBind_Common", "p3", "s") end if%>">
				<INPUT TYPE="HIDDEN" NAME="PortBind_PON_Tag_4" ID="PortBind_PON_Tag_4" VALUE="<%if tcWebApi_get("PortBind_Common", "p4", "h") <> "N/A" then tcWebApi_get("PortBind_Common", "p4", "s") end if%>">
				<INPUT TYPE="HIDDEN" NAME="PortBind_PON_Tag_5" ID="PortBind_PON_Tag_5" VALUE="<%if tcWebApi_get("PortBind_Common", "p5", "h") <> "N/A" then tcWebApi_get("PortBind_Common", "p5", "s") end if%>">
				<INPUT TYPE="HIDDEN" NAME="PortBind_PON_Tag_6" ID="PortBind_PON_Tag_6" VALUE="<%if tcWebApi_get("PortBind_Common", "p6", "h") <> "N/A" then tcWebApi_get("PortBind_Common", "p6", "s") end if%>">
				<INPUT TYPE="HIDDEN" NAME="PortBind_PON_Tag_7" ID="PortBind_PON_Tag_7" VALUE="<%if tcWebApi_get("PortBind_Common", "p7", "h") <> "N/A" then tcWebApi_get("PortBind_Common", "p7", "s") end if%>">
		</table>
	</td>
	</tr>
    <tr>
...
<%if tcwebApi_get("WebCustom_Entry","is3GDongleSupport","h")="Yes" then%>
    ...
    <td height="25" class="light-orange">&nbsp;</td><td class="light-orange">&nbsp;</td><td height="80" class="tabdata">
      <div align=right>
      <font color="#000000">3G</font>      </div></td><td class="tabdata"><div align=center>:</div></td><td height="25" class="tabdata">
	  <table border="1" cellpadding="0" cellspacing="0" bordercolor="#CCCCCC">
        <tr class="tabdata">
        <td rowspan="2" class="tabdata">
          <div align=right>
		  ...
		  <td>
		  <div align=center>
            <INPUT TYPE="CHECKBOX" NAME="PortBind_3G_Port_0" ID="PortBind_3G_Port_0" <%if tcWebApi_get("PortBind_Entry", "3g0", "h") = "Yes" then asp_write("checked") end if%> >       
		 </div>
		 </td>
		 </tr>
		<tr>
        <td class="tabdata"><div align=center>1</div></td>
			...
			<INPUT TYPE="HIDDEN" NAME="PortBind_3G_Tag_0" ID="PortBind_3G_Tag_0" VALUE="<%if tcWebApi_get("PortBind_Common", "3g0", "h") <> "N/A" then tcWebApi_get("PortBind_Common", "3g0", "s") end if%>">
		</table>
	  </td>
	  </tr> 
<%end if%>
  ...
  <tr>
	...
	<INPUT TYPE="SUBMIT" NAME="DeleteBtn_PortBind_group" VALUE="DELETE" onclick="doDel();">
	...
	<INPUT TYPE="HIDDEN" NAME="dongleSupport" value="<% if tcwebApi_get("WebCustom_Entry","is3GDongleSupport","h")="Yes" then asp_write("1") else asp_write("0") end if%>">
