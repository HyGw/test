...
If Request_Form("Sambaflag")="1" then 
	...
	if TCWebAPI_get("Samba_Entry", "Active", "h") = "Yes" then
		...
		TCWebAPI_set("Samba_Entry","Passwd","newSambaPassword")
			...
			if Request_Form("newSambaPassword") <> "******" Then
				TCWebAPI_set("Samba_Entry","Passwd","newSambaPassword")
			end if
		end if	
...
<FORM METHOD="POST" ACTION="/cgi-bin/access_samba.asp" name="Samba_form">
  <table width="760" border="0" align=center cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
    ...
    <tr> 
      ...
      <td class="tabdata"><div align=center>:</div></td>
      <td class="tabdata"> <INPUT TYPE="PASSWORD" NAME="newSambaPassword" SIZE="32" MAXLENGTH="31" VALUE="" > 
      </td>
    </tr>
    <tr> 
      <td class="light-orange">&nbsp;</td>
      ...
      <td class="tabdata"><div align=center>:</div></td>
      <td class="tabdata"> <INPUT TYPE="PASSWORD" NAME="confirmSambaPassword" SIZE="32" MAXLENGTH="31" VALUE="" > 
      </td>
    </tr>
    <tr> 
      <td class="light-orange">&nbsp;</td>
