<%
 If Request_Form("saveFlag") = "1" Then	
	...
	tcWebApi_set("Wan_PVC0","PASSWORD","IntePPPPswSetupOte")
	 	...
	 	if Request_Form("IntePPPPswSetupOte") <> "******" Then
			tcWebApi_set("Wan_PVC0","PASSWORD","IntePPPPswSetupOte")
		end if
	end if	
...
<script language="JavaScript" src="OutVar.asp"></script>
<style type="text/css">
</style>
<script>
...
function uiSave() {
	...
	{                                
		 alert("UserName Internet Contain Space!!");
		return false;                
	}
...
function doLoad() {
	if(document.WizardPPPOteform.IntePPPPswSetupOte != null)
			document.WizardPPPOteform.IntePPPPswSetupOte.value = pppvc0Pwd;
}
...
<table width="760" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
   ...
   <tr>
	...
	<%
	      if tcWebApi_staticGet("DeviceInfo_PVC0","Status","h")="1" then
	  	  asp_Write("Connected")
	      elseif tcWebApi_staticGet("DeviceInfo_PVC0","IP6Status","h") = "1" Then
		  asp_Write("Connected")
	      else 
  ...
  <%If tcWebApi_staticGet("DeviceInfo_PVC0","DispPPPconn","h") <> "0" then%>
  <tr>
    <td class="light-orange">&nbsp;</td>
    <td class="light-orange"></td>
    <td class="tabdata"><div align="right">
  ...
  <%elseif tcWebApi_staticGet("DeviceInfo_PVC0","IP6DispPPPconn","h") <> "0" then%>
 <tr>
    <td class="light-orange">&nbsp;</td>
    <td class="light-orange"></td>
    <td class="tabdata"><div align="right">
    ...
    <td class="tabdata"><div align="center">:</div></td>
    <td class="tabdata">
		 <%tcWebApi_staticGet("DeviceInfo_PVC0","IP6pppConnTime","s")%>
	</td>
  </tr>
  <%end if%> 
    <tr>
...
<table width="760" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
  ...
  <tr>
   ...
   <tr>
    ...
    <td class="tabdata" ><div align="center">:</div></td>
	<td class="tabdata" align=left>
		<INPUT TYPE="PASSWORD" NAME="IntePPPPswSetupOte" SIZE="32" MAXLENGTH="64" VALUE="">
	</td>
  </tr>
    <tr>
    <td class="light-orange">&nbsp;</td>
