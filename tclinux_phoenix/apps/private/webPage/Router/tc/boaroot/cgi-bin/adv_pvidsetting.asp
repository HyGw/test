...
<div align="center">
	<table width="760" border="0" align=center cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
      ...
      <tr> 
        <td class="light-orange">&nbsp;</td>
        <td class="light-orange"></td>
        <td width="199" class="tabdata"><div align="right"><font color="#000000"><%If tcWebApi_get("WebCustom_Entry", "haveXPON", "h") = "Yes" Then%>Pon Wan #0<%Else%>ATM 
            VC #0<%End If%></font> 
      ...
      <tr > 
        <td class="light-orange">&nbsp;</td>
        <td class="light-orange"></td>
        <td class="tabdata"><div align="right"><font color="#000000"> <%If tcWebApi_get("WebCustom_Entry", "haveXPON", "h") = "Yes" Then%>Wan<%Else%>VC<%End If%> #1</font>
      ...
      <tr> 
        <td class="light-orange">&nbsp;</td>
        <td class="light-orange"></td>
        <td class="tabdata"><div align="right"> <%If tcWebApi_get("WebCustom_Entry", "haveXPON", "h") = "Yes" Then%>Wan<%Else%>VC<%End If%> #2 
      ...
      <tr> 
        <td class="light-orange">&nbsp;</td>
        <td class="light-orange"></td>
        <td class="tabdata"><div align="right"> <%If tcWebApi_get("WebCustom_Entry", "haveXPON", "h") = "Yes" Then%>Wan<%Else%>VC<%End If%> #3 
      ...
      <tr> 
        <td class="light-orange">&nbsp;</td>
        <td class="light-orange"></td>
        <td class="tabdata"><div align="right"> <%If tcWebApi_get("WebCustom_Entry", "haveXPON", "h") = "Yes" Then%>Wan<%Else%>VC<%End If%> #4 
      ...
      <tr> 
        ...
        <td class="light-orange"></td>
        <td class="tabdata"><div align="right"> <%If tcWebApi_get("WebCustom_Entry", "haveXPON", "h") = "Yes" Then%>Wan<%Else%>VC<%End If%> #5 
      ...
      <tr> 
        <td class="light-orange">&nbsp;</td>
        <td class="light-orange"></td>
        <td class="tabdata"><div align="right"> <%If tcWebApi_get("WebCustom_Entry", "haveXPON", "h") = "Yes" Then%>Wan<%Else%>VC<%End If%> #6 
      ...
      <tr> 
        <td class="light-orange">&nbsp;</td>
        <td class="light-orange"></td>
        <td class="tabdata"><div align="right"> <%If tcWebApi_get("WebCustom_Entry", "haveXPON", "h") = "Yes" Then%>Wan<%Else%>VC<%End If%> #7 
