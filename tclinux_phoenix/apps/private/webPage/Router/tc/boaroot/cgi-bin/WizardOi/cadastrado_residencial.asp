         ...
         <table border="0" cellpadding="0" cellspacing="0" width="100%" height="100%" class="layout_pages">
            ...
            <tr>
                ...
                <div class="page_content">
                    <div id="page_registered_residential_content">
                        ...
                        <div class="page_subtitle_special">
                            ...
                            Agora voc&ecirc; faz parte da Rede Fon. Procure pela rede <b>Oi WiFi Fon</b> e se <br />
                            conecte gratuitamente.
                            <br /><br />
                        </div>
                        ...
                        <div class="page_subtitle_special">
                            Seu cadastro foi realizado com sucesso.<br />
                            Agora voc&ecirc; faz parte da Rede Fon. Procure pela rede Oi WiFi Fon e se <br />
                            conecte gratuitamente.
                        ...
                        Senha: n&uacute;mero do CPF do titular.<br />
                        <br />
                        <%elseif tcWebApi_get("WebCustom_Entry","isOIWizardC7Support","h") = "Yes" then%>
                        <span class="page_txt_highlights">Importante: Anote seus dados para acessar a Rede Fon:</span><br />
                        Login: n&uacute;mero do seu Oi Fixo com DDD. Se tiver mais de um Oi Fixo, 
             ...
             <b>Login: n&uacute;mero do seu Oi Fixo com DDD.</b> Se tiver mais de um Oi Fixo, 
              digite o n&uacute;mero daquele que est&aacute; vinculado ao seu Oi Velox<br />
              <b>Senha: n&uacute;mero do CPF do titular</b><br />
              <br />
                        <%end if%>
                           <div class="page_txt"  id="dynText">
                            ...
                            Mais informa&ccedil;&otilde;es em <a href="http://www.oi.com.br/oivelox" target="_blank">http://www.oi.com.br/oivelox</a>.</p>
			   </div>
                        </div>						
                        <!--END TXT-->
        		...
        		<div style="display:none">
                 	<iframe id="fonStringIframe" name="fonStringIframe" frameborder="0"  src="/cgi-bin/getOutString.cgi?index=2"  onload="GetFonString();"></iframe>
			</div>
                <!--BEGIN PAGE BTNS-->
                <div class="page_btns">                
                    <a href="javascript:void(0)" onclick="navPage( 'browsingu' )" ><img src="../../include/images/page_btn_navigate.png" width="166" height="30" title="Navegar" alt="Navegar" onmouseover="this.src='../../include/images/page_btn_navigate_over.png'" onmouseout="this.src='../../include/images/page_btn_navigate.png'" /></a>
                </div>
                <!--END PAGE BTNS-->
                </div>
                <!--BEGIN LAYOUT PAGES CONTENT-->
