...
<%else%>
	...
	<%if tcWebApi_get("WebCustom_Entry","haveXPON","h") = "Yes" then%>
		<OPTION value="0" <%if tcWebApi_get("WebCurSet_Entry","wan_pvc","h") = "0" then asp_Write("selected") end if%>>WAN0
		<OPTION value="1" <%if tcWebApi_get("WebCurSet_Entry","wan_pvc","h") = "1" then asp_Write("selected") end if%>>WAN1
		<OPTION value="2" <%if tcWebApi_get("WebCurSet_Entry","wan_pvc","h") = "2" then asp_Write("selected") end if%>>WAN2
		<OPTION value="3" <%if tcWebApi_get("WebCurSet_Entry","wan_pvc","h") = "3" then asp_Write("selected") end if%>>WAN3
		<OPTION value="4" <%if tcWebApi_get("WebCurSet_Entry","wan_pvc","h") = "4" then asp_Write("selected") end if%>>WAN4
		<OPTION value="5" <%if tcWebApi_get("WebCurSet_Entry","wan_pvc","h") = "5" then asp_Write("selected") end if%>>WAN5
		<OPTION value="6" <%if tcWebApi_get("WebCurSet_Entry","wan_pvc","h") = "6" then asp_Write("selected") end if%>>WAN6
		<OPTION value="7" <%if tcWebApi_get("WebCurSet_Entry","wan_pvc","h") = "7" then asp_Write("selected") end if%>>WAN7
	<%end if%>
<%end if%>
...
<%if tcwebApi_get("WebCustom_Entry","isGUIALGControl","h") = "Yes" then%>
<table width="760" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
  <tr>
    <td width="150" height="30" class="title-main">   
    ALG 
  ...
  <tr>
    ...
    <td height="30"><div align="right"><img src="/next.gif" width="16" height="16"></div></td>
    <td>&nbsp;</td>
    <td class="content"> <a href="/cgi-bin/adv_nat_alg_switch.asp" target="main">   
    ALG Switch   
    </a></td>
  </tr>
   <tr>
