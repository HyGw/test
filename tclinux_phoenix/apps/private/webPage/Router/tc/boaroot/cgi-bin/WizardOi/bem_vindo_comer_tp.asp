<%
	tcWebApi_constSet("GUI_Entry0","OI_USER_ENTERPRISE","1")
%>
                    ...
                    <div id="page_welcome_content">
                        ...
                        <div class="page_subtitle_special">
												<%if tcWebApi_get("WebCustom_Entry", "isCZH108LSupported", "h") = "Yes" then %>	
														 Seja bem-vindo ao assistente de configura&ccedil;&atilde;o do modem MTK do seu Oi Velox.<br />
                            Vamos come&ccedil;ar? Feche os demais programas que estiverem abertos pra iniciar a instala&ccedil;&atilde;o.
                        <%else%>    
                            Seja bem-vindo ao assistente de configura&ccedil;&atilde;o do modem DSLink 477-M3 do seu Oi Velox.<br />
                            Vamos come&ccedil;ar? Feche os demais programas que estiverem abertos pra iniciar a instala&ccedil;&atilde;o.
												<%end if%>
                        </div>
                    </div>
