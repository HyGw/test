...
<INPUT TYPE="HIDDEN" NAME="DynIPv6EnableRadio" VALUE="1">
<% end if %>
<INPUT TYPE="HIDDEN" NAME="wan_dot1q" VALUE="No">
<INPUT TYPE="HIDDEN" NAME="wan_BridgeInterface1" VALUE="Yes">
<INPUT TYPE="HIDDEN" NAME="PPPAuthen" VALUE="No">
