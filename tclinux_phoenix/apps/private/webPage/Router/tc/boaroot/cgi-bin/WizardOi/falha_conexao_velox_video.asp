...
<html lang="pt-br">
    <head>
		...
		function PageSubmit()
		{
			document.configure_modem_residen.WAN_RetryFlag.value = "1";
            ...
            <tr>
                ...
                <div class="page_content page_authentication_failure_velox">
                    <div id="page_authentication_failure_velox_video_content">
                        ...
                        <%if tcWebApi_get("WebCustom_Entry","isOIWizardC9Support","h") = "Yes" then%>	
																Quer ajuda? <a href="javascript:void(0)" onclick="navPage( 'adsl_off_problem' )" >Veja a solu&ccedil;&atilde;o para alguns problemas aqui</a>.<br />Caso o problema persista, entre em contato com o suporte:<br />
                                Cliente Residencial: Do RJ, ES, MG, BA, SE, AL, PE, PB, RN, CE, PI, MA, PA,<br />
                                 AP, RR e AM, ligue pra 103 31 e informe "falha na conex&atilde;o".<br />
                                Do RS, SC, PR, MS, GO, TO, MT, AC, RO e do DF, ligue pra 103 14 e informe<br />
                                 "falha na conex&atilde;o".<br />
                        <%elseif	tcWebApi_get("WebCustom_Entry","isOIWizardC7Support","h") = "Yes" then%>
																Quer ajuda? <a href="javascript:void(0)" onclick="navPage( 'adsl_off_problem' )" >Veja a solu&ccedil;&atilde;o para alguns problemas aqui</a>.<br />Caso o problema persista, entre em contato com o suporte:<br />
                                Cliente Residencial: Do RJ, ES, MG, BA, SE, AL, PE, PB, RN, CE, PI, MA, PA,<br />
                                 AP, RR e AM, ligue pra 103 31 e informe "falha na conex&atilde;o".<br />
                                Do RS, SC, PR, MS, GO, TO, MT, AC, RO e do DF, ligue pra 103 14 e informe<br />
                                 "falha na conex&atilde;o".<br />
                        <%else%>
                                Quer ajuda? <a href="javascript:void(0)" onclick="navPage( 'adsl_off_problem' )" >Veja a solu&ccedil;&atilde;o para alguns problemas aqui</a>.<br />Cliente Empresarial: Ligue pra 0800 031 0800.<br />Cliente Residencial: Do RJ, ES, MG, BA, SE, AL, PE, PB, RN, CE, PI, MA, PA, AP, RR e AM, ligue pra 103 31. Do RS, SC, PR, MS, GO, TO, MT, AC, RO e do DF, ligue pra 103 14.
                        <%end if%>
                            </div>
                        </div>
                    </div>
