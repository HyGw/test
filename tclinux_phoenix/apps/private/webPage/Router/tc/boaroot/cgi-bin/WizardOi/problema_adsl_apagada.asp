        ...
        <div id="layout_bg_left" class="layout">
         ...
         <table border="0" cellpadding="0" cellspacing="0" width="100%" height="100%" class="layout_pages">
            ...
            <tr>
                ...
                <div class="page_btns">    
                    <a href="javascript:void(0)" onclick="navPage( 'authentication_failure_velox_video' );"><img src="../../include/images/page_btn_back.png" width="150" height="30" title="Voltar" alt="Voltar" onmouseover="this.src='../../include/images/page_btn_back_over.png'" onmouseout="this.src='../../include/images/page_btn_back.png'" /></a>
				</div>
                </div>
                </td>
            </tr>
