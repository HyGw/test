...
<form name="wzPWform" method="post" ACTION="<% if tcWebApi_get("WebCustom_Entry","isC5VOLLCOMMSupport","h") = "Yes" then asp_write("/cgi-bin/wizardPPP.asp") else asp_write("/cgi-bin/wizardTZ.asp") end if %>">
