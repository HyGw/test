...
hasXPON=`$tcapicom WebCustom_Entry haveXPON`
if [ "$hasXPON" = "Yes" ]
then
       echo "xPON"
else
...
echo " Router</td></tr></table><table width=\"590\" height=\"2\" border=\"0\" align=\"center\" cellpadding=\"0\" cellspacing=\"0\" class=\"orange\"><tr><td width=\"590\" valign=\"baseline\" class=\"orange\"></td></tr></table><table width=\"590\" border=\"0\" align=\"center\" cellpadding=\"0\" cellspacing=\"0\" color=\"#FF9933\"><tr><td width=\"590\" height=\"35\"  bgcolor=\"#FFFFFF\" class=\"headline\">Service Information Summary</td></tr><tr><td></table><table width=\"590\" border=\"1\" align=\"center\" cellpadding=\"0\" cellspacing=\"0\" bordercolor=\"#CCCCCC\" bgcolor=\"#FFFFFF\"><tr height=\"30\"><td width=\"55\"  align=\"center\" class=\"tabdata\"><strong>#</strong></div></td><td width=\"70\"  align=\"center\" class=\"tabdata\"><strong>Active</strong></td>"
if [ "$hasXPON" = "Yes" ]
then
	echo "<td width=\"120\"  align=\"center\" class=\"tabdata\"><strong>IP Address</strong></td><td width=\"70\"  align=\"center\" class=\"tabdata\"><strong>Status</strong></td></tr>"
else
	echo "<td width=\"50\"  align=\"center\" class=\"tabdata\"><strong>VPI</strong></td><td width=\"50\"  align=\"center\" class=\"tabdata\"><strong>VCI</strong></td><td width=\"200\"  align=\"center\" class=\"tabdata\"><strong>ENCAP</strong></td><td width=\"120\"  align=\"center\" class=\"tabdata\"><strong>Mux</strong></td><td width=\"120\"  align=\"center\" class=\"tabdata\"><strong>IP Address</strong></td><td width=\"70\"  align=\"center\" class=\"tabdata\"><strong>Status</strong></td></tr>"
fi
tmpstr=""
...
do
       ...
       lineState=`$tcapicom XPON_Common trafficStatus`
