...
if(vPageMap[6][0] == '1'){
	if(vPageMap[6][1] == '1')
		...
		MenuArray[iCount++] = new MenuNodeConstruction(1, "诊断", "/cgi-bin/diag-servicediagnose.asp", "");	
}

if(vPageMap[6][1] == '1')
	MenuArray[iCount++] = new MenuNodeConstruction(2, "网络诊断", "/cgi-bin/diag-quickdiagnose.asp", "");
if(vPageMap[6][2] == '1')
	MenuArray[iCount++] = new MenuNodeConstruction(2, "业务诊断", "/cgi-bin/diag-servicediagnose.asp", "");
//Help->7
if(vPageMap[7][0] == '1')
