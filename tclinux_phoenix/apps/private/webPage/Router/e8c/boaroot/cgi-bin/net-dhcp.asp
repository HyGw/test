...
alert('警告：该操作将改变IP地址池，修改后请重新启动设备！');
<% else %>	
          ...
          <TD>
            ...
            <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
              ...
              <TR>
                ...
                <TD>
<% if tcwebApi_get("WebCustom_Entry","isCYE8SFUSupported","h") <>"Yes" then %>
                <B>本地网络配置</B><BR><BR>用户侧的DHCP打开和关闭、租约时间（1分钟、1小时、1天、1周）。<BR>DHCP地址区间设置及与设备类型的映射。<BR>DHCP工作模式（DHCP 
                  Server和DHCP relay）设置。 <BR><BR>
<% end if %>  
                  ...
                  <TABLE cellSpacing=0 cellPadding=0 border=0>		  
                    ...
                    <TR>
                      <TD colSpan=2><INPUT id=dhcpSrvType onclick="typeClick()" type=radio value="0" name="dhcpSrvType" <%if tcWebApi_get("Lan_Dhcp","type","h") = "0" then asp_Write("checked") end if %>> &nbsp;&nbsp;禁用DHCP 
                        Server </TD></TR>
                    <TR>
                      <TD colSpan=2><INPUT id="dhcpSrvType" onclick="typeClick()"  type=radio  value="1" name="dhcpSrvType" <%if tcWebApi_get("Lan_Dhcp","type","h") = "1" then asp_Write("checked") end if %>> <NOBR>&nbsp;&nbsp;开启DHCP 
                        Server</NOBR>  <INPUT id="dhcpSrvType" onclick="typeClick()"  type=radio  value="2" name="dhcpSrvType" <%if tcWebApi_get("Lan_Dhcp","type","h") = "2" then asp_Write("checked") end if %>> <NOBR>&nbsp;&nbsp;开启DHCP 
                        Relay</NOBR></TD>
                      <TD>&nbsp;&nbsp;&nbsp;</TD>
                      <TD style="display:block"><NOBR>设备类型:&nbsp; <SELECT onchange="IpPoolIndexChange()" size=1 name="IpPoolIndex"> 
              ...
              <TR>
				...
				<BUTTON onclick="btnSaveIPv4();" type="button" name=btnApply1 value="Apply">保存</BUTTON></TD>
                      ...
                      <TD align=left>
                          <SELECT id=rapdsource name="rapdsource"></SELECT>
	                        ...
	                        initRaPDSourceList();
					          	...
					          	<TD align=right>&nbsp;</TD>
					         		<TD align=left>
												  <input type="checkbox" name="ramflag" id="ramflag" <%if tcWebApi_get("Radvd_Entry","ManagedEnable","h") = "1" then asp_Write("checked") end if%>>开启Managed标志
													<input type="checkbox" name="raoflag" id="raoflag" <%if tcWebApi_get("Radvd_Entry","OtherEnable","h") = "1" then asp_Write("checked") end if%>>开启Other标志 </TD>
					          </TR>
...
function btnDhcp1Save()
{
	if (DhcpCheckForm() == true){
		...
		document.ConfigForm1.submit();
                ...
                <TD>
                  ...
                  <TABLE>
                    ...
                    <TR>
                      ...
                      <TD align=right width=120>域名服务器来源:&nbsp;&nbsp;&nbsp;</TD>
                      <TD align=left width=307>
              ...
              <TR>
                ...
                <TD>
                  ...
                  <TABLE>
                    <TBODY>
                    <TR>
                      <TD align=right width=120>分配地址格式:&nbsp;&nbsp;&nbsp;</TD>
                      <TD align=left width=307>
              ...
              <TR>
                <TD width=10>&nbsp;</TD>
                <TD align=middle width=307><BUTTON type="button" onclick="btnDhcp1Save();" name=btnApply2 value="Apply">保存</BUTTON>
