				...
				document.writeln("<option id=" + vEntryIndex[i] + " " + "value=" + vEntryValue[i] +">" + vEntryName[i] + "</option>");
                  ...
                  <TABLE cellSpacing=0 cellPadding=0 border=0>
                    ...
                    <TR>
					  ...
					  <OPTION value="Chinatelecom" <%if tcWebApi_get("Ddns_Entry","DDNS_Name","h") = "China Telecom" then asp_Write("selected") elseif tcWebApi_get("Ddns_Entry","DDNS_Name","h") = "N/A" then asp_Write("selected") end if %>>中国电信</OPTION> 
					  </SELECT> </TD></TR>
                  ...
                  </TD></TR></TBODY></TABLE></DIV></FORM><LEFT><INPUT id='Add_Button' onclick="btnSubmit()" type=button value=添加 name='Add_Button'> 
                  </LEFT><BR><BR>
                  <DIV id=ddnsInfo>
