...
evaBool_e isValidHexNum(const char* inStr, int min, int max);
...
codec_e 	convertBitrate(const char* inStr); /* added by mtk07059_20150811. */
pTime_e 	convertPtime(const char* inStr);
strmDir_e	convertStrmdir(const char* inStr);
dsp_dir convertDspdir(const char* inStr);
evaBool_e isValidDspdir(const char* inStr);
evaBool_e isValidDspStageNum(const char* inStr, int min, int max);
...
int convertSlicType(const char* inStr);/*ADD by mtk08176_20150508 , support line test. */
...
char* 	etosBitrate(int32 e) ; /*  added by mtk07059_20150811. */
char*	etosHook(int32 e);
char*	etosLine(int32 e);
char* 	etosJbMode(int32 e);
char* 	etosT38State(int32 e) ;
char* 	etosCidFormat(int32 e);
char* 	etosCUOutlineStatus(int32 e);/* mtk08176_20150824 */
char* 	etosCUInlineStatus(int32 e);/* mtk08176_20150824 */
