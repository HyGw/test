/*
** $Id: //BBN_Linux/Branch/Branch_for_Rel_CMCC_7526_20161014/tclinux_phoenix/bootrom/bootram/include/asm/tc3162.h#1 $
*/
/************************************************************************
 *
...
#define needFlashSafeRead (isTC3162L5P5E2 && spiFlashBoot)
...
#define isRT63260B ((((unsigned char)(VPint(0xbfb000bc)>>9)&0x01)==0x0)?1:0)
...
#define isGenernalFPGA_2        (((VPint(CR_AHB_SSTR) & 0x1) == 0) ? 1 : 0) /*used for EN7522 and later version*/
...
#define MT751020_CPU_CLK		(((VPint(0xbfb0008c) >> 0x9) & 0x3) == 0x0) ? (750) : (((VPint(0xbfb0008c) >> 0x9) & 0x3) == 0x1) ? (650) : (((VPint(0xbfb0008c) >> 0x9) & 0x3) == 0x2) ? (500) : (250)
#define	MT751020_SYS_HCLK		((VPint(0xbfb0008c)&(1<<31)) ? (32) : ((((MT751020_CPU_CLK)* 100) / ((VPint(0xbfb000f8) >> 0x3) & 0x7)) / 100))
#define	MT7505_SYS_HCLK		((VPint(0xbfb0008c)&(1<<31)) ? (32) : (135))  //MT7505 CPU clock is 540
...
#define	CR_UART2_RBR     	(0x00+CR_UART2_BASE+0x03)
#define	CR_UART2_THR     	(0x00+CR_UART2_BASE+0x03)
#define	CR_UART2_IER     	(0x04+CR_UART2_BASE+0x03)
#define	CR_UART2_IIR     	(0x08+CR_UART2_BASE+0x03)
#define	CR_UART2_FCR     	(0x08+CR_UART2_BASE+0x03)
#define	CR_UART2_LCR     	(0x0c+CR_UART2_BASE+0x03)
#define	CR_UART2_MCR     	(0x10+CR_UART2_BASE+0x03)
#define	CR_UART2_LSR     	(0x14+CR_UART2_BASE+0x03)
#define	CR_UART2_MSR     	(0x18+CR_UART2_BASE+0x03)
#define	CR_UART2_SCR     	(0x1c+CR_UART2_BASE+0x03)
#define	CR_UART2_BRDL    	(0x00+CR_UART2_BASE+0x03)
#define	CR_UART2_BRDH    	(0x04+CR_UART2_BASE+0x03)
#define	CR_UART2_WORDA		(0x20+CR_UART2_BASE)
#define	CR_UART2_HWORDA	    (0x28+CR_UART2_BASE)
#define	CR_UART2_MISCC		(0x24+CR_UART2_BASE+0x03)
