...
/* lobo add */
#define MACH_GROUP_SUNPLUS     19 /* Sunplus's DVD Player Arch */

#define MACH_GROUP_LEXRA    	20  /* Lexra based architecture */

#define GROUP_NAMES { "unknown", "Jazz", "Digital", "ARC", "SNI", "ACN",      \
	"SGI", "Cobalt", "NEC DDB", "Baget", "Cosine", "Galileo", "Momentum", \
	"ITE", "Philips", "Globepspan", "SiByte", "Toshiba", "Alchemy", "Sunplus" } /* lobo add something */
...
/*
 * Valid machtype for group Sunplus
 */
#define MACH_SUNPLUS	0	         /* Sunplus-based eval board */
 
#define GROUP_SUNPLUS_NAMES { "DVD_PLAYER" } /* the actual board name */
/* =============== lobo add ===============*/

/*
 * Valid machtype for group Lexra
 */
#define MACH_LX4181	0	         /* TrendChip WDL eval board */
 
#define GROUP_LEXRA_NAMES { "TC3160" } /* the actual board name */

/* Robert add here */
/* Add board for TrendChip 3162 CPU */
#define MACH_LX4380	1

#define GROUP_LX4380_NAMES { "TC3162" }
...
/*extern unsigned long mips_tlb_entries;*/ /* lobo del */
