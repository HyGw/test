/*
** $Id: //BBN_Linux/Branch/Branch_for_MT7520_20120528/tclinux_phoenix/bootrom/bootram/net/femac.h#2 $
*/
/************************************************************************
 *
...
/*
** $Log: femac.h,v $
** Revision 1.1.2.5  2011/08/02 06:07:38  lino
** add RT63365 support: SDRAM/DDR1/DDR2 parameter
**
** Revision 1.1.2.4  2011/05/10 02:28:27  lino
...
** add RT63365 support
**
** Revision 1.1.2.1  2011/04/20 02:46:32  lino
** add RT63365 support
**
** Revision 1.1.1.1.14.1  2010/09/28 12:53:37  lino
** add RT63165 support
**
