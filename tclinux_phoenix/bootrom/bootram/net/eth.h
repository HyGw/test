...
#define FLASH_ETHER_GPIO	(0xff65 | flash_base)
#if 0
#ifdef TCSUPPORT_BB_NAND
#define FLASH_ETHER_GPIO	0xff65 
#else
#define FLASH_ETHER_GPIO	0xbfc0ff65 
#endif
#endif
...
void eth_gpioReset(void);
void eth_latsch_up(void);
#endif /* __ETH_H */
