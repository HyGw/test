/*
** $Id: //BBN_Linux/Branch/Branch_for_Rel_CMCC_7526_20161014/tclinux_phoenix/bootrom/bootram/net/tc3162l2mac.h#1 $
*/
/************************************************************************
 *
...
#else
#define MAC_TXDESCP_NO		16	/* Max tx buffer Cnts , default=64 */
#define MAC_RXDESCP_NO		128	/* Max rx buffer Cnts , default=64 */
#endif
...
#define TX_BUF_RELEASE_THRESHOLD 4  // default:8
...
#define   MAC_TX_POLL_DEMAND_(x) *(volatile unsigned int *)(CR_MAC_TXPD) = (0xffffffff);

// --- Force MAC to poll Rx ---
#define   MAC_RX_POLL_DEMAND_(x) *(volatile unsigned int *)(CR_MAC_RXPD) = (0xffffffff);

// --- setup MAC address ---
          // --- Setup MAC address ---
#define   MAC_SET_MAC_ADDRESS_(x,y) *(volatile unsigned int *)(CR_MAC_LADR) = (x&0x0000ffff); *(volatile unsigned int *)(CR_MAC_MADR) = (y&0xffffffff);
...
#define DESCRIPTOR_POOL_SIZE	( MAC_RXDESCP_SIZE*MAC_RXDESCP_NO + MAC_TXDESCP_SIZE*MAC_TXDESCP_NO + 4 )
#endif
...
{
//	allocMap_t descrRing;			/* Descr Ring Allocation Map		*/
//	allocMap_t rxBufMap[MAX_FBL_ENTRIES];
//	allocMap_t maxTxBufMap[MAX_TFD_ENTRIES];
