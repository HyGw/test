...
#if 0
static int vp3030_env57h12d5_params(struct dvb_frontend *fe,
				    struct dvb_frontend_parameters *params)
{
	...
	struct i2c_msg msg = {.addr = 0x60, .flags = 0, .buf = buf, .len = 5};
	...
	return err;
exit:
	dprintk(MANTIS_ERROR, 1, "I/O error, err=%d", err);
	return err;
}
#endif
