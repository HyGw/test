...
#define	SIM_Reg(addr)				INREG32(addr)
#define SIM_WriteReg32(addr, data)	OUTREG32(addr, data)
#define SIM_SetBits(addr, data)     SETREG32(addr, data)
#define SIM_ClearBits(addr, data)   CLRREG32(addr, data)
...
//  Assertions
// ---------------------------------------------------------------------------
#define SIM_ASSERT(_condition) printk("SIM_ASSERT Error\n\n");

#ifndef ASSERT
//    #define ASSERT(expr)        BUG_ON(!(expr))
    #define ASSERT(expr)        printk("ASSERT Error\n\n");
#endif
