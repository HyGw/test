...
typedef enum {
    ...
    TIC_STATE_REV_OHT			= 17,
    TIC_STATE_OHT				= 18,
    TIC_STATE_STAND_BY			= 19,//add by mtk69090 for COC  #OSBNB00030711
    TIC_STATE_REV_ACTIVE        = 20,  //dyma_20140508
    /*
...
typedef enum {
    TIC_PDD_IDLE	= 0x1,
    TIC_PDD_PROCESS	= 0x2,
    TIC_PDD_FLASH_DISABLE	= 0x4,
    TIC_PDD_FLASH_DETECTED = 0x8,
    TIC_PDD_DETECTED = 0x10,
} TIC_PDD_STATUS;
 ...
 */
typedef struct {
    unsigned char       state;  //dyma_131106
    int         intrs;
    /*
...
typedef struct {
    ...
    int   nvCount;
    int   count;
    unsigned char pulse[35];  //dyma_131106
    unsigned char pulseDTMFMode;  //dyma_131106
    int   pauseTime;
 ...
 */
typedef struct {
    unsigned char chan;  //dyma_131106
    int   infcType;
