 ...
 *
 * $Revision: 10946 $
 * $LastChangedDate: 2013-04-12 13:47:17 -0500 (Fri, 12 Apr 2013) $
 */
...
{
    Vp886LineObjectType *pLineObj =  pLineCtx->pLineObj;
    uint8 opCond = VP886_R_OPCOND_CUT_RX | VP886_R_OPCOND_HIGHPASS;
    ...
    int16 gain)
{
    ...
    VP_TEST(VpLineCtxType, pLineCtx, ("Vp886SadcGetMathData"));
