 ...
 */
//VP_API_PORTING #define VP_REDUCED_API_IF
 ...
 */
  ...
  #undef VP_CC_880_SERIES   /**< define to build 880 specific API library;      *   undef to exclude this library. */

//VP_API_PORTING  #undef VP_CC_886_SERIES   /**< define to build 886/887 specific API library;  *   undef to exclude this library. */

//VP_API_PORTING  #undef VP_CC_890_SERIES   /**< define to build 890 specific API library;         *   undef to exclude this library. */
...
#define VP890_INCLUDE_TESTLINE_CODE     /* Defines whether or not to enable
                                         * 890 line test capabilities */  //VP_API_PORTING
...
#define VP886_INCLUDE_TESTLINE_CODE      /* Defines whether or not to enable
                                         * 886 line test capabilities */  //VP_API_PORTING
