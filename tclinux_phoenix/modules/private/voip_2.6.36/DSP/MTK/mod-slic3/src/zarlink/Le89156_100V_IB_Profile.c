...
const VpProfileDataType DEV_PROFILE_Inverting_Boost_100V_89156_A[] =
{
 ...
 0xE4, 0x02, 0x44, 0x0A, /* Inverting Boost (100V) Switching Regulator Parameters */
 0x75, 0x00, 0x98, 0x40, 0xC0, 0x40, /* Regulator Timing Parameters */
 0x28, 0x40, 0x30, 0x40, 0x30, 0x40  /* FreeRun Timing Parameters */
};

const VpProfileDataType DEV_PROFILE_Inverting_Boost_100V_89156_B[] =
{
  /* Device Profile for VE890 Device Family */
 0x00, 0xFF, 0x02, 0x1A, /* Profile Type and Length */
 0x06, 0x00, /* Version and MPI Command */
...
const VpProfileDataType AC_FXS_RF50_600R_DEF_89156[] =
{
  /* AC Profile */
...
const VpProfileDataType AC_FXS_RF50_ETSI_89156[] =
{
  /* AC Profile */
...
const VpProfileDataType AC_FXS_RF50_GR57_89156[] =
{
  /* AC Profile */
...
const VpProfileDataType AC_FXS_RF50_AT_89156[] =
{
  /* AC Profile */
...
const VpProfileDataType AC_FXS_RF50_AU_89156[] =
{
  /* AC Profile */
 0x55, 0x00, 0xC7, 0x4C, 0x01, 0x49, 0xCA, 0xE8, 0x98, 0x3C, 0x41, 0xB4,
 0xB2, 0x3B, 0x3B, 0xEA, 0xBA, 0xF4, 0x53, 0x9A, 0x2E, 0xA2, 0x97, 0x9F,
...
const VpProfileDataType AC_FXS_RF50_BE_89156[] =
{
  /* AC Profile */
 0xC0, 0x00, 0xBD, 0x4C, 0x01, 0x49, 0xCA, 0xE4, 0x98, 0x7B, 0xB1, 0xAC,
 0xE2, 0xAA, 0xAC, 0x22, 0x2B, 0x4A, 0x34, 0x9A, 0xC4, 0xA2, 0xA7, 0x9F,
...
const VpProfileDataType AC_FXS_RF50_BG_89156[] =
{
  /* AC Profile */
 0x55, 0x00, 0xC7, 0x4C, 0x01, 0x49, 0xCA, 0xE8, 0x98, 0x3C, 0x41, 0xB4,
 0xB2, 0x3B, 0x3B, 0xEA, 0xBA, 0xF4, 0x53, 0x9A, 0x2E, 0xA2, 0x97, 0x9F,
...
const VpProfileDataType AC_FXS_RF50_CH_89156[] =
{
  /* AC Profile */
 0xC0, 0x00, 0xBD, 0x4C, 0x01, 0x49, 0xCA, 0xE4, 0x98, 0x7B, 0xB1, 0xAC,
 0xE2, 0xAA, 0xAC, 0x22, 0x2B, 0x4A, 0x34, 0x9A, 0xC4, 0xA2, 0xA7, 0x9F,
...
const VpProfileDataType AC_FXS_RF50_CN_89156[] =
{
  /* AC Profile */
...
const VpProfileDataType AC_FXS_RF50_DE_89156[] =
{
  /* AC Profile */
 0x55, 0x00, 0xC7, 0x4C, 0x01, 0x49, 0xCA, 0xE8, 0x98, 0x3C, 0x41, 0xB4,
 0xB2, 0x3B, 0x3B, 0xEA, 0xBA, 0xF4, 0x53, 0x9A, 0x2E, 0xA2, 0x97, 0x9F,
...
const VpProfileDataType AC_FXS_RF50_DK_89156[] =
{
  /* AC Profile */
 0xC0, 0x00, 0xBD, 0x4C, 0x01, 0x49, 0xCA, 0xE4, 0x98, 0x7B, 0xB1, 0xAC,
 0xE2, 0xAA, 0xAC, 0x22, 0x2B, 0x4A, 0x34, 0x9A, 0xC4, 0xA2, 0xA7, 0x9F,
...
const VpProfileDataType AC_FXS_RF50_ES_89156[] =
{
  /* AC Profile */
 0xC0, 0x00, 0xBD, 0x4C, 0x01, 0x49, 0xCA, 0xE4, 0x98, 0x7B, 0xB1, 0xAC,
 0xE2, 0xAA, 0xAC, 0x22, 0x2B, 0x4A, 0x34, 0x9A, 0xC4, 0xA2, 0xA7, 0x9F,
...
const VpProfileDataType AC_FXS_RF50_FI_89156[] =
{
  /* AC Profile */
...
const VpProfileDataType AC_FXS_RF50_FR_89156[] =
{
  /* AC Profile */
 0xC0, 0x00, 0xBD, 0x4C, 0x01, 0x49, 0xCA, 0xE4, 0x98, 0x7B, 0xB1, 0xAC,
 0xE2, 0xAA, 0xAC, 0x22, 0x2B, 0x4A, 0x34, 0x9A, 0xC4, 0xA2, 0xA7, 0x9F,
...
const VpProfileDataType AC_FXS_RF50_GB_89156[] =
{
  /* AC Profile */
...
const VpProfileDataType AC_FXS_RF50_HU_89156[] =
{
  /* AC Profile */
 0xC0, 0x00, 0xBD, 0x4C, 0x01, 0x49, 0xCA, 0xE4, 0x98, 0x7B, 0xB1, 0xAC,
 0xE2, 0xAA, 0xAC, 0x22, 0x2B, 0x4A, 0x34, 0x9A, 0xC4, 0xA2, 0xA7, 0x9F,
...
const VpProfileDataType AC_FXS_RF50_IE_89156[] =
{
  /* AC Profile */
 0xC0, 0x00, 0xBD, 0x4C, 0x01, 0x49, 0xCA, 0xE4, 0x98, 0x7B, 0xB1, 0xAC,
 0xE2, 0xAA, 0xAC, 0x22, 0x2B, 0x4A, 0x34, 0x9A, 0xC4, 0xA2, 0xA7, 0x9F,
...
const VpProfileDataType AC_FXS_RF50_IT_89156[] =
{
  /* AC Profile */
 0xC0, 0x00, 0xBD, 0x4C, 0x01, 0x49, 0xCA, 0xE4, 0x98, 0x7B, 0xB1, 0xAC,
 0xE2, 0xAA, 0xAC, 0x22, 0x2B, 0x4A, 0x34, 0x9A, 0xC4, 0xA2, 0xA7, 0x9F,
...
const VpProfileDataType AC_FXS_RF50_JP_89156[] =
{
  /* AC Profile */
...
const VpProfileDataType AC_FXS_RF50_NL_89156[] =
{
  /* AC Profile */
 0xC0, 0x00, 0xBD, 0x4C, 0x01, 0x49, 0xCA, 0xE4, 0x98, 0x7B, 0xB1, 0xAC,
 0xE2, 0xAA, 0xAC, 0x22, 0x2B, 0x4A, 0x34, 0x9A, 0xC4, 0xA2, 0xA7, 0x9F,
...
const VpProfileDataType AC_FXS_RF50_NO_89156[] =
{
  /* AC Profile */
 0xC0, 0x00, 0xBD, 0x4C, 0x01, 0x49, 0xCA, 0xE4, 0x98, 0x7B, 0xB1, 0xAC,
 0xE2, 0xAA, 0xAC, 0x22, 0x2B, 0x4A, 0x34, 0x9A, 0xC4, 0xA2, 0xA7, 0x9F,
...
const VpProfileDataType AC_FXS_RF50_NZ_89156[] =
{
  /* AC Profile */
 0x43, 0x00, 0x20, 0x4C, 0x01, 0x49, 0xCA, 0xE0, 0x98, 0xA2, 0xB1, 0x3A,
 0x22, 0x72, 0xA4, 0xE3, 0xAB, 0x3A, 0xD5, 0x9A, 0xBA, 0xA3, 0xA5, 0x6E,
...
const VpProfileDataType AC_FXS_RF50_PT_89156[] =
{
  /* AC Profile */
 0xC0, 0x00, 0xBD, 0x4C, 0x01, 0x49, 0xCA, 0xE4, 0x98, 0x7B, 0xB1, 0xAC,
 0xE2, 0xAA, 0xAC, 0x22, 0x2B, 0x4A, 0x34, 0x9A, 0xC4, 0xA2, 0xA7, 0x9F,
...
const VpProfileDataType AC_FXS_RF50_SE_89156[] =
{
  /* AC Profile */
 0xC0, 0x00, 0xBD, 0x4C, 0x01, 0x49, 0xCA, 0xE4, 0x98, 0x7B, 0xB1, 0xAC,
 0xE2, 0xAA, 0xAC, 0x22, 0x2B, 0x4A, 0x34, 0x9A, 0xC4, 0xA2, 0xA7, 0x9F,
...
const VpProfileDataType AC_FXS_RF50_ZA_89156[] =
{
  /* AC Profile */
 0x55, 0x00, 0xC7, 0x4C, 0x01, 0x49, 0xCA, 0xE8, 0x98, 0x3C, 0x41, 0xB4,
 0xB2, 0x3B, 0x3B, 0xEA, 0xBA, 0xF4, 0x53, 0x9A, 0x2E, 0xA2, 0x97, 0x9F,
...
const VpProfileDataType DC_FXS_DEF_89156[] =
{
 /* DC Profile */
...
const VpProfileDataType RING_25HZ_DEF_89156[] =
{
...
/* Austria Ringing 50 Hz 55 Vrms Tracking */
const VpProfileDataType RING_AT_89156[] =
{
  /* Sine, 50 Hz, 1.41 CF, 77.00 Vpk, 0.00 Bias */
  /* Ringing Profile */
 0x00, 0x04, 0x00, 0x12, 0x01, 0x0C, 0xD2, 0x00, 0x00, 0x00, 0x00, 0x89,
 0x3F, 0x95, 0x00, 0x00, 0x00, 0x00,
 0xAE, 0x05,  /* Ring Trip Threshold (23mA) and Current Limit (60mA)*/
 0x0F, /* Max Supply Ringing Voltage 80V */
 0x00  /* Ringing Tracking Mode */
};

/* Japan Ringing 16 Hz 55 Vrms Tracking */
const VpProfileDataType RING_JP_89156[] =
{
  /* Sine, 16 Hz, 1.41 CF, 77.00 Vpk, 0.00 Bias */
  /* Ringing Profile */
...
/* Singapore Ringing 24 Hz 55 Vrms Tracking */
const VpProfileDataType RING_SG_89156[] =
{
  /* Sine, 24 Hz, 1.41 CF, 77.00 Vpk, 0.00 Bias */
  /* Ringing Profile */
...
const VpProfileDataType RING_25HZ_TRAP_89156[] =
{
  /* Trap, 25 Hz, 1.41 CF, 85.00 Vpk, 0.00 Bias */
  /* Ringing Profile */
0x00, 0x04, 0x00, 0x12, 0x01, 0x0C, 0xD2, 0x01, 0x00, 0x00, 0x00, 0xB6,
0x46, 0x31, 0x01, 0x40, 0x00, 0x00,
...
/* end of file Le89156_100V_IB_Profile.c */
