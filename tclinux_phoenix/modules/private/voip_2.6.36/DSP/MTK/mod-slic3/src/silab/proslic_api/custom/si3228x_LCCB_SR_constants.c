...
/*
	...
	Rprot = 30 ohms, Type = SMART_RINGING, Waveform = SINE
*/ 
0x00050000L,	/* RTPER */
...
0xFFFE7000L,	/* SMART_RING_PERIOD */
0xFFFF9C00L,	/* SMART_RING_PHASE */
...
*/ 
0x00064000L,	/* RTPER */
0x07F5A000L,	/* RINGFR (16.000 Hz) */
0x001612BEL,	/* RINGAMP (45.000 vrms)  */
0x00000000L,	/* RINGPHAS */
0x00000000L,	/* RINGOF (0.000 vdc) */
0x15E5200EL,	/* SLOPE_RING (100.000 ohms) */
0x006C94D6L,	/* IRING_LIM (70.000 mA) */
0x00827954L,	/* RTACTH (57.642 mA) */
0x0FFFFFFFL,	/* RTDCTH (450.000 mA) */
0x00004000L,	/* RTACDB (75.000 ms) */
0x00004000L,	/* RTDCDB (75.000 ms) */
0x00C49BA0L,	/* VOV_RING_BAT (12.000 v) */
0x00000000L,	/* VOV_RING_GND (0.000 v) */
0x0557F143L,	/* VBATR_EXPECT (83.493 v) */
0x80,			/* RINGTALO (2.000 s) */
0x3E,			/* RINGTAHI */
0x00,			/* RINGTILO (4.000 s) */
0x7D,			/* RINGTIHI */
...
0x98,			/* RINGCON */
0x00,			/* USERSTAT */
0x02ABF8A1L,	/* VCM_RING (38.746 v) */
0x02ABF8A1L,	/* VCM_RING_FIXED */
0x003126E8L,	/* DELTA_VCM */
0x00200000L,	/* DCDC_RNGTYPE */
0x00FFFFFFL,	/* VOV_DCDC_SLOPE */
0x00A18937L,	/* VOV_DCDC_OS */
0x00E49BA5L,	/* VOV_RING_BAT_MAX */
0xFFFE0C00L,	/* SMART_RING_PERIOD */
0xFFFF8300L,	/* SMART_RING_PHASE */
...
0x00A18937L,	/* VOV_DCDC_OS */
0x00E49BA5L,	/* VOV_RING_BAT_MAX */
0xFFFEC000L,	/* SMART_RING_PERIOD */
0xFFFFB000L,	/* SMART_RING_PHASE */
...
*/ 
0x00060000L,	/* RTPER */
0x07D34000L,	/* RINGFR (33.330 Hz) */
0x002E2C53L,	/* RINGAMP (45.000 vrms)  */
0x00000000L,	/* RINGPHAS */
0x00000000L,	/* RINGOF (0.000 vdc) */
0x15E5200EL,	/* SLOPE_RING (100.000 ohms) */
0x006C94D6L,	/* IRING_LIM (70.000 mA) */
0x007EA343L,	/* RTACTH (58.278 mA) */
0x0FFFFFFFL,	/* RTDCTH (450.000 mA) */
0x00006000L,	/* RTACDB (75.000 ms) */
0x00006000L,	/* RTDCDB (75.000 ms) */
0x00C49BA0L,	/* VOV_RING_BAT (12.000 v) */
0x00000000L,	/* VOV_RING_GND (0.000 v) */
0x05598450L,	/* VBATR_EXPECT (83.589 v) */
0x80,			/* RINGTALO (2.000 s) */
0x3E,			/* RINGTAHI */
0x00,			/* RINGTILO (4.000 s) */
0x7D,			/* RINGTIHI */
...
0x98,			/* RINGCON */
0x00,			/* USERSTAT */
0x02ACC228L,	/* VCM_RING (38.794 v) */
0x02ACC228L,	/* VCM_RING_FIXED */
0x003126E8L,	/* DELTA_VCM */
0x00200000L,	/* DCDC_RNGTYPE */
0x00FFFFFFL,	/* VOV_DCDC_SLOPE */
0x00A18937L,	/* VOV_DCDC_OS */
0x00E49BA5L,	/* VOV_RING_BAT_MAX */
0xFFFF1000L,	/* SMART_RING_PERIOD */
0xFFFFC400L,	/* SMART_RING_PHASE */
