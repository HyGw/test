...
static VpLineCtxType           lineCtx_ptr[ZL88601_1_CHAN_NUM];
static Vp886LineObjectType     lineObj_ptr[ZL88601_1_CHAN_NUM];
VpEventType   zl88601_1_legerityEventObj; // a temp var need not duplicate  [ZL88601_1_CHAN_NUM]; // 1=>2
zl88601_1_LineStat_t zl88601_1_LineStat[ZL88601_1_CHAN_NUM]; // 1=>2

#define SLIC_Offset 2

int zl88601_1_Init_Cmp = _TDI_FALSE;
int zl88601_1_Init_Line_Cmp[ZL88601_1_CHAN_NUM]= {_TDI_FALSE,_TDI_FALSE};
int zl88601_1_Get_Mask_Cmp = _TDI_FALSE;
int zl88601_1_Line_Cal_Cmp[ZL88601_1_CHAN_NUM]= {_TDI_FALSE,_TDI_FALSE};
...
unsigned int zl88601_1_event_process_flags; //dyma_20140218

/*20110714 PTChen add for slic country*/
const VpProfileDataType *DEVICE_PRO_zl88601_1;
const VpProfileDataType *AC_PRO_FXS_zl88601_1;
const VpProfileDataType *DC_PRO_FXS_zl88601_1;
const VpProfileDataType *RINGING_PRO_FXS_zl88601_1;
const VpProfileDataType *AC_PRO_FXO_zl88601_1;
const VpProfileDataType *CONFIG_PRO_FXO_zl88601_1;
const VpProfileDataType *RINGING_CADENCE_PRO_zl88601_1;
const VpProfileDataType *CALL_ID_PRO_zl88601_1;
const VpProfileDataType *METERING_PRO_zl88601_1; //dyma_20140218
...
//#define NB_LINE     2  // replace by ZL88601_1_CHAN_NUM

/* FXS on device ID, FXO on device ID */
//#define FXS_LINE    0  // related to ZL88601_1_FXS_NUM
//#define FXO_LINE    1  // related to ZL88601_1_FXO_NUM
#endif

slicFuncTbl zl88601_1Func[]={
		zl88601_1_deviceVerify,
		zl88601_1_deviceInit,
		zl88601_1_shutdownHw,
		zl88601_1_paramReset,
		zl88601_1_phoneRingStart,
		zl88601_1_phoneRingStop,
		zl88601_1_eventProcess,
		zl88601_1_fxsSetLineState,
		zl88601_1_fxsGetLineState,
		zl88601_1_fxsSetBatteryPol,
		zl88601_1_fxsGetBatteryPol,
		zl88601_1_fxsGetHookState,
		zl88601_1_ringState,
		zl88601_1_fxsGetPulseStatus,
		zl88601_1_fxsSetGainLv,
		...
		zl88601_1_dumpregister,
		slicFunc_dummy,
		zl88601_1_LtTestStart,//Roger_lt
		zl88601_1_getLtTestResult,//Roger_lt
		zl88601_1_fxsSetMetering,  //dyma_20140428 metering
		zl88601_1_SetLoopback,
		zl88601_1_SetRingParam,	//mtk07059_20150423
                zl88601_1_SetDcFeedParam,	//mtk07059_20150616
};
...
hwProfList_t zl88601_1_country_mapping[] =
{
...
*
*******************************************************************************/
void zl88601_1_slicParamReset(int idx){
	/*====== decide profile according to Country code =====*/
	/*Reset by default table*/
	DEVICE_PRO_zl88601_1 = ZLR88621L_ABS81V_DEVICE;
	AC_PRO_FXS_zl88601_1 = AC_FXS_RF14_600R_DEF;
	DC_PRO_FXS_zl88601_1 = DC_FXS_ZL880_ABS100V_DEF;
	RINGING_PRO_FXS_zl88601_1 = RING_ZL880_ABS100V_DEF;
	AC_PRO_FXO_zl88601_1 = VP_PTABLE_NULL;
	CONFIG_PRO_FXO_zl88601_1 = VP_PTABLE_NULL;
	CALL_ID_PRO_zl88601_1 = VP_PTABLE_NULL;
	METERING_PRO_zl88601_1 = NULL; //dyma_20140428

	if((idx >= C_DEF) && (idx < C_NUM)){
		DEVICE_PRO_zl88601_1 = zl88601_1_country_mapping[idx].pDevice;
		AC_PRO_FXS_zl88601_1 = zl88601_1_country_mapping[idx].pAcFXS;
		DC_PRO_FXS_zl88601_1 = zl88601_1_country_mapping[idx].pDcFXS;
		RINGING_PRO_FXS_zl88601_1 = zl88601_1_country_mapping[idx].pRingingFXS;
		AC_PRO_FXO_zl88601_1 = zl88601_1_country_mapping[idx].pAcFXO;
		CONFIG_PRO_FXO_zl88601_1 = zl88601_1_country_mapping[idx].pConfigFXO;
		CALL_ID_PRO_zl88601_1 = zl88601_1_country_mapping[idx].pCallID;
		METERING_PRO_zl88601_1 = zl88601_1_country_mapping[idx].pMetering; //dyma_20140428 
		SLIC_DBG_MSG(_SLIC_DBG_TYPE_INFO, " Successful(CountryCode=%s)\n", \
				zl88601_1_country_mapping[idx].name);
	}
	else{
 ...
 */
int zl88601_1_paramReset(char* buf){
//	int country = *(int *)buf;
	uint8 i=0;
...
/*_____________________________________________________________________________
 **      function name: zl88601_1_deviceVerify
 **      descriptions:
 **            driver verify
 **      parameters:
 **				void
...
int zl88601_1_deviceVerify(char* buf){
	...
	SLIC_DBG_MSG(_SLIC_DBG_TYPE_INFO, "\nzl88601_1_deviceVerify fxsNum:%d\n",devInfo->fxsNum);
	if(devInfo->fxsNum >2)
	{
		SLIC_DBG_MSG(_SLIC_DBG_TYPE_WARNING, "zl88601_1_deviceVerify already! Bypass 2nd verify! fxsNum:%d\n",devInfo->fxsNum);
		return _TDI_FAIL;
	}
	
	SLIC_DBG_MSG(_SLIC_DBG_TYPE_INFO, "zl88601_1_deviceVerify Start\r\n");
		
	while(((res_arr[0]!=0x2) ||(res_arr[1]!=0x73))&&((res_arr[0]!=0x2) ||(res_arr[1]!=0x77))){ /*88601/88602*/
		VpMpiCmd(devInfo->deviceNum, VP886_EC_1, VP886_R_RCNPCN_RD, VP886_R_RCNPCN_LEN, res_arr);

		RCNPCN_rd_cnt++;
		if(RCNPCN_rd_cnt>100)
		{
			SLIC_DBG_MSG(_SLIC_DBG_TYPE_ERROR, "zl88601_1_deviceVerify RCNPCN mismatch!\n");		
	...
	zl88601_DevPhyLocation =devInfo->fxsNum;//devInfo->deviceNum;
	SLIC_DBG_MSG(_SLIC_DBG_TYPE_INFO, "zl88601_1_deviceVerify Success! \r\nrd_cnt=%d\r\n",RCNPCN_rd_cnt);
	...
	#if ZL88601_1_SELF_TEST
	uint8 temp_val=0x47;

	/* printing the SLIC state */		
	VpMpiCmd( devInfo->deviceNum, VP886_EC_1, VP886_R_OPCOND_RD, 1, res_arr );		
	SLIC_DBG_MSG(_SLIC_DBG_TYPE_DEBUG, "SLIC_SELF_TEST VP886_R_OPCOND_RD = 0x%x\n",res_arr[0]);
	...
	/* printing the SLIC state */		
	VpMpiCmd( devInfo->deviceNum, VP886_EC_1, VP886_R_OPCOND_RD, 1, res_arr );		
	SLIC_DBG_MSG(_SLIC_DBG_TYPE_DEBUG, "SLIC_SELF_TEST WRT VAL = 0x%x\nSLIC_SELF_TEST RD BACK = 0x%x\n", temp_val, res_arr[0]);
	...
	devInfo->deviceNum += 1;
	devInfo->fxsNum += ZL88601_1_FXS_NUM;
	devInfo->fxoNum += ZL88601_1_FXO_NUM;
	devInfo->slicType = ZARLINK_88601;
	devInfo->pcm1ChNum += ZL88601_1_FXS_NUM+ZL88601_1_FXO_NUM;
	devInfo->pcm2ChNum += 0;
	return _TDI_SUCCESS;
...
/*_____________________________________________________________________________
 **      function name: zl88601_1_deviceInit
 **      descriptions:
 **            driver init
 **      parameters:
 **				void
...
int zl88601_1_deviceInit(char* buf){
	int                  devCnt;
	int                  lineCnt;
    ...
    timeSlotIdx = devCnt;
        ...
        //dyma_20140218
	zl88601_1_Init_Line_Cmp[0] = _TDI_FALSE;
	zl88601_1_Init_Line_Cmp[1] = _TDI_FALSE;
	zl88601_1_Line_Cal_Cmp[0]	 = _TDI_FALSE;
	zl88601_1_Line_Cal_Cmp[1]	 = _TDI_FALSE;
	
	zl88601_1_Init_Cmp = _TDI_FALSE;
	zl88601_Init_Cnt = 0;
	...
	if(devCnt!=zl88601_DevPhyLocation){
		SLIC_DBG_MSG(_SLIC_DBG_TYPE_INFO, "Bypass zl88601_1_deviceInit on Device %d!\n",devCnt/2);  //dyma_130118
	...
	SLIC_DBG_MSG(_SLIC_DBG_TYPE_INFO, "zl88601_1_deviceInit %d\n",devCnt);  //dyma_130118 
	...
	for (lineCnt=0; lineCnt < ZL88601_1_CHAN_NUM; lineCnt++) {
    ...
    zl88601_1_slicParamReset(pinitSetting->hwProfId);
    status = VpInitDevice(&devCtx_ptr , DEVICE_PRO_zl88601_1, AC_PRO_FXS_zl88601_1, DC_PRO_FXS_zl88601_1, RINGING_PRO_FXS_zl88601_1, AC_PRO_FXO_zl88601_1, CONFIG_PRO_FXO_zl88601_1);
    if (VP_STATUS_SUCCESS != status) {
    ...
    while (zl88601_1_Init_Cmp != _TDI_TRUE) {
		zl88601_Init_Cnt++;
		...
		mdelay(10);
		zl88601_1_eventProcess((char *)&devCnt);
    }
	SLIC_DBG_MSG(_SLIC_DBG_TYPE_INFO, "\r\nzl88601_Init_Cnt = %d\n",zl88601_Init_Cnt);

	if(zl88601_1_Init_Cmp == FALSE)
	{
		SLIC_1_DBG_MSG(_SLIC_DBG_TYPE_ERROR,"zl88601_Init_Cnt=%d, TIMEOUT !!! \n",zl88601_Init_Cnt);
		atomic_set(&zl88601_init_ongoing,0); //dyma_20140218
		return _TDI_FAIL;
	}
...
//	eventMask.fxo &= ~VP_LINE_EVID_POLREV;
   ...
   // VpSetOption(VP_NULL, &devCtx_ptr, VP_OPTION_ID_PULSE_MODE, &pulseMode);
    ...
    zl88601_1_LineStat[0].fxsHookStat = TIC_IMMEDIATE_ONHOOK;
	zl88601_1_LineStat[1].fxsHookStat = TIC_IMMEDIATE_ONHOOK;
	
	//dyma_20140428 metering
	for (lineCnt=0; lineCnt < ZL88601_1_CHAN_NUM; lineCnt++) {
		VpInitMeter(&(lineCtx_ptr[lineCnt]),METERING_PRO_zl88601_1);
	}
...
/*_____________________________________________________________________________
 **      function name: zl88601_1_fxsSetLineState
 **      descriptions:
 **            set ring state
 **      parameters:
 **				void
...
/*_____________________________________________________________________________
 **      function name: zl88601_1_fxsGetLineState
 **      descriptions:
 **            set ring state
 **      parameters:
 **				void
...
/*_____________________________________________________________________________
 **      function name: zl88601_1_fxsGetBatteryPol
 **      descriptions:
 **            set ring state
 **      parameters:
 **				void
...
/*_____________________________________________________________________________
 **      function name: zl88601_1_fxsSetBatteryPol
 **      descriptions:
...
/*_____________________________________________________________________________
 **      function name: zl88601_1_fxsGetHookState
 **      descriptions:
 **            get hook polarity
 **      parameters:
 **				void
...
int zl88601_1_fxsGetHookState(char* buf){
	...
	//dbg_printf("%s",__func__);
	pHookStat->hookStat = zl88601_1_LineStat[pHookStat->chan - SLIC_Offset].fxsHookStat;
	return _TDI_SUCCESS;
}

/*_____________________________________________________________________________
 **      function name: zl88601_1_ringState
 **      descriptions:
 **            get ring state
 **      parameters:
 **				void
...
int zl88601_1_eventProcess(char *buf){
...
//	int chan=0;
	...
	if(devCnt!=zl88601_DevPhyLocation){
		//printk("Bypass zl88601_1_eventProcess on Device %d!\n",devCnt);  //dyma_130118
		return _TDI_SUCCESS;
	}

	spin_lock_irqsave(&zl88601_event_process_lock, zl88601_1_event_process_flags); //dyma_20140218
    ...
    if(VpGetEvent(legerityDev_ptr,&zl88601_1_legerityEventObj)){
		
		ret_event_process_chan_id = zl88601_1_legerityEventObj.channelId;
	
        //if ((TRUE == legerityEventStatus) && (VP_STATUS_SUCCESS == zl88601_1_legerityEventObj[devCnt].status)) {
        if ((VP_STATUS_SUCCESS == zl88601_1_legerityEventObj.status)
			&&(VP_STATUS_SUCCESS==zl88601_1_legerityEventObj.eventData)){
			
			SLIC_1_DBG_MSG(_SLIC_DBG_TYPE_DEBUG,"Chk[%d]:Dev[%d]chan[%d][%d]:st0=%d,ed0=%d: Cat=0x%x Id=0x%x\n",
			devCnt,
			zl88601_1_legerityEventObj.deviceId,
			zl88601_1_legerityEventObj.channelId,
			ret_event_process_chan_id,
			zl88601_1_legerityEventObj.status,
			zl88601_1_legerityEventObj.eventData,
			zl88601_1_legerityEventObj.eventCategory,
			zl88601_1_legerityEventObj.eventId); 
            ...
            if (VP_EVCAT_RESPONSE == zl88601_1_legerityEventObj.eventCategory) {
                switch (zl88601_1_legerityEventObj.eventId) {
                    case VP_DEV_EVID_DEV_INIT_CMP:
		                ...
		                for (lineNum=0; lineNum < ZL88601_1_CHAN_NUM; lineNum++) {   //line init
					...
					case VP_EVID_CAL_CMP:
						...
						zl88601_1_Line_Cal_Cmp[ret_event_process_chan_id] = _TDI_TRUE;
						SLIC_1_DBG_MSG(_SLIC_DBG_TYPE_DEBUG,"Calibration done on lineNum %d (%d/%d)\n", ret_event_process_chan_id,cmpCounter,ZL88601_1_CHAN_NUM);
						if (cmpCounter == ZL88601_1_CHAN_NUM) {
							/* Device Initialization is complete */
							zl88601_1_Init_Cmp = _TDI_TRUE;
            ...
            else if (VP_EVCAT_SIGNALING == zl88601_1_legerityEventObj.eventCategory) {
                switch (zl88601_1_legerityEventObj.eventId) {
                    case VP_LINE_EVID_HOOK_OFF:
						SLIC_1_DBG_MSG(_SLIC_DBG_TYPE_DEBUG,"chan %d HOOK_OFF\n\n",ret_event_process_chan_id);
                    	zl88601_1_LineStat[ret_event_process_chan_id].fxsHookStat = TIC_IMMEDIATE_OFFHOOK;
                        break;
                    case VP_LINE_EVID_HOOK_ON:
						SLIC_1_DBG_MSG(_SLIC_DBG_TYPE_DEBUG,"chan %d HOOK_ON\n\n",ret_event_process_chan_id);
                    	zl88601_1_LineStat[ret_event_process_chan_id].fxsHookStat = TIC_IMMEDIATE_ONHOOK;
                        break;
                    default:
                        /* Do nothing */
                        break;
            ...
            else if(VP_EVCAT_FXO == zl88601_1_legerityEventObj.eventCategory){
				SLIC_1_DBG_MSG(_SLIC_DBG_TYPE_WARNING,"#zl88601 not support FXO\n\n");
            }
        }
		else{
	...
	spin_unlock_irqrestore(&zl88601_event_process_lock, zl88601_1_event_process_flags); //dyma_20140218
	...
	if (_TDI_VP890_SIGREG_LIU & mpiData ) {     //off-hook state
		if (zl88601_1_LineStat.fxsHookStat != TIC_IMMEDIATE_OFFHOOK) {
			zl88601_1_LineStat.fxsHookStat  = TIC_IMMEDIATE_OFFHOOK;
		}
		else { }
	} else {                                    // on-hook state
		if (zl88601_1_LineStat.fxsHookStat != TIC_IMMEDIATE_ONHOOK) {
			zl88601_1_LineStat.fxsHookStat  = TIC_IMMEDIATE_ONHOOK;
		}
	}*/
...
//Roger_lt
int zl88601_1_LtTestStart(char* buf) {
	_TDI_devicelinetest_t* linetest=(_TDI_devicelinetest_t*)buf;

	if(atomic_read(&zl88601_init_ongoing))	//dyma_20140218
		return _TDI_FAIL;

	if(linetest->chan<ZL88601_1_CHAN_NUM)	
...
int* zl88601_1_getLtTestResult(void)
{
...
int zl88601_1_SetLoopback(char *buf)
{
	...
	if (VP_STATUS_SUCCESS != VpSetOption(&(lineCtx_ptr[loopbackSetting->chan - SLIC_Offset]), VP_NULL, VP_OPTION_ID_LOOPBACK, &loopBack)) {
...
int zl88601_1_SetRingParam(char *buf)
{
	...
	if(0 == ringParams->type){
		ret = VpConfigLine(&(lineCtx_ptr[ringParams->chanId - SLIC_Offset]), VP_NULL, VP_NULL, RINGING_PRO_FXS_zl88601_1);
	}
	else if(1 == ringParams->type){
		ret = VpConfigLine(&(lineCtx_ptr[ringParams->chanId - SLIC_Offset]), VP_NULL, VP_NULL, RING_ZL880_ABS100V_TRAP);
	}
	else{
		return _TDI_FAIL;
	}
	...
	ret = VpSetOption(&(lineCtx_ptr[ringParams->chanId - SLIC_Offset]), VP_NULL, VP_OPTION_ID_RINGING_PARAMS, &vpParams);
	if(ret != VP_STATUS_SUCCESS){
		SLIC_DBG_MSG(_SLIC_DBG_TYPE_ERROR, "ERROR ret:%d\n", ret);
		return _TDI_FAIL;
	}
...
int zl88601_1_SetDcFeedParam(char* buf)
{
...
int zl88601_fxoGetRingCadence(char* buf){
	event_printf("%s - %d\n",__func__,zl88601_1_LineStat.fxoRingStat);
	return zl88601_1_LineStat.fxoRingStat;
}
int zl88601_fxoGetHookState(char* buf){
	dbg_printf("%s - %d \n",__func__,zl88601_1_LineStat.fxoHookStat);
    return zl88601_1_LineStat.fxoHookStat;
}
...
int zl88601_fxoGetPSTNStats(char* buf){
	//printk("%s  \n",__func__);
	return zl88601_1_LineStat.fxoLineConn;
