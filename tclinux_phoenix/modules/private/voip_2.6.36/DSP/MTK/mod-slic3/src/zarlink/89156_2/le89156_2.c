 ...
 *************************************************************************
 */
static VpDevCtxType            devCtx_ptr_2;
static Vp890DeviceObjectType   devObj_ptr_2;
static VpLineCtxType           lineCtx_ptr_2;
static Vp890LineObjectType     lineObj_ptr_2;
int le89156_2_FXS_Init_Cmp = _TDI_FALSE;
int le89156_2_Get_Mask_Cmp = _TDI_FALSE;
int le89156_2_Line_Cal_Cmp= _TDI_FALSE;
static atomic_t le89156_2_init_ongoing=ATOMIC_INIT(0);
...
static atomic_t le89156_2_SlicApiStatus;

int le89156_2_immediateHookState;

#if LINUX_VERSION_CODE > KERNEL_VERSION(2,6,31)
extern void VpSysSemaphoreInit(int semaphoredId);
#endif

slicFuncTbl le89156_2Func[]={
		le89156_2_deviceVerify,
		le89156_2_deviceInit,
		le89156_2_shutdownHw,
		le89156_2_paramReset,
		le89156_2_phoneRingStart,
		le89156_2_phoneRingStop,
		le89156_2_eventProcess,
		le89156_2_fxsSetLineState,
		le89156_2_fxsGetLineState,
		le89156_2_fxsSetBatteryPol,
		le89156_2_fxsGetBatteryPol,
		le89156_2_fxsGetHookState,
		le89156_2_ringState,
		le89156_2_fxsGetPulseStatus,
		le89156_2_fxsSetGainLv,
		slicFunc_dummy,
		slicFunc_dummy,
		slicFunc_dummy,
		slicFunc_dummy,
		slicFunc_dummy,
		slicFunc_dummy,
		le89156_2_dumpregister,
		slicFunc_dummy,
		le89156_2_LtTestStart,//Roger_lt
		le89156_2_getLtTestResult,//Roger_lt
		slicFunc_dummy,  //dyma_20140428 metering
		le89156_2_SetLoopback,  //FXS_SET_LOOPBACK
		le89156_2_SetRingParam,	//mtk07059_20150423		
		le89156_2_SetDcFeedParam,	//mtk07059_20150616		
};

/*20110714 PTChen add for slic country*/
const VpProfileDataType *DEVICE_PRO_89156_2;
const VpProfileDataType *AC_PRO_FXS_89156_2;
const VpProfileDataType *DC_PRO_FXS_89156_2;
const VpProfileDataType *RINGING_PRO_FXS_89156_2;
const VpProfileDataType *AC_PRO_FXO_89156_2;
const VpProfileDataType *CONFIG_PRO_FXO_89156_2;
const VpProfileDataType *RINGING_CADENCE_PRO_89156_2;
const VpProfileDataType *CALL_ID_PRO_89156_2;

hwProfList_t *country_mapping_89156_2;

//dyma_20140428 
hwProfList_t country_mapping_89156_a_2[] =
{
...
hwProfList_t country_mapping_89156_b_2[] =
{
...
*
*******************************************************************************/
void slicParamReset_89156_2(int idx){
	...
	if (TCSUPPORT_ZARLINK_LE89156A_VAL){
		...
		DEVICE_PRO_89156_2 = DEV_PROFILE_Inverting_Boost_100V_89156_A;
		country_mapping_89156_2 = country_mapping_89156_a_2;
	}
	else{
		SLIC_DBG_MSG(_SLIC_DBG_TYPE_INFO, "TCSUPPORT_ZARLINK_LE89156B");
		DEVICE_PRO_89156_2 = DEV_PROFILE_Inverting_Boost_100V_89156_B;
		country_mapping_89156_2 = country_mapping_89156_b_2;
	}
	
	AC_PRO_FXS_89156_2 = AC_FXS_RF50_600R_DEF_89156;
	DC_PRO_FXS_89156_2 = DC_FXS_DEF_89156;
	RINGING_PRO_FXS_89156_2 = RING_25HZ_DEF_89156;
	AC_PRO_FXO_89156_2 = VP_PTABLE_NULL;
	CONFIG_PRO_FXO_89156_2 = VP_PTABLE_NULL;
	CALL_ID_PRO_89156_2 = VP_PTABLE_NULL;
	if((idx >= C_DEF) && (idx < C_NUM)){
		DEVICE_PRO_89156_2 = country_mapping_89156_2[idx].pDevice;
		AC_PRO_FXS_89156_2 = country_mapping_89156_2[idx].pAcFXS;
		DC_PRO_FXS_89156_2 = country_mapping_89156_2[idx].pDcFXS;
		RINGING_PRO_FXS_89156_2 = country_mapping_89156_2[idx].pRingingFXS;
		AC_PRO_FXO_89156_2 = country_mapping_89156_2[idx].pAcFXO;
		CONFIG_PRO_FXO_89156_2 = country_mapping_89156_2[idx].pConfigFXO;
		CALL_ID_PRO_89156_2 = country_mapping_89156_2[idx].pCallID;
		SLIC_DBG_MSG(_SLIC_DBG_TYPE_INFO, "%s Successful(CountryCode=%s)\n",__func__,\
				country_mapping_89156_2[idx].name);
	}
	else{
...
static int testCheck_read_proc(char *page, char **start, off_t off,
	...
	int len = 0;
	//VpSetLineState(&(lineCtx_ptr_2[FXO_LINE]),VP_LINE_FXO_LOOP_OPEN);
 ...
 */
int le89156_2_paramReset(char* buf){
//	int country = *(int *)buf;
	return _TDI_SUCCESS;
}

/*_____________________________________________________________________________
 **      function name: le89156_2_deviceVerify
 **      descriptions:
 **            driver verify
 **      parameters:
 **				void
...
int le89156_2_deviceVerify(char* buf){
	...
	uint8	res_arr[2] = {0};
	atomic_set(&le89156_2_SlicApiStatus,0);
	SLIC_DBG_MSG(_SLIC_DBG_TYPE_INFO, "le89156_2_deviceVerify\n");
    /*
     * Create the device object and device context
     */
	if (VP_STATUS_SUCCESS != VpMakeDeviceObject(VP_DEV_890_SERIES, devInfo->deviceNum, &devCtx_ptr_2, &devObj_ptr_2)) {
	...
	devInfo->deviceNum += 1;
	devInfo->fxsNum += LE89156_2_FXS_NUM;
	devInfo->fxoNum += LE89156_2_FXO_NUM;
	devInfo->pcm1ChNum += 0;
	devInfo->pcm2ChNum += LE89156_2_FXS_NUM+LE89156_2_FXO_NUM;
	return _TDI_SUCCESS;
}

/*_____________________________________________________________________________
 **      function name: le89156_2_deviceInit
 **      descriptions:
 **            driver init
 **      parameters:
 **				void
 ...
 **____________________________________________________________________________
 */
int le89156_2_deviceInit(char* buf){
	int                  devCnt;
    //int                  lineCnt;
    VpStatusType          status;
	...
	le89156_2_Line_Cal_Cmp	 = _TDI_FALSE;
	le89156_2_FXS_Init_Cmp = _TDI_FALSE;
	
	atomic_set(&le89156_2_init_ongoing,1);
    ...
    //for (devCnt = 0; devCnt < _TDI_FXS_NUM; devCnt++) {
        ...
        if (VP_STATUS_SUCCESS != VpMakeDeviceObject(VP_DEV_890_SERIES,
        		devCnt, &devCtx_ptr_2, &devObj_ptr_2)) {
        	dbg_printf("%s:%d Error returned from VpMakeDeviceObject!\n",__FILE__, __LINE__);
			atomic_set(&le89156_2_init_ongoing,0);
            return _TDI_FAIL;
        }
		/*
		...
		if (VP_STATUS_SUCCESS != VpMakeLineObject(VP_TERM_FXS_GENERIC, 0,
				&lineCtx_ptr_2, &lineObj_ptr_2, &devCtx_ptr_2)) {
		...
		slicParamReset_89156_2(pinitSetting->hwProfId);
		status = VpInitDevice(&devCtx_ptr_2, DEVICE_PRO_89156_2, AC_PRO_FXS_89156_2, DC_PRO_FXS_89156_2, RINGING_PRO_FXS_89156_2, VP_PTABLE_NULL, VP_PTABLE_NULL);
	    ...
	    while (le89156_2_FXS_Init_Cmp != TRUE) {
	    	event_printf(">>1.5\n");
	        /*
	         * Wait for event indicating that the initialization is complete
	         */
			mdelay(10); /*SERENA_MODIFY*/
			le89156_2_eventProcess((char *)&devCnt);  /* Only run for one line per device */
	    }
		...
		if(pinitSetting->slicCodecOption == CODEC_LINEAR){
			...
			if (VP_STATUS_SUCCESS != VpSetOption(VP_NULL, &devCtx_ptr_2,
        ...
        //VpSetOption(VP_NULL, &devCtx_ptr_2, VP_OPTION_ID_PULSE_MODE, &pulseMode);
        /*
	...
	eventMask.process &= ~(VP_LINE_EVID_SIGNAL_CMP);
		...
		VpSetOption(&lineCtx_ptr_2, VP_NULL, VP_OPTION_ID_TIMESLOT,
			&timeSlots);

		//VpSetLineState(&lineCtx_ptr_2, VP_LINE_ACTIVE);/*for COC by jq.zhu , OSBNB00030567, 20130327*/

		/*
		 * Adjust Tx/Rx relative gain levels.
		 */
		event_printf("gain--TX :%x RX: %x \n",pinitSetting->speakSlicVal, pinitSetting->listenSlicVal);
		VpSetRelGain(&lineCtx_ptr_2,pinitSetting->speakSlicVal, pinitSetting->listenSlicVal, 0);

		/*
		 * Calibrate Lines
		 */
		/*le89156_2_Line_Cal_Cmp = FALSE;
		VpCalLine(&lineCtx_ptr_2);
		while (le89156_2_Line_Cal_Cmp != TRUE) {
			 * Wait for event indicating that calibration is complete
			mdelay(10);
			le89156_2_eventProcess((char *)&devCnt);
		}*/
        event_printf(">>5\n");
        /*
         * Init the hook state for each FXS channel
         */
        le89156_2_immediateHookState = TIC_IMMEDIATE_ONHOOK;
		atomic_set(&le89156_2_init_ongoing,0);
    //}
    return _TDI_SUCCESS;
}
...
int le89156_2_shutdownHw(char* buf){
    int    lineCnt;
	if(atomic_read(&le89156_2_init_ongoing))
	{
		return _TDI_FAIL;
	}
    event_printf("%s",__func__);
     ...
     * Power down line
     */
    VpSetLineState(&lineCtx_ptr_2, VP_LINE_DISCONNECT);
    /*
     * Free the memory
     */
    VpFreeLineCtx(&lineCtx_ptr_2);
	
    return _TDI_SUCCESS;
}
/*_____________________________________________________________________________
 **      function name: le89156_2_fxsSetLineState
 **      descriptions:
 **            set ring state
 **      parameters:
 **				void
...
int le89156_2_fxsSetLineState(char* buf){
	...
	while(atomic_read(&le89156_2_SlicApiStatus)){
		apiWaitCnt++;
		mdelay(10);
		if(apiWaitCnt>1000){
			atomic_set(&le89156_2_SlicApiStatus,0);
			SLIC_DBG_MSG(_SLIC_DBG_TYPE_WARNING, "le89156_fxsSetLineState wait timeout, SLIC API occupied\n");
			break;
		}
	}
   ...
   event_printf("---ch:%d status: %d \n",plineInfo->chan,stateType);
    VpSetLineState(&lineCtx_ptr_2,stateType);
    return _TDI_SUCCESS;
}

/*_____________________________________________________________________________
 **      function name: le89156_2_fxsGetLineState
 **      descriptions:
 **            set ring state
 **      parameters:
 **				void
...
int le89156_2_fxsGetLineState(char* buf){
    ...
    event_printf("%s",__func__);
    VpGetLineState(&lineCtx_ptr_2, &state);
...
/*_____________________________________________________________________________
 **      function name: le89156_2_fxsGetBatteryPol
 **      descriptions:
 **            set ring state
 **      parameters:
 **				void
...
int le89156_2_fxsGetBatteryPol(char* buf){
    ...
    event_printf("%s",__func__);
    status = VpGetLineState(&lineCtx_ptr_2, &polarity);
    if (VP_STATUS_SUCCESS != status) {
...
/*_____________________________________________________________________________
 **      function name: le89156_2_fxsSetBatteryPol
 **      descriptions:
...
int le89156_2_fxsSetBatteryPol(char* buf){
	...
	while(atomic_read(&le89156_2_SlicApiStatus)){
		...
		if(apiWaitCnt>1000){
			atomic_set(&le89156_2_SlicApiStatus,0);
			SLIC_DBG_MSG(_SLIC_DBG_TYPE_WARNING, "le89156_fxsSetBatteryPol wait timeout, SLIC API occupied!\n");
			break;
		}
	}
    ...
    event_printf("%s",__func__);
    getStatus = VpGetLineState(&lineCtx_ptr_2, &curState);
    ...
    switch (curState) {
        ...
        case VP_LINE_ACTIVE_POLREV:
            if (TIC_BATT_POL_FORWARD == pBatteryPolInfo->polarity) {
                setStatus = VpSetLineState(&lineCtx_ptr_2, VP_LINE_ACTIVE);
            }
            else {
                setStatus = VpSetLineState(&lineCtx_ptr_2,
        ...
        case VP_LINE_OHT_POLREV:
            if (TIC_BATT_POL_FORWARD == pBatteryPolInfo->polarity) {
                setStatus = VpSetLineState(&lineCtx_ptr_2, VP_LINE_OHT);
            }
            else {
                setStatus = VpSetLineState(&lineCtx_ptr_2,
                        VP_LINE_OHT_POLREV);
        ...
        case VP_LINE_STANDBY_POLREV:
            if (TIC_BATT_POL_FORWARD == pBatteryPolInfo->polarity) {
                setStatus = VpSetLineState(&lineCtx_ptr_2, VP_LINE_STANDBY);
            }
            else {
                setStatus = VpSetLineState(&lineCtx_ptr_2,
        ...
        case VP_LINE_RINGING_POLREV:
            if (TIC_BATT_POL_FORWARD == pBatteryPolInfo->polarity) {
                setStatus = VpSetLineState(&lineCtx_ptr_2, VP_LINE_RINGING);
            }
            else {
                setStatus = VpSetLineState(&lineCtx_ptr_2,
        ...
        default:
            if (TIC_BATT_POL_FORWARD == pBatteryPolInfo->polarity) {
                setStatus = VpSetLineState(&lineCtx_ptr_2, VP_LINE_TALK);
            }
            else {
                setStatus = VpSetLineState(&lineCtx_ptr_2,
                        VP_LINE_TALK_POLREV);
...
/*_____________________________________________________________________________
 **      function name: le89156_2_fxsGetHookState
 **      descriptions:
 **            get hook polarity
 **      parameters:
 **				void
...
int le89156_2_fxsGetHookState(char* buf){
	...
	event_printf("%s",__func__);
	pHookStat->hookStat = le89156_2_immediateHookState;
	return _TDI_SUCCESS;
}

/*_____________________________________________________________________________
 **      function name: le89156_2_ringState
 **      descriptions:
 **            get ring state
 **      parameters:
 **				void
...
int le89156_2_fxsSetGainLv(char* buf){
	...
	while(atomic_read(&le89156_2_SlicApiStatus)){
		...
		if(apiWaitCnt>1000){
			atomic_set(&le89156_2_SlicApiStatus,0);
			SLIC_DBG_MSG(_SLIC_DBG_TYPE_WARNING, "le89156_fxsSetGainLv wait timeout, SLIC API occupied!\n");
			break;
		}
	}

	VpSetRelGain(&lineCtx_ptr_2,gainSetting->speakSlicVal,gainSetting->listenSlicVal, 0);
	dbg_printf("%s %x/%x \n",__func__,gainSetting->speakSlicVal,gainSetting->listenSlicVal);
	return _TDI_SUCCESS;
}
int le89156_2_fxsGetGain(char* buf){
	if(atomic_read(&le89156_2_init_ongoing))
		return _TDI_FAIL;
	event_printf("%s",__func__);
	return _TDI_SUCCESS;
...
int le89156_2_eventProcess(char* buf){
	...
	while(atomic_read(&le89156_2_SlicApiStatus)){
		...
		if(apiWaitCnt>1000){
			atomic_set(&le89156_2_SlicApiStatus,0);
			SLIC_DBG_MSG(_SLIC_DBG_TYPE_WARNING, " wait timeout, SLIC API occupied!\n");
			break;
		}
	}
            ...
            if (VP_EVCAT_RESPONSE == legerityEventObj.eventCategory) {
                ...
                switch (legerityEventObj.eventId) {
                    case VP_LINE_EVID_HOOK_OFF:
                    	...
                    	le89156_2_immediateHookState = TIC_IMMEDIATE_OFFHOOK;
                        break;
...
// 						VpSetLineState(lineCtx_ptr_2[lineCnt], VP_LINE_TALK);
// 						if(pEvent->eventData <= 5){
// 							VpSetLineTone(lineCtx_ptr_2[lineCnt], tonePtrs[]);
// 						}
// 						break;
                    default:
                        /* Do nothing */
	...
	if (_TDI_VP890_SIGREG_LIU & mpiData ) {     //off-hook state
		if (le89156_2_immediateHookState != TIC_IMMEDIATE_OFFHOOK) {
			le89156_2_immediateHookState  = TIC_IMMEDIATE_OFFHOOK;
		}
		else { }
	} else {                                    // on-hook state
		if (le89156_2_immediateHookState != TIC_IMMEDIATE_ONHOOK) {
			le89156_2_immediateHookState  = TIC_IMMEDIATE_ONHOOK;
		}
	}*/
...
int le89156_2_dumpregister(char* buf){
	...
	Vp890DeviceObjectType *pDevObj = devCtx_ptr_2.pDevObj;
...
//Roger_lt
int le89156_2_LtTestStart(char* buf) {
	if(atomic_read(&le89156_2_init_ongoing))
		return _TDI_FAIL;

	return LtTestStart(&lineCtx_ptr_2,&devCtx_ptr_2,buf);
}


int* le89156_2_getLtTestResult(void)
{
	if(atomic_read(&le89156_2_init_ongoing))
		return _TDI_FAIL;
...
int le89156_2_SetLoopback(char *buf)
{
	...
	if(atomic_read(&le89156_2_init_ongoing))	//dyma_20140218
		return _TDI_FAIL;
	if(loopbackSetting->chan >= LE89156_2_FXS_NUM)
		return _TDI_FAIL;
	...
	if (VP_STATUS_SUCCESS != VpSetOption(&lineCtx_ptr_2, VP_NULL, VP_OPTION_ID_LOOPBACK, &loopBack)) {
...
int le89156_2_SetRingParam(char* buf)
{
	...
	if(0 == ringParams->type){
		ret = VpConfigLine(&(lineCtx_ptr_2), VP_NULL, VP_NULL, RINGING_PRO_FXS_89156_2);
	}
	else if(1 == ringParams->type){
		ret = VpConfigLine(&(lineCtx_ptr_2), VP_NULL, VP_NULL, RING_25HZ_TRAP_89156);
	}
	else{
		return _TDI_FAIL;
	}
	...
	ret = VpSetOption(&(lineCtx_ptr_2), VP_NULL, VP_OPTION_ID_RINGING_PARAMS, &vpParams);
	if(ret != VP_STATUS_SUCCESS){
		SLIC_DBG_MSG(_SLIC_DBG_TYPE_ERROR, "ERROR ret:%d\n", ret);
		return _TDI_FAIL;
	}
...
int le89156_2_SetDcFeedParam(char* buf)
{
	...
	ret = VpSetOption(&(lineCtx_ptr_2), VP_NULL, VP_OPTION_ID_DCFEED_PARAMS, &vpParams);
	if(ret != VP_STATUS_SUCCESS){
		SLIC_DBG_MSG(_SLIC_DBG_TYPE_ERROR, "ERROR ret:%d\n", ret);
		return _TDI_FAIL;
	}
