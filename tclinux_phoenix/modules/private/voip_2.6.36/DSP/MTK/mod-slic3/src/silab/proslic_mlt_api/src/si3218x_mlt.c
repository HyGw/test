...
pProSLICMLT->WriteRAM(pMLT_HW, pMLT_CHAN,MLT_COMM_RAM_P_TH_HVIC,0x4468adL);
		...
		case 3: /* Capture samples and accumulate */
			...
			{ /* Compute averages */
				...
				printf ("si3218x_mlt : execAutoV : Avg V1    = %dmV \n",pState->vmeas);
				printf ("si3218x_mlt : execAutoV : Avg I1    = %duA \n",pState->imeas);	    
		...
		case 7: /* Capture samples and accumulate 2nd measurement*/
			...
			{ /* Compute averages */
				...
				printf ("si3218x_mlt : execAutoV : Avg V2    = %dmV \n",pState->vmeas);
				printf ("si3218x_mlt : execAutoV : Avg I2    = %duA \n",pState->imeas);
			}
			else
			{ /* Take next sample */
