 ...
 *************************************************************************
 */
static VpDevCtxType            devCtx_ptr_1;
static Vp890DeviceObjectType   devObj_ptr_1;
static VpLineCtxType           lineCtx_ptr_1;
static Vp890LineObjectType     lineObj_ptr_1;
int le89116_1_FXS_Init_Cmp = _TDI_FALSE;
int le89116_1_Get_Mask_Cmp = _TDI_FALSE;
int le89116_1_Line_Cal_Cmp= _TDI_FALSE;
static atomic_t le89116_1_init_ongoing=ATOMIC_INIT(0);
//dyma_130306
#ifdef __KERNEL__      
#define PRINT					printk
...
int le89116_1_immediateHookState;
...
#if 0
int (*le89116_1Func[])(char *buf)={
		le89116_1_deviceInit,
		le89116_1_shutdownHw,
		le89116_1_paramReset,
		le89116_1_phoneRingStart,
		le89116_1_phoneRingStop,
		le89116_1_eventProcess,
		le89116_1_fxsSetLineState,
		le89116_1_fxsGetLineState,
		le89116_1_fxsSetBatteryPol,
		le89116_1_fxsGetBatteryPol,
		le89116_1_fxsGetHookState,
		le89116_1_ringState,
		le89116_1_fxsGetPulseStatus,
		le89116_1_fxoGetRingCadence,
		le89116_1_fxoGetHookState,
		le89116_1_fxoSetHookState,
		le89116_1_fxoGetLineStats,
		le89116_1_fxoGetPSTNStats,
		le89116_1_fxoSetMonitorMode,
		le89116_1_dumpregister,
};
#else
slicFuncTbl le89116_1Func[]={
		le89116_1_deviceVerify,
		le89116_1_deviceInit,
		le89116_1_shutdownHw,
		le89116_1_paramReset,
		le89116_1_phoneRingStart,
		...
		le89116_1_dumpregister,
		slicFunc_dummy,
		le89116_1_LtTestStart,//Roger_lt
		le89116_1_getLtTestResult,//Roger_lt
		slicFunc_dummy,  //dyma_20140428 metering
		le89116_1_SetLoopback,  //FXS_SET_LOOPBACK
		le89116_1_SetRingParam,  //added by mtk07059_20150423
		le89116_1_SetDcFeedParam,  //added by mtk07059_20150616
};
#endif

/*20110714 PTChen add for slic country*/
const VpProfileDataType *DEVICE_PRO_1;
const VpProfileDataType *AC_PRO_FXS_1;
const VpProfileDataType *DC_PRO_FXS_1;
const VpProfileDataType *RINGING_PRO_FXS_1;
const VpProfileDataType *AC_PRO_FXO_1;
const VpProfileDataType *CONFIG_PRO_FXO_1;
const VpProfileDataType *RINGING_CADENCE_PRO_1;
const VpProfileDataType *CALL_ID_PRO_1;

/*20110714 PTChen add for slic country*/ //dyma_20140428 
hwProfList_t le89116_country_mapping_1[] =
{
	{"Default"    	  , C_DEF, DEV_PROFILE_BuckBoost, AC_FXS_RF50_600R_DEF	, DC_FXS_DEF, RING_25HZ_DEF , NULL	, NULL , NULL , NULL },
	{"Australia"  	  ,  C_AU, DEV_PROFILE_BuckBoost, AC_FXS_RF50_AU 		, DC_FXS_DEF, RING_25HZ_DEF	, NULL	, NULL , NULL , NULL },
	{"Austria"   	  ,  C_AT, DEV_PROFILE_BuckBoost, AC_FXS_RF50_AT 		, DC_FXS_DEF, RING_AT  		, NULL	, NULL , NULL , NULL },
	{"BEL-Belgium"    ,  C_BE, DEV_PROFILE_BuckBoost, AC_FXS_RF50_BE 		, DC_FXS_DEF, RING_25HZ_DEF , NULL	, NULL , NULL , NULL },
	{"BRA-Brazil"     ,  C_BR, DEV_PROFILE_BuckBoost, AC_FXS_RF50_BR 		, DC_FXS_DEF, RING_25HZ_DEF , NULL	, NULL , NULL , NULL },
	{"Canada"    	  ,  C_CA, DEV_PROFILE_BuckBoost, AC_FXS_RF50_600R_DEF	, DC_FXS_DEF, RING_CA  		, NULL	, NULL , NULL , NULL },
	{"CHN-China"      ,  C_CN, DEV_PROFILE_BuckBoost, AC_FXS_RF50_CN 		, DC_FXS_DEF, RING_25HZ_DEF , NULL	, NULL , NULL , NULL },
	{"Czech"       	  ,  C_CZ, DEV_PROFILE_BuckBoost, AC_FXS_RF50_600R_DEF	, DC_FXS_DEF, RING_25HZ_DEF , NULL	, NULL , NULL , NULL },
	{"DNK-Denmark"    ,  C_DK, DEV_PROFILE_BuckBoost, AC_FXS_RF50_DK 		, DC_FXS_DEF, RING_25HZ_DEF , NULL	, NULL , NULL , NULL },
	{"ETS-ETSI"       ,  C_EU, DEV_PROFILE_BuckBoost, AC_FXS_RF50_ETSI 		, DC_FXS_DEF, RING_25HZ_DEF , NULL	, NULL , NULL , NULL },
	{"FIN-Finland"    ,  C_FI, DEV_PROFILE_BuckBoost, AC_FXS_RF50_FI 		, DC_FXS_DEF, RING_25HZ_DEF , NULL	, NULL , NULL , NULL },
	{"FRA-France"     ,  C_FR, DEV_PROFILE_BuckBoost, AC_FXS_RF50_FR 		, DC_FXS_DEF, RING_FR  		, NULL	, NULL , NULL , NULL },
	{"DEU-Germany"    ,  C_DE, DEV_PROFILE_BuckBoost, AC_FXS_RF50_DE 		, DC_FXS_DEF, RING_25HZ_DEF , NULL	, NULL , NULL , NULL },
	{"Greece"     	  ,  C_GR, DEV_PROFILE_BuckBoost, AC_FXS_RF50_GR57 		, DC_FXS_DEF, RING_25HZ_DEF , NULL	, NULL , NULL , NULL },
	{"HongKong"  	  ,  C_HK, DEV_PROFILE_BuckBoost, AC_FXS_RF50_600R_DEF	, DC_FXS_DEF, RING_HK 		 , NULL	, NULL , NULL , NULL },
	{"HUN-Hungary"    ,  C_HU, DEV_PROFILE_BuckBoost, AC_FXS_RF50_HU 		, DC_FXS_DEF, RING_25HZ_DEF , NULL	, NULL , NULL , NULL },
	{"Ireland"   	  ,  C_IE, DEV_PROFILE_BuckBoost, AC_FXS_RF50_600R_DEF	, DC_FXS_DEF, RING_25HZ_DEF , NULL	, NULL , NULL , NULL },
	{"Israel"    	  ,  C_IL, DEV_PROFILE_BuckBoost, AC_FXS_RF50_600R_DEF	, DC_FXS_DEF, RING_25HZ_DEF , NULL	, NULL , NULL , NULL },
	{"India"      	  ,  C_IN, DEV_PROFILE_BuckBoost, AC_FXS_RF50_600R_DEF 	, DC_FXS_DEF, RING_25HZ_DEF , NULL	, NULL , NULL , NULL },
	{"ITA-Italy"      ,  C_IT, DEV_PROFILE_BuckBoost, AC_FXS_RF50_IT 		, DC_FXS_DEF, RING_25HZ_DEF , NULL	, NULL , NULL , NULL },
	{"JPN-Japan"      ,  C_JP, DEV_PROFILE_BuckBoost, AC_FXS_RF50_JP 		, DC_FXS_DEF, RING_JP 		 , NULL	, NULL , NULL , NULL },
	{"Singapore" 	  ,  C_SG, DEV_PROFILE_BuckBoost, AC_FXS_RF50_600R_DEF	, DC_FXS_DEF, RING_SG 		 , NULL	, NULL , NULL , NULL },
	{"S.Korea"   	  ,  C_KR, DEV_PROFILE_BuckBoost, AC_FXS_RF50_600R_DEF 	, DC_FXS_DEF, RING_KR  		 , NULL	, NULL , NULL , NULL },
	{"Mexico"     	  ,  C_MX, DEV_PROFILE_BuckBoost, AC_FXS_RF50_600R_DEF 	, DC_FXS_DEF, RING_25HZ_DEF , NULL	, NULL , NULL , NULL },
	{"NLD-Netherlands",  C_NL, DEV_PROFILE_BuckBoost, AC_FXS_RF50_NL 		, DC_FXS_DEF, RING_25HZ_DEF , NULL	, NULL , NULL , NULL },
	{"NewZealand" 	  ,  C_NZ, DEV_PROFILE_BuckBoost, AC_FXS_RF50_NZ		, DC_FXS_DEF, RING_25HZ_DEF , NULL	, NULL , NULL , NULL },
	{"Norway"     	  ,  C_NO, DEV_PROFILE_BuckBoost, AC_FXS_RF50_NO 		, DC_FXS_DEF, RING_25HZ_DEF , NULL	, NULL , NULL , NULL },
	{"Poland"   	  ,  C_PL, DEV_PROFILE_BuckBoost, AC_FXS_RF50_600R_DEF		, DC_FXS_DEF, RING_25HZ_DEF , NULL	, NULL , NULL , NULL },
	{"Portugal"   	  ,  C_PT, DEV_PROFILE_BuckBoost, AC_FXS_RF50_PT 		, DC_FXS_DEF, RING_25HZ_DEF , NULL	, NULL , NULL , NULL },
	{"Slovenia"   	  ,  C_SI, DEV_PROFILE_BuckBoost, AC_FXS_RF50_600R_DEF  , DC_FXS_DEF, RING_25HZ_DEF , NULL	, NULL , NULL , NULL },
	{"Taiwan"     	  ,  C_TW, DEV_PROFILE_BuckBoost, AC_FXS_RF50_600R_DEF	, DC_FXS_DEF, RING_TW  		, NULL	, NULL , NULL , NULL },
	{"Spain"     	  ,  C_ES, DEV_PROFILE_BuckBoost, AC_FXS_RF50_ES 		, DC_FXS_DEF, RING_25HZ_DEF , NULL	, NULL , NULL , NULL },
	{"SWE-Sweden"     ,  C_SE, DEV_PROFILE_BuckBoost, AC_FXS_RF50_SE 		, DC_FXS_DEF, RING_25HZ_DEF , NULL	, NULL , NULL , NULL },
	{"GBR-Great Britain" ,  C_GB, DEV_PROFILE_BuckBoost, AC_FXS_RF50_GB 	, DC_FXS_DEF, RING_25HZ_DEF , NULL	, NULL , NULL , NULL },
	{"USA-United States" ,  C_US, DEV_PROFILE_BuckBoost, AC_FXS_RF50_600R_DEF, DC_FXS_DEF, RING_US  	, NULL  , NULL , NULL , NULL },
	{"S.Africa"   	  ,  C_ZA, DEV_PROFILE_BuckBoost, AC_FXS_RF50_600R_DEF	, DC_FXS_DEF, RING_25HZ_DEF , NULL	, NULL , NULL , NULL },
	{"Vietnam"	 ,C_VN, DEV_PROFILE_BuckBoost, AC_FXS_RF50_600R_DEF, DC_FXS_DEF, RING_US  	, NULL  , NULL , NULL , NULL },
	{"RSV1"			  ,C_RSV1, DEV_PROFILE_BuckBoost, AC_FXS_RF50_600R_DEF	, DC_FXS_DEF, RING_25HZ_DEF , NULL	, NULL , NULL , NULL },
	{"RSV2"			  ,C_RSV2, DEV_PROFILE_BuckBoost, AC_FXS_RF50_600R_DEF	, DC_FXS_DEF, RING_25HZ_DEF , NULL	, NULL , NULL , NULL },
	{"RSV3"			  ,C_RSV3, DEV_PROFILE_BuckBoost, AC_FXS_RF50_600R_DEF	, DC_FXS_DEF, RING_25HZ_DEF , NULL	, NULL , NULL , NULL }
...
*
*******************************************************************************/
void le89116_slicParamReset_1(int idx){
	/*====== decide profile according to Country code =====*/
	/*Reset by default table*/
	DEVICE_PRO_1 = DEV_PROFILE_BuckBoost;
	AC_PRO_FXS_1 = AC_FXS_RF50_600R_DEF;
	DC_PRO_FXS_1 = DC_FXS_DEF;
	RINGING_PRO_FXS_1 = RING_25HZ_DEF;
	AC_PRO_FXO_1 = VP_PTABLE_NULL;
	CONFIG_PRO_FXO_1 = VP_PTABLE_NULL;
	CALL_ID_PRO_1 = VP_PTABLE_NULL;

	if((idx >= C_DEF) && (idx < C_NUM)){
		DEVICE_PRO_1 = le89116_country_mapping_1[idx].pDevice;
		AC_PRO_FXS_1 = le89116_country_mapping_1[idx].pAcFXS;
		DC_PRO_FXS_1 = le89116_country_mapping_1[idx].pDcFXS;
		RINGING_PRO_FXS_1 = le89116_country_mapping_1[idx].pRingingFXS;
		AC_PRO_FXO_1 = le89116_country_mapping_1[idx].pAcFXO;
		CONFIG_PRO_FXO_1 = le89116_country_mapping_1[idx].pConfigFXO;
		CALL_ID_PRO_1 = le89116_country_mapping_1[idx].pCallID;
		SLIC_DBG_MSG(_SLIC_DBG_TYPE_INFO, "%s Successful(CountryCode=%s)\n",__func__,\
				le89116_country_mapping_1[idx].name);
	}
	else{
...
static int testCheck_read_proc(char *page, char **start, off_t off,
	...
	int len = 0;
	//VpSetLineState(&(lineCtx_ptr_1[FXO_LINE]),VP_LINE_FXO_LOOP_OPEN);
 ...
 */
int le89116_1_paramReset(char* buf){
//	int country = *(int *)buf;
	return _TDI_SUCCESS;
}

/*_____________________________________________________________________________
 **      function name: le89116_1_deviceVerify
 **      descriptions:
 **            driver verify
 **      parameters:
 **				void
...
int le89116_1_deviceVerify(char* buf){
	...
	SLIC_DBG_MSG(_SLIC_DBG_TYPE_INFO, "le89116_1_deviceVerify\n"); 

    /*
     * Create the device object and device context
     */
	if (VP_STATUS_SUCCESS != VpMakeDeviceObject(VP_DEV_890_SERIES, devInfo->deviceNum, &devCtx_ptr_1, &devObj_ptr_1)) {
		SLIC_DBG_MSG(_SLIC_DBG_TYPE_ERROR, "Error returned from VpMakeDeviceObject!\n");
       	return _TDI_FAIL;
	}
	...
	devInfo->deviceNum += 1;
	devInfo->fxsNum += LE89116_1_FXS_NUM;
	devInfo->fxoNum += LE89116_1_FXO_NUM;
	devInfo->pcm1ChNum += LE89116_1_FXS_NUM+LE89116_1_FXO_NUM;
	devInfo->pcm2ChNum += 0;
	return _TDI_SUCCESS;
}

/*_____________________________________________________________________________
 **      function name: le89116_1_deviceInit
 **      descriptions:
 **            driver init
 **      parameters:
 **				void
 ...
 **____________________________________________________________________________
 */
int le89116_1_deviceInit(char* buf){
	int                  devCnt;
    //int                  lineCnt;
    VpStatusType          status;
	...
	le89116_1_Line_Cal_Cmp	 = _TDI_FALSE;
	le89116_1_FXS_Init_Cmp = _TDI_FALSE;
	
	atomic_set(&le89116_1_init_ongoing,1);
    ...
    //for (devCnt = 0; devCnt < _TDI_FXS_NUM; devCnt++) {
        ...
        if (VP_STATUS_SUCCESS != VpMakeDeviceObject(VP_DEV_890_SERIES,
        		devCnt, &devCtx_ptr_1, &devObj_ptr_1)) {
        	dbg_printf("%s:%d Error returned from VpMakeDeviceObject!\n",__FILE__, __LINE__);
			atomic_set(&le89116_1_init_ongoing,0);
            return _TDI_FAIL;
        }
		/*
		...
		if (VP_STATUS_SUCCESS != VpMakeLineObject(VP_TERM_FXS_GENERIC, 0,
				&lineCtx_ptr_1, &lineObj_ptr_1, &devCtx_ptr_1)) {
			dbg_printf("%s:%d Error returned from VpMakeLineObject!\n",
					__FILE__, __LINE__);
			atomic_set(&le89116_1_init_ongoing,0);
            return _TDI_FAIL;
		}
		...
		le89116_slicParamReset_1(pinitSetting->hwProfId);
		status = VpInitDevice(&devCtx_ptr_1, DEVICE_PRO_1, AC_PRO_FXS_1, DC_PRO_FXS_1, RINGING_PRO_FXS_1, VP_PTABLE_NULL, VP_PTABLE_NULL);
		if (VP_STATUS_SUCCESS != status) {
			dbg_printf("%s: %d Device Did Not Init Properly %d - (dev:%d)\n",
					__FILE__, __LINE__, status,devCnt);
			atomic_set(&le89116_1_init_ongoing,0);
			return _TDI_FAIL;
		}
	    while (le89116_1_FXS_Init_Cmp != TRUE) {
	    	event_printf(">>1.5\n");
	        /*
	         * Wait for event indicating that the initialization is complete
	         */
			mdelay(10); /*SERENA_MODIFY*/
			le89116_1_eventProcess((char *)&devCnt);  /* Only run for one line per device */
	    }
		...
		if(pinitSetting->slicCodecOption == CODEC_LINEAR){
			...
			if (VP_STATUS_SUCCESS != VpSetOption(VP_NULL, &devCtx_ptr_1,
        ...
        //VpSetOption(VP_NULL, &devCtx_ptr_1, VP_OPTION_ID_PULSE_MODE, &pulseMode);
        /*
	...
	eventMask.process &= ~(VP_LINE_EVID_SIGNAL_CMP);
		...
		VpSetOption(&lineCtx_ptr_1, VP_NULL, VP_OPTION_ID_TIMESLOT,
			&timeSlots);

		//VpSetLineState(&lineCtx_ptr_1, VP_LINE_ACTIVE);/*for COC by jq.zhu , OSBNB00030567, 20130327*/

		/*
		 * Adjust Tx/Rx relative gain levels.
		 */
		event_printf("gain--TX :%x RX: %x \n",pinitSetting->speakSlicVal, pinitSetting->listenSlicVal);
		VpSetRelGain(&lineCtx_ptr_1,pinitSetting->speakSlicVal, pinitSetting->listenSlicVal, 0);

		/*
		 * Calibrate Lines
		 */
		/*le89116_1_Line_Cal_Cmp = FALSE;
		VpCalLine(&lineCtx_ptr_1);
		while (le89116_1_Line_Cal_Cmp != TRUE) {
			 * Wait for event indicating that calibration is complete
			mdelay(10);
			le89116_1_eventProcess((char *)&devCnt);
		}*/
        event_printf(">>5\n");
        /*
         * Init the hook state for each FXS channel
         */
        le89116_1_immediateHookState = TIC_IMMEDIATE_ONHOOK;
        atomic_set(&le89116_1_init_ongoing,0);
    //}
    return _TDI_SUCCESS;
}
...
int le89116_1_shutdownHw(char* buf){
    int    lineCnt;
	if(atomic_read(&le89116_1_init_ongoing))
	{
			return _TDI_FAIL;
	}
    event_printf("%s",__func__);
     ...
     * Power down line
     */
    VpSetLineState(&lineCtx_ptr_1, VP_LINE_DISCONNECT);
    /*
     * Free the memory
     */
    VpFreeLineCtx(&lineCtx_ptr_1);
	
    return _TDI_SUCCESS;
}
/*_____________________________________________________________________________
 **      function name: le89116_1_fxsSetLineState
 **      descriptions:
 **            set ring state
 **      parameters:
 **				void
...
int le89116_1_fxsSetLineState(char* buf){
   ...
   event_printf("---ch:%d status: %d \n",plineInfo->chan,stateType);
    VpSetLineState(&lineCtx_ptr_1,stateType);
    return _TDI_SUCCESS;
}

/*_____________________________________________________________________________
 **      function name: le89116_1_fxsGetLineState
 **      descriptions:
 **            set ring state
 **      parameters:
 **				void
...
int le89116_1_fxsGetLineState(char* buf){
    ...
    event_printf("%s",__func__);
    VpGetLineState(&lineCtx_ptr_1, &state);
...
/*_____________________________________________________________________________
 **      function name: le89116_1_fxsGetBatteryPol
 **      descriptions:
 **            set ring state
 **      parameters:
 **				void
...
int le89116_1_fxsGetBatteryPol(char* buf){
    ...
    event_printf("%s",__func__);
    status = VpGetLineState(&lineCtx_ptr_1, &polarity);
    if (VP_STATUS_SUCCESS != status) {
...
/*_____________________________________________________________________________
 **      function name: le89116_1_fxsSetBatteryPol
 **      descriptions:
...
int le89116_1_fxsSetBatteryPol(char* buf){
    ...
    event_printf("%s",__func__);
    getStatus = VpGetLineState(&lineCtx_ptr_1, &curState);
    ...
    switch (curState) {
        ...
        case VP_LINE_ACTIVE_POLREV:
            if (TIC_BATT_POL_FORWARD == pBatteryPolInfo->polarity) {
                setStatus = VpSetLineState(&lineCtx_ptr_1, VP_LINE_ACTIVE);
            }
            else {
                setStatus = VpSetLineState(&lineCtx_ptr_1,
        ...
        case VP_LINE_OHT_POLREV:
            if (TIC_BATT_POL_FORWARD == pBatteryPolInfo->polarity) {
                setStatus = VpSetLineState(&lineCtx_ptr_1, VP_LINE_OHT);
            }
            else {
                setStatus = VpSetLineState(&lineCtx_ptr_1,
                        VP_LINE_OHT_POLREV);
        ...
        case VP_LINE_STANDBY_POLREV:
            if (TIC_BATT_POL_FORWARD == pBatteryPolInfo->polarity) {
                setStatus = VpSetLineState(&lineCtx_ptr_1, VP_LINE_STANDBY);
            }
            else {
                setStatus = VpSetLineState(&lineCtx_ptr_1,
        ...
        case VP_LINE_RINGING_POLREV:
            if (TIC_BATT_POL_FORWARD == pBatteryPolInfo->polarity) {
                setStatus = VpSetLineState(&lineCtx_ptr_1, VP_LINE_RINGING);
            }
            else {
                setStatus = VpSetLineState(&lineCtx_ptr_1,
        ...
        default:
            if (TIC_BATT_POL_FORWARD == pBatteryPolInfo->polarity) {
                setStatus = VpSetLineState(&lineCtx_ptr_1, VP_LINE_TALK);
            }
            else {
                setStatus = VpSetLineState(&lineCtx_ptr_1,
                        VP_LINE_TALK_POLREV);
...
/*_____________________________________________________________________________
 **      function name: le89116_1_fxsGetHookState
 **      descriptions:
 **            get hook polarity
 **      parameters:
 **				void
...
int le89116_1_fxsGetHookState(char* buf){
	...
	event_printf("%s",__func__);
	pHookStat->hookStat = le89116_1_immediateHookState;
	return _TDI_SUCCESS;
}

/*_____________________________________________________________________________
 **      function name: le89116_1_ringState
 **      descriptions:
 **            get ring state
 **      parameters:
 **				void
...
int le89116_1_fxsSetGainLv(char* buf){
	...
	if(atomic_read(&le89116_1_init_ongoing))
		return _TDI_FAIL;
	VpSetRelGain(&lineCtx_ptr_1,gainSetting->speakSlicVal,gainSetting->listenSlicVal, 0);
	dbg_printf("%s %x/%x \n",__func__,gainSetting->speakSlicVal,gainSetting->listenSlicVal);
	return _TDI_SUCCESS;
}
int le89116_1_fxsGetGain(char* buf){
	if(atomic_read(&le89116_1_init_ongoing))
		return _TDI_FAIL;
	event_printf("%s",__func__);
	return _TDI_SUCCESS;
...
int le89116_1_eventProcess(char* buf){
            ...
            if (VP_EVCAT_RESPONSE == legerityEventObj.eventCategory) {
                ...
                switch (legerityEventObj.eventId) {
                    case VP_LINE_EVID_HOOK_OFF:
                    	...
                    	le89116_1_immediateHookState = TIC_IMMEDIATE_OFFHOOK;
                        break;
...
// 						VpSetLineState(lineCtx_ptr_1[lineCnt], VP_LINE_TALK);
// 						if(pEvent->eventData <= 5){
// 							VpSetLineTone(lineCtx_ptr_1[lineCnt], tonePtrs[]);
// 						}
// 						break;
                    default:
                        /* Do nothing */
	...
	if (_TDI_VP890_SIGREG_LIU & mpiData ) {     //off-hook state
		if (le89116_1_immediateHookState != TIC_IMMEDIATE_OFFHOOK) {
			le89116_1_immediateHookState  = TIC_IMMEDIATE_OFFHOOK;
		}
		else { }
	} else {                                    // on-hook state
		if (le89116_1_immediateHookState != TIC_IMMEDIATE_ONHOOK) {
			le89116_1_immediateHookState  = TIC_IMMEDIATE_ONHOOK;
		}
	}*/
...
int le89116_1_dumpregister(char* buf){
	...
	Vp890DeviceObjectType *pDevObj = devCtx_ptr_1.pDevObj;
...
#define VP890_DEVICE_REGISTER_COUNT    18
	...
	print_buffer_len+=sprintf(print_buffer+print_buffer_len,"LE89156Device_1:");
	ecVal = pDevObj->ecVal;
...
//Roger_lt
int le89116_1_LtTestStart(char* buf) {
	if(atomic_read(&le89116_1_init_ongoing))
		return _TDI_FAIL;
	return LtTestStart(&lineCtx_ptr_1,&devCtx_ptr_1,buf);
}


int* le89116_1_getLtTestResult(void)
{
	if(atomic_read(&le89116_1_init_ongoing))
		return _TDI_FAIL;
...
int le89116_1_SetLoopback(char *buf)
{
	...
	if(atomic_read(&le89116_1_init_ongoing))	//dyma_20140218
		return _TDI_FAIL;
	if(loopbackSetting->chan >= LE89116_1_FXS_NUM)
		return _TDI_FAIL;
	...
	if (VP_STATUS_SUCCESS != VpSetOption(&lineCtx_ptr_1, VP_NULL, VP_OPTION_ID_LOOPBACK, &loopBack)) {
...
int le89116_1_SetRingParam(char* buf)
{
	...
	if(0 == ringParams->type){
		ret = VpConfigLine(&(lineCtx_ptr_1), VP_NULL, VP_NULL, RINGING_PRO_FXS_1);
	}
	else if(1 == ringParams->type){
		ret = VpConfigLine(&(lineCtx_ptr_1), VP_NULL, VP_NULL, RING_25HZ_VE890_IB100V_TRAP);
	}
	else{
		return _TDI_FAIL;
	}
	...
	ret = VpSetOption(&(lineCtx_ptr_1), VP_NULL, VP_OPTION_ID_RINGING_PARAMS, &vpParams);
	if(ret != VP_STATUS_SUCCESS){
		SLIC_DBG_MSG(_SLIC_DBG_TYPE_ERROR, "ERROR ret:%d\n", ret);
		return _TDI_FAIL;
	}
...
int le89116_1_SetDcFeedParam(char* buf)
{
	...
	ret = VpSetOption(&(lineCtx_ptr_1), VP_NULL, VP_OPTION_ID_DCFEED_PARAMS, &vpParams);
	if(ret != VP_STATUS_SUCCESS){
		SLIC_DBG_MSG(_SLIC_DBG_TYPE_ERROR, "ERROR ret:%d\n", ret);
		return _TDI_FAIL;
	}
