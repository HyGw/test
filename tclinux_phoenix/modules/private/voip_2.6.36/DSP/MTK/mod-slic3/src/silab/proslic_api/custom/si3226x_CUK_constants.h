...
** 2016-01-14 23:55:04
**
** Si3226x ProSLIC API Configuration Tool Version 4.0.3
...
enum {
	...
	SI3226X_RING_PROFILE_TOTAL_NUM  //PROSLIC_PORTING
};
...
enum {
	...
	SI3226X_IMP_PROFILE_TOTAL_NUM  //PROSLIC_PORTING_20131025
};
