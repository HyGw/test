 ...
 *
 * $Revision: 10934 $
 * $LastChangedDate: 2013-04-09 18:20:31 -0500 (Tue, 09 Apr 2013) $
 */
    ...
    Vp886TestHeapType *pTestHeap)
{
    ...
    switch (pTestHeap->nextState) {
        ...
        case RES_FLT_DEBOUNCE_HOOK_GKEY: {
            ...
            if (Vp886AddTimerMs(NULL, pLineCtx, VP886_TIMERID_LINE_TEST, debounce, 0, RES_FLT_CHECK_HOOK_GKEY) == FALSE) {
                Vp886PushTestEvent(pLineCtx, VP_TEST_STATUS_RESOURCE_NA);
        ...
        case RES_FLT_LG_GET_MEASUREMENT: {
            ...
            if (VpResStoreMeasurementLG(pLineCtx, pTestHeap, pTestHeap->adcState, &adcAverage) == FALSE) {
            ...
            if (VpResNeedMoreSettlingTimeLG(pLineCtx, pTestHeap, adcAverage, pTestHeap->adcState) == TRUE) {
