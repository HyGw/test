...
/**
 *	@brief returns the csema_t struct size
 */
LINK_SYSS unsigned SEMA_Size(void);

typedef struct csema csema_t;

/**
 *	@brief semaphore initialization function
 *  @initial_count : the amount of resource that can be used using SEMA_Get
 */
LINK_SYSS exc_t SEMA_Init(csema_t* o, char* name, unsigned initial_count);

/**
 *	@brief semaphore destroy function
 */
LINK_SYSS exc_t SEMA_Dest(csema_t* o);

/**
 *	@brief semaphore acquire function
 */
LINK_SYSS exc_t SEMA_Get(csema_t* o, cwait_t wait);

/**
 *	@brief semaphore release function
 */
LINK_SYSS exc_t SEMA_Put(csema_t* o);

/**
 *	@brief semaphore value function 
 *  @return the amount of resource left
 */
LINK_SYSS unsigned SEMA_Value(csema_t* o);

/**
 *	@brief semaphore control function
 */
LINK_SYSS exc_t SEMA_Ctrl(csema_t* o, int req, ...);
