 ...
 *	@include Makefile
 */
#ifndef LINK_BASE_DEF
#define LINK_BASE_DEF

#if defined (WIN32)
#define snprintf    _snprintf
#endif

#if defined (WIN32) && defined (BASE_EXPORTS)
#define LINK_BASE __declspec(dllexport)
#elif defined (WIN32) && defined (BASE_IMPORTS)
#define LINK_BASE __declspec(dllimport)
#else
#define LINK_BASE
#endif
