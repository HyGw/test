 ...
 *	Author: PTChen
 *	 
 *	Last Revision Date: 2012.8.8
 *	 
 *	Description:
 *	MTK DSP generic Constant and Enumeration
 *	
 *
 */
...
#define	DSP_MAX_CHAN				4   /*upgrade_to_4_channel*/
#define DSP_MAX_STRM_PER_CHAN		2

#define	DSP_MAX_SESSION				(DSP_MAX_CHAN<<1)
