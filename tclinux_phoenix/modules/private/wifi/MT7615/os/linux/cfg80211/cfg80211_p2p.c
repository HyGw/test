	...
	PVOID SystemSpecific2, PVOID SystemSpecific3)
{
	...
	MTWF_LOG(DBG_CAT_P2P, DBG_SUBCAT_ALL, DBG_LVL_INFO, ("CFG80211_ROC: RemainOnChannelTimeout\n"));
...
#define RESTORE_COM_CH_TIME 100
            	...
            	(pAd->LatchRfRegs.Channel != pApCliEntry->MlmeAux.Channel))
	{
		...
		MTWF_LOG(DBG_CAT_P2P, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("CFG80211_ROC: ROC_Timeout APCLI_ON Channel: %d\n",
		...
		MTWF_LOG(DBG_CAT_P2P, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("CFG80211_NULL: P2P_CLI PWR_ACTIVE ROC_END\n"));
	...
	{
		MTWF_LOG(DBG_CAT_P2P, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("CFG80211_ROC: ROC_Timeout INFRA_ON Channel: %d\n",
...
//		ch = pAd->StaCfg[0].wdev.CentralChannel;
		pAd->CommonCfg.Channel = pAd->StaCfg[0].wdev.channel;
		pAd->CommonCfg.CentralChannel = pAd->StaCfg[0].wdev.CentralChannel;
	}
	else
	{
		HcBbpSetBwByChannel(pAd, BW_20,pAd->StaCfg[0].wdev.channel);
		AsicSwitchChannel(pAd, pAd->StaCfg[0].wdev.channel, FALSE);
	       AsicLockChannel(pAd, pAd->StaCfg[0].wdev.channel);
//		ch = pAd->StaCfg[0].wdev.channel;	
		pAd->CommonCfg.Channel = pAd->StaCfg[0].wdev.channel;
...
/* CFG TODO: move to cfg802_util */
		...
		MTWF_LOG(DBG_CAT_P2P, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("CFG80211_ROC: RemainOnChannelTimeout -- FINISH\n"));
	}
...
BOOLEAN CFG80211DRV_OpsRemainOnChannel(VOID *pAdOrg, VOID *pData, UINT32 duration)
{
	...
	{
        MTWF_LOG(DBG_CAT_P2P, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("CFG80211_NULL: APCLI PWR_SAVE ROC_START\n"));
	...
	{
    	MTWF_LOG(DBG_CAT_P2P, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("CFG80211_NULL: STA PWR_SAVE ROC_START\n"));
	...
	{
		MTWF_LOG(DBG_CAT_P2P, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("CFG80211_PKT: ROC CHANNEL_LOCK %d\n", pChanInfo->ChanId));
	...
	{
		MTWF_LOG(DBG_CAT_P2P, DBG_SUBCAT_ALL, DBG_LVL_INFO, ("80211> ComCH == ROC_CH \n"));
	}
...
/* CFG TODO: move to cfg802_util */
	...
	{
		MTWF_LOG(DBG_CAT_P2P, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("CFG80211_ROC : CANCEL Cfg80211RocTimer\n"));
...
BOOLEAN CFG80211DRV_OpsCancelRemainOnChannel(VOID *pAdOrg, UINT32 cookie)
{
	...
	{
		MTWF_LOG(DBG_CAT_P2P, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("CFG_ROC : CANCEL Cfg80211RocTimer\n"));
...
INT CFG80211_setPowerMgmt(VOID *pAdCB, UINT Enable)
{
	...
	MTWF_LOG(DBG_CAT_P2P, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("@@@ %s: %d\n", __FUNCTION__, Enable));
...
VOID CFG80211DRV_P2pClientKeyAdd(VOID *pAdOrg, VOID *pData)
{
	...
	CMD_RTPRIV_IOCTL_80211_KEY *pKeyInfo;
    	...
    	MTWF_LOG(DBG_CAT_P2P, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("CFG Debug: CFG80211DRV_P2pClientKeyAdd\n"));
...
BOOLEAN CFG80211DRV_P2pClientConnect(VOID *pAdOrg, VOID *pData)
{
	...
	MTWF_LOG(DBG_CAT_P2P, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("APCLI Connection onGoing.....\n"));
...
VOID CFG80211_LostP2pGoInform(VOID *pAdCB)
{
	...
	MTWF_LOG(DBG_CAT_P2P, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("80211> CFG80211_LostGoInform ==> \n"));
