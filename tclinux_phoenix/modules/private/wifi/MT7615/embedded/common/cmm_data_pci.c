...
__IMEM PNDIS_PACKET GetPacketFromRxRing(
	IN RTMP_ADAPTER *pAd,
	OUT RX_BLK **_pRxBlk,
...
__IMEM BOOLEAN RxRing1DoneInterruptHandle(RTMP_ADAPTER *pAd)
{
...
#endif /* MANUAL_MU */
__IMEM INT CutThroughPktTx(RTMP_ADAPTER *pAd, TX_BLK *pTxBlk)
{
	USHORT freeCnt = 1;
	QUEUE_ENTRY *pQEntry;
...
__IMEM VOID FastPathDequeBh(ULONG Param)
{
