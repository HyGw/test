...
INT SetMuStaParamProc(RTMP_ADAPTER *pAd, RTMP_STRING *arg)
{
    ...
    param.gid[0] = simple_strtol(pLowGidUserMemberStatus, 0, 16);
    param.gid[1] = simple_strtol(pHighGidUserMemberStatus, 0, 16);
    param.up[0] = simple_strtol(pLowGidUserPosition0, 0, 16);
    param.up[1] = simple_strtol(pLowGidUserPosition1, 0, 16);
    param.up[2] = simple_strtol(pHighGidUserPosition0, 0, 16);
    param.up[3] = simple_strtol(pHighGidUserPosition1, 0, 16);
