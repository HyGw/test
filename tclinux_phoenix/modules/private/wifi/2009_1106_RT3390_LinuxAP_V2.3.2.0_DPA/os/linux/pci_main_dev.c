...
//
//Patch for RT3090, merge from 2.5.0.0. Chih Huang, 20101210.
#ifdef RT30xx
#ifndef TC_SOC
...
#if defined(TC_SOC) && defined(RT30xx)
...
#ifdef TC_SOC		
			/*Reset PCI_E patch for 3090,and this patch is merge from 2.5.0.0.
				shnwind_add 20101210.*/
			//printk("!!!!!!PCI-E reset!!!!!!!!!!!\n");
			pcieReset();
    			pcieRegInitConfig();
 ...
 ***************************************************************************/
 static VOID RTMPInitPCIeDevice(
    ...
    IN PRTMP_ADAPTER     pAd)
{
	USHORT  device_id, subDev_id, subVendor_id;
	POS_COOKIE pObj;
