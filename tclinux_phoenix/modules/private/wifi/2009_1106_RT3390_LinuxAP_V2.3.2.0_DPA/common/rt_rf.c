...
#ifdef RT33xx
#ifdef RT3390
	if (IS_RT3390(pAd) && (pAd->infType == RTMP_DEV_INF_PCI||pAd->infType == RTMP_DEV_INF_PCIE))
	{
			pChipOps->pRFRegTable = RT33xx_RFRegTable;
...
#endif // RT30xx //
	DBGPRINT_RAW(RT_DEBUG_ERROR, ("Hook callback function fail\n"));
