/* $Id: //BBN_Linux/Branch/Branch_for_Rel_CMCC_7526_20161014/tclinux_phoenix/modules/private/wifi/2009_1106_RT3390_LinuxAP_V2.3.2.0_DPA/miniupnpd/upnpevents.c#1 $ */
/* MiniUPnP project
...
void
upnp_event_var_change_notify(enum subscriber_service_enum service)// shiang : send to all
{
	struct subscriber * sub;
