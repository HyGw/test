/* $Id: //BBN_Linux/Branch/Branch_for_Rel_CMCC_7526_20161014/tclinux_phoenix/modules/private/wifi/2009_1106_RT3390_LinuxAP_V2.3.2.0_DPA/miniupnpd/upnpdescgen.c#1 $ */
/* MiniUPnP project
...
static const struct stateVar WSCVars[] =
{
	...
	{"WLANEvent", 5|0x80, 0, 0, 252},    /* Conditional */
	{"STASettings", 5, 0, 0, 0},    /* Conditional */
	{"APStatus", 4|0x80, 0, 0, 252},  /* Conditional */
	{"STAStatus", 4|0x80, 0, 0, 252},    /* Conditional */
		...
		if(v->itype & 0x80) {
			...
			switch(v->ieventvalue) {
				case 0:
					break;
#ifdef ENABLE_WSC_SERVICE
				case 252:	/* Default WSC service magical value */
