...
#if defined(WSC_INCLUDED) || defined(DOT11R_FT_SUPPORT) || defined(DOT11Z_TDLS_SUPPORT)
#define SHA256_SUPPORT
#endif // defined(WSC_INCLUDED) || defined(DOT11R_FT_SUPPORT) || defined(DOT11Z_TDLS_SUPPORT) //
