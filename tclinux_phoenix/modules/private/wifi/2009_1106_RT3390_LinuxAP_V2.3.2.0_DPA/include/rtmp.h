...
typedef struct _MLME_STRUCT {
	...
	UCHAR CaliBW40RfR24;
	UCHAR CaliBW20RfR24;
	UCHAR CaliBW40RfR31;    // RT3370 / RT3390 use it
	UCHAR CaliBW20RfR31;    // RT3370 / RT3390 use it
#endif // RT30xx //
...
#if defined(BIN_IN_FILE	) || defined(CONFIG_STA_SUPPORT)
	ULONG				FirmwareVersion;        // byte 0: Minor version, byte 1: Major version, otherwise unused.
#endif // defined(BIN_IN_FILE	) || defined(CONFIG_STA_SUPPORT) //	
...
#define TIME_ONE_SECOND		(1000000/TIME_BASE)
 ...
 //   UCHAR                   Wsc_Uuid_Str[UUID_LEN_STR];
	...
	UCHAR		EEPROMImage[MAX_EEPROM_BIN_FILE_SIZE];
	...
	RALINK_TIMER_STRUCT     pollingModeTimer;
...
/***************************************************************************
  ...
  **************************************************************************/
#if defined(MAT_SUPPORT) || defined(IGMP_SNOOP_SUPPORT)
...
#endif // #if defined(MAT_SUPPORT) || defined(IGMP_SNOOP_SUPPORT)
...
VOID  WPSLedPeriodicExec(
	...
	IN PVOID SystemSpecific2, 
	IN PVOID SystemSpecific3);
VOID wpsLedChk(PRTMP_ADAPTER	pAd);
#endif
#endif  // __RTMP_H__
