...
#define DEF_QUICK_RA_TIME_INTERVAL 50
#ifdef SNMP_SUPPORT
// for snmp 
...
#define TX_RING_SIZE            20 //64
#define MGMT_RING_SIZE          20 //128
#define RX_RING_SIZE           32 //128 //64
#else
#ifdef TC_SOC
/*ring size is the same with Linos. shnwind 20100105*/
#define TX_RING_SIZE            20
...
#ifdef TC_SOC
#define RX_BUFFER_AGGRESIZE     (SKB_WITH_OVERHEAD(2048) - NET_SKB_PAD)
#define RX_BUFFER_NORMSIZE      (SKB_WITH_OVERHEAD(2048) - NET_SKB_PAD)
#else
...
#ifdef TC_SOC
#define MAX_AGGREGATION_SIZE 	RX_BUFFER_AGGRESIZE
#else
