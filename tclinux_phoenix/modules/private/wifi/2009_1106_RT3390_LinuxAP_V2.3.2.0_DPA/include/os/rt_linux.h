...
#define AP_DRIVER_VERSION			"2.3.2.17"
...
#if defined(TCSUPPORT_CT) && defined(CONFIG_MIPS_TC3182)
...
#if defined(BB_SOC) && defined(BB_PCIE_ADDR_SWAP)
#define RTMP_IO_READ8(_A, _R, _pV)                                                              \
{		\
	ULONG Val;                \
	UCHAR _i; \
...
#if defined(BRCM_6358) || defined(RALINK_2880) || defined(RALINK_3052) || defined(RALINK_2883) || defined(BB_PCIE_ADDR_SWAP)
#define RTMP_IO_WRITE8(_A, _R, _V)            \
{                    \
	ULONG Val;                \
	UCHAR _i;                \
...
#endif /*TCSUPPORT_CT && CONFIG_MIPS_TC3182*/
