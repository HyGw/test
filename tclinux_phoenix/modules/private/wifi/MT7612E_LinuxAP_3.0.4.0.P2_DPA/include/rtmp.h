...
/*==================================================== */
	...
	ULONG McsTotalTxCount;
	ULONG McsLowRateTxCount;
	ULONG McsTotalRxCount;
	ULONG McsLowRateRxCount;
	CHAR PerEntryAvgRssi;
	LONG PerEntryTotalRssi;
	LONG RssiCount;
	LONG AvgRssi;
...
#ifdef RATE_PRIOR_SUPPORT
INT Set_RatePrior_Proc(RTMP_ADAPTER *pAd, PSTRING *arg);
INT Set_BlackListTimeout_Proc(RTMP_ADAPTER *pAd, PSTRING *arg);
INT Set_LowRateRatio_Proc(RTMP_ADAPTER *pAd, PSTRING *arg);
INT Set_LowRateCountPeriod_Proc(RTMP_ADAPTER *pAd, PSTRING *arg);
INT Set_TotalCntThreshold_Proc(RTMP_ADAPTER *pAd, PSTRING *arg);
#endif /*RATE_PRIOR_SUPPORT*/
