...
#else
#ifdef BB_SOC
#define SINGLE_SKU_TABLE_FILE_NAME	"/etc/Wireless/RT2860AP_AC/SingleSKU.dat"
#else
 ...
 ***********************************************************************************/
	...
	extern int (*wifi_bandwidth_hook_tx)(VOID *skb);
	extern int	 (*wifi_bandwidth_hook_rx)(unsigned char* srcMac, int length);
#endif
