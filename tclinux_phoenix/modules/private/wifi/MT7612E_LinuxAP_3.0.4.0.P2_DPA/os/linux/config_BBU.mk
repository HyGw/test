...
HAS_RADIOTAP_IN_DATA_SUPPORT=n
...
WFLAGS := -DAGGREGATION_SUPPORT -DPIGGYBACK_SUPPORT -DWMM_SUPPORT  -DLINUX -Wall -Wstrict-prototypes -Wno-trigraphs -DENHANCED_STAT_DISPLAY
...
ifeq ($(HAS_DMA_BUSY_RESET),y)
WFLAGS += -DDMA_BUSY_RESET
endif
...
ifeq ($(RT28xx_MODE),AP)
WFLAGS += -DCONFIG_AP_SUPPORT  -DUAPSD_SUPPORT -DUAPSD_SP_ACCURATE -DMBSS_SUPPORT -DIAPP_SUPPORT -DAP_SCAN_SUPPORT -DSCAN_SUPPORT
WFLAGS += -DDBG
...
ifneq ($(findstring $(RT28xx_MODE),AP),)
WFLAGS += -DDROP_MASK_SUPPORT -DMULTI_CLIENT_SUPPORT
endif
