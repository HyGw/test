...
ifeq ($(CHIPSET),5370)
WFLAGS +=-DRTMP_MAC_USB -DRT30xx -DRT33xx -DRT3070 -DRT3370 -DRT53xx -DRT5370 -DRTMP_USB_SUPPORT -DRTMP_TIMER_TASK_SUPPORT -DRTMP_RF_RW_SUPPORT -DRTMP_EFUSE_SUPPORT -DRTMP_INTERNAL_TX_ALC -DhSPECIFIC_BCN_BUF_SUPPORT -DRTMP_FREQ_CALIBRATION_SUPPORT -DIQ_CAL_SUPPORT
CHIPSET_DAT = 2870
endif
...
ifeq ($(PLATFORM),TC3162U)
WFLAGS += -DRT_BIG_ENDIAN -DTC_SOC -DMULTI_CORE_SUPPORT
endif
