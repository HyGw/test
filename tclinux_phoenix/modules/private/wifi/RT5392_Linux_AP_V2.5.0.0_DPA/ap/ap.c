...
#if 1 //disable INT until AP is ready //donny 20140823
	RTMP_IRQ_ENABLE(pAd);
#endif
...
#if 1 //disable INT until AP is ready by donny 20140823
	...
	IN PRTMP_ADAPTER pAd)
{
	...
	for (i = 1; i < MAX_LEN_OF_MAC_TABLE; i++) 
	{
		...
		{
			DBGPRINT(RT_DEBUG_TRACE, ("%s - NoDataIdleCount = %d, AssocDeadLine = %d\n", __FUNCTION__, pEntry->NoDataIdleCount, pEntry->AssocDeadLine));
