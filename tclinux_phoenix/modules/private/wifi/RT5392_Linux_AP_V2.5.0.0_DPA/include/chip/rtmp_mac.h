...
#ifdef RT53xx
	UINT32		rsv3:1;
	UINT32		TXRPT:1; // Tx report tag (1: TX_REPORT_CNT increases by one; 0: Do nothing)
	UINT32		rsv1:4;
#else
	UINT32		rsv:6;
#endif // RT53xx //
...
typedef	struct	GNU_PACKED _RXWI_STRUC {
	...
	// Word 3
	/*UINT32		rsv2:16;*/
#if defined(RT2883) || defined(RT3883) || defined(RT3593)||defined(RT5390)
	UINT32		FOFFSET:8;
	UINT32		SNR2:8;
#else
	UINT32		rsv2:8;	
	UINT32		FOFFSET:8;	// RT35xx	
#endif // defined(RT2883) || defined(RT3883) || defined(RT3593)  || defined(RT53xx)//
	UINT32		SNR1:8;
	UINT32		SNR0:8;
...
typedef	struct	GNU_PACKED _RXWI_STRUC {
	...
	UINT32		SNR0:8;
	UINT32		SNR1:8;
#if defined(RT2883) || defined(RT3883) || defined(RT3593) || defined(RT53xx)
	UINT32		SNR2:8;
	UINT32		FOFFSET:8;
#else
	UINT32		FOFFSET:8;	// RT35xx	
...
typedef	union	_LED_CFG_STRUC	{
 ...
 #if 0 /* RT3352 not support */
 #define TX_WCID_DROP_MASK00_31  0x106C
 #define TX_WCID_DROP_MASK32_63  0x1070
 #define TX_WCID_DROP_MASK64_95  0x1074
 #define TX_WCID_DROP_MASK96_127 0x1078
 #endif /* 0 */
...
#define MAC_WAPI_PN_TABLE_BASE	0x7800
...
#define HW_BEACON_MAX_SIZE_CONS	0x2000 /* unit: byte */
#define HW_BEACON_BASE0_CONS		0x4000
...
#define HW_BEACON_MAX_SIZE(_pAd)	((_pAd)->BcnCB.DYN_HW_BEACON_MAX_SIZE)
#define HW_BEACON_BASE0(_pAd)		((_pAd)->BcnCB.DYN_HW_BEACON_BASE0)
...
#define HW_BEACON_MAX_SIZE_CONS      0x1000 /* unit: byte */
#define HW_BEACON_BASE0_CONS         0x7800
...
#define HW_BEACON_MAX_SIZE(_pAd)	HW_BEACON_MAX_SIZE_CONS
#define HW_BEACON_BASE0(_pAd)		HW_BEACON_BASE0_CONS
...
#define	RTMP_MAC_SHR_MSEL_LOCK(_pAd, _shr_msel, _irqFlag)					\
	do{										\
		if (_pAd->BcnCB.bHighShareMemSupport == TRUE)						\
		{																	\
		UINT32			__regValue;					\
		RTMP_IO_WRITE32(_pAd, BCN_OFFSET0, 0x18100800); /* 0x0000(00), 0x0200(08), 0x0400(10), 0x0600(18), 512B for each beacon */ \
		RTMP_IO_WRITE32(_pAd, BCN_OFFSET1, 0x38302820); /* 0x0800(20), 0x0A00(28), 0x0C00(30), 0x0E00(38), 512B for each beacon */ \
...
#define RTMP_MAC_SHR_MSEL_PROTECT_LOCK(__pAd, __IrqFlags)                            \
                                 if (__pAd->BcnCB.bHighShareMemSupport== TRUE)                                                        \
