...
#define MAX_MBSSID_NUM_CONS			1
#ifdef MBSS_SUPPORT
#undef	MAX_MBSSID_NUM_CONS
#ifdef SPECIFIC_BCN_BUF_SUPPORT
#define HW_BEACON_MAX_COUNT_CONS		16
#define HW_BEACON_MAX_COUNT(_pAd)	((_pAd)->BcnCB.DYN_HW_BEACON_MAX_COUNT)
/* 	In 16-MBSS support mode, if AP-Client is enabled, 
	the last 8-MBSS would be occupied for AP-Client using. */
#ifdef APCLI_SUPPORT
#define MAX_MBSSID_NUM_CONS				(8 - MAX_MESH_NUM)
#else
#define MAX_MBSSID_NUM_CONS				(16 - MAX_MESH_NUM)
#endif // APCLI_SUPPORT //
#define MAX_MBSSID_NUM(_pAd)			((_pAd)->BcnCB.DYN_MAX_MBSSID_NUM)
#else
#define HW_BEACON_MAX_COUNT_CONS			8
#define MAX_MBSSID_NUM_CONS			(HW_BEACON_MAX_COUNT_CONS - MAX_MESH_NUM - MAX_APCLI_NUM) //8
//#define MAX_MBSSID_NUM				(HW_BEACON_MAX_COUNT_CONS - MAX_MESH_NUM - MAX_APCLI_NUM)
#define HW_BEACON_MAX_COUNT(_pAd)	HW_BEACON_MAX_COUNT_CONS
//#define MAX_MBSSID_NUM(_pAd)			MAX_MBSSID_NUM_CONS
#define MAX_MBSSID_NUM(_pAd)			(HW_BEACON_MAX_COUNT_CONS - MAX_MESH_NUM - MAX_APCLI_NUM)
#endif // SPECIFIC_BCN_BUF_SUPPORT //
#else
#define HW_BEACON_MAX_COUNT_CONS		1
#define MAX_MBSSID_NUM(_pAd)			MAX_MBSSID_NUM_CONS
#define HW_BEACON_MAX_COUNT(_pAd)	HW_BEACON_MAX_COUNT_CONS
#endif // MBSS_SUPPORT //

/* sanity check for apidx */
#define MBSS_MR_APIDX_SANITY_CHECK(apidx, pAd) \
...
#else
#if defined(MAX_MBSSID_NUM_CONS) && (MAX_MBSSID_NUM_CONS == 8)
#define HW_RESERVED_WCID	222
#elif defined(MAX_MBSSID_NUM_CONS) && (MAX_MBSSID_NUM_CONS == 7)
...
#define MAX_AVAILABLE_CLIENT_WCID	(LAST_SPECIFIC_WCID - MAX_MBSSID_NUM_CONS - 1) 

// TX need WCID to find Cipher Key
// these wcid 212 ~ 219 are reserved for bc/mc packets if MAX_MBSSID_NUM is 8.
#define GET_GroupKey_WCID(__wcid, __bssidx, __pAd) \
	{										\
		__wcid = LAST_SPECIFIC_WCID - (MAX_MBSSID_NUM(__pAd)) + __bssidx;	\
	}
