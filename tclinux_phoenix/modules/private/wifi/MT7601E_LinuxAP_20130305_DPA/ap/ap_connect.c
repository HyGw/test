...
VOID APMakeBssBeacon(RTMP_ADAPTER *pAd, INT apidx)
{
	...
	printk("\x1b[31m%s: bCountryFlag %d\x1b[m\n", __FUNCTION__, pAd->CommonCfg.bCountryFlag);
	...
	*/
	...
	//printk("\x1b[32m%s: ptr %p, reg_base %p\x1b[m\n", __FUNCTION__, ptr, reg_base);
	...
	//hex_dump("beacon buffer:", (PUCHAR)pAd->ApCfg.MBSSID[apidx].BeaconBuf, 128);
}
   	...
   	/* add Ralink-specific IE here - Byte0.b0=1 for aggregation, Byte0.b1=1 for piggy-back */
{
	...
	//hex_dump("beacon buffer2:", (PUCHAR)pAd->ApCfg.MBSSID[apidx].BeaconBuf, 256);
}
