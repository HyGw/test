...
#ifdef MT7601E
	BOOLEAN Cal_Done;	/* calibration done */
#endif	/* MT7601E */
...
#ifdef MT7601
	/* for MT7601 bbp hang */
	UINT32 false_cca_cnt_per_100ms;
	UINT8 bbp_halt_cnt;
#ifdef CONFIG_AP_SUPPORT
#ifdef AP_DYNAMIC_VGA_SUPPORT
	UINT16 	dvga_cca_h_th;
	UINT16 	dvga_cca_l_th;
	CHAR   	dvga_rssi_bw20_th;
	CHAR   	dvga_rssi_bw40_th;
	CHAR   	dvga_main_def_gain;
	CHAR   	dvga_aux_def_gain;
	CHAR   	dvga_acs_rssi;
	CHAR   	dvga_acs_rssi_sample;
	INT16  	dvga_acs_rssi256;
	BOOLEAN	dvga_enable; 
