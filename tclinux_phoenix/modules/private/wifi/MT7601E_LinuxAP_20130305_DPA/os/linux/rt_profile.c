...
extern int APFindDataPattern(PCHAR str, UINT32 line, PUCHAR data, UINT32 len);
...
//---Add by shiang for debug
		...
		//APFindDataPattern( __FUNCTION__, __LINE__, GET_OS_PKT_DATAPTR(pRxPkt), GET_OS_PKT_LEN(pRxPkt) );
		RtmpOsPktProtocolAssign(pRxPkt);
