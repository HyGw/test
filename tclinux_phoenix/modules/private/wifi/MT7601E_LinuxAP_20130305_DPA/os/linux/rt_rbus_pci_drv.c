...
/*	printk("mgmt_dma_done_process\n"); */
	...
	if ((IS_RT65XX(pAd) && (!IS_RT8592(pAd))) || IS_MT7601(pAd))
    ...
    IN	VOID				*pAdSrc)
{
	...
	if (device_id == NIC6590_PCIe_DEVICE_ID ||
    	...
    	pci_read_config_byte(pci_dev, FTS_CFG, &fts);
    	printk("\x1b[31m%s: fts %x\x1b[m\n", __FUNCTION__, fts);
    	pci_write_config_byte(pci_dev, FTS_CFG, 0x30);
	}
#endif /* MT7601 */
