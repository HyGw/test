...
ifeq ($(RT28xx_MODE),AP)
WFLAGS += -DCONFIG_AP_SUPPORT  -DUAPSD_SUPPORT -DMBSS_SUPPORT -DIAPP_SUPPORT -DAP_SCAN_SUPPORT
WFLAGS += -DRT_SOC_SUPPORT
WFLAGS += -DDBG
...
WFLAGS += -DMT7601E -DMT7601 -DRLT_MAC -DRLT_RF -DRTMP_MAC_PCI -DRTMP_PCI_SUPPORT -DRX_DMA_SCATTER -DVCORECAL_SUPPORT -DVCORECAL_SUPPORT -DRTMP_EFUSE_SUPPORT -DNEW_MBSSID_MODE -DRTMP_INTERNAL_TX_ALC -DCONFIG_ANDES_SUPPORT -DDPD_CALIBRATION_SUPPORT -DENHANCED_STAT_DISPLAY -DMCS_LUT_SUPPORT -DPEER_DELBA_TX_ADAPT -DFIFO_EXT_SUPPORT -DAP_DYNAMIC_VGA_SUPPORT -DAP_DYNAMIC_PD_LPF_SUPPORT
#-DRTMP_FREQ_CALIBRATION_SUPPORT -DMCS_LUT_SUPPORT -DPEER_DELBA_TX_ADAPT -DED_MONITOR
ifneq ($(findstring $(RT28xx_MODE),AP),)
#WFLAGS += -DSPECIFIC_BCN_BUF_SUPPORT
endif
