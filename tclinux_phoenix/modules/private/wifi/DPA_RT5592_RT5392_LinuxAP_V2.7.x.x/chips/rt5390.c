...
#if 0// defined(BB_SOC) && defined(CONFIG_MIPS_RT63365)
	{RF_R17,		0x80}, // Based on the frequency offset in the EEPROM
#endif
	{RF_R18,		0x03}, 
	{RF_R19,		0x00}, /* Spare */
	{RF_R20,		0x00}, 
...
#ifdef ED_MONITOR
	pChipOps->ChipSetEDCCA = RT5392_set_ed_cca;
#else
...
#ifdef ED_MONITOR
INT RT5392_set_ed_cca(RTMP_ADAPTER *pAd, BOOLEAN enable)
{
	UINT32 mac_val;
	UCHAR bbp_val = 0;
...
#endif
		bbp_val = 0x10; /* 0x2e */ // bit 0~7 for high threshold
	...
	IN PCHAR 				pDeltaPowerByBbpR1)
{
	...
	{
		if ((pAd->Mlme.OneSecPeriodicRound % 4 == 0) && (pAd->CommonCfg.TxPowerPercentage >= 100))	
		{
