	...
	IN	PSTRING			arg)
{
	...
	/* Make sure RF can do Tx/Rx */
	/*
		We don't need to enable mac Tx because mac will automatically
		respond the sounding req when Explit Tx BF is enabled.
	*/
	ATE_RF_IO_WRITE8_BY_REG_ID(pAd, RF_R01, 0xFF);
	...
	IN	PRTMP_ADAPTER	pAd)
{
...
#if defined(RT5370) || defined(RT5390) || defined(RT5592) || defined(RT3593)
	if (IS_RT5392(pAd) || IS_RT5592(pAd) || IS_RT3593(pAd))
		pATEInfo->Payload = 0xAA; 
	else
#endif /* defined(RT5370) || defined(RT5390) || defined(RT5592) || defined(RT3593) */
	...
	pATEInfo->TxWI.PHYMODE = MODE_OFDM;
	pATEInfo->TxWI.MCS = 7;
	pATEInfo->TxWI.BW = BW_20;
