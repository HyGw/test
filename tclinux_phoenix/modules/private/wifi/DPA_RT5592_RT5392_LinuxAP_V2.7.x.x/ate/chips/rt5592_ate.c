	...
	IN char index)
{
	...
	for (rate = 0; rate < CfgOfTxPwrCtrlOverMAC.NumOfEntries; rate++)
	{
		RTMP_IO_WRITE32(pAd, CfgOfTxPwrCtrlOverMAC.TxPwrCtrlOverMAC[rate].MACRegisterOffset, CfgOfTxPwrCtrlOverMAC.TxPwrCtrlOverMAC[rate].RegisterValue);
	}
