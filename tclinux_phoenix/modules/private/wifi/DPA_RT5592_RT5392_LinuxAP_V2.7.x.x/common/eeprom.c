...
static struct {
	...
	{0x3390,	"RT3390E2P.bin"},
	{0x3593,	"RT3593E2P.bin"},
	{0x5392,	"RT5392E2P.bin"},
	{0x5592,	"RT5592E2P.bin"},
	{0x5390,	"RT5390E2P.bin"},//tony 5390R e2p.bin
	{0x5391,	"RT5391E2P.bin"},//tony 5390H e2p.bin
#else
...
#ifdef BB_SOC
	rtmp_ee_write_to_bin_BBSOC(pAd);
#endif /* BB_SOC */
...
#ifdef BB_SOC
INT rtmp_ee_write_to_bin_BBSOC(
	IN PRTMP_ADAPTER 	pAd)
{
	PSTRING src = NULL;
	INT ret_val;			
