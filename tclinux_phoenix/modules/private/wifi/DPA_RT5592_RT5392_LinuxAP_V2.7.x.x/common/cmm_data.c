		...
		case 0x0800:
			{
				...
				{	/* udp packet*/
					...
					if (!HSIPv4Check(pAd, pWcid, pPacket, pSrcBuf, srcPort, dstPort))
						return FALSE;		
#endif				
#endif					
				}
...
#endif
				/* 
 				 * Check if DHCPv6 Packet, and Convert group-address DHCP packets 
 				 * to individually-addressed 802.11 frames
 				 */
#endif				
		...
		case 0x0806:
			{
				...
				{
//					if (pMacEntry)
//						printk("111,%d,%d,%d,%d,%d\n",pMacEntry->apidx, RTMP_GET_PACKET_NET_DEVICE(pPacket), pMacEntry->Aid, pMbss->WNMCtrl.ProxyARPEnable, *pWcid);
