...
/* 3593 */
#define IS_RT3593_NEW(_pAd) (_pAd->MACVersion == 0x35930405)
#define IS_RT3593(_pAd) (((_pAd)->MACVersion & 0xFFFF0000) == 0x35930000 || IS_RT3593_NEW((_pAd)))
