...
typedef struct _MO_CFG_STRUCT {
	...
	UINT16 		nFalseCCACnt;	
	UINT16		nFalseCCATh;	/* default is 200 */
	UINT16		nLowFalseCCATh;	/* default is 30 */
...
#ifdef DYNAMIC_RX_RATE_ADJ
	HT_CAPABILITY_IE RxHtCapability;
#endif /* DYNAMIC_RX_RATE_ADJ */
...
struct _RTMP_ADAPTER {
	...
	/* jiffies for Divider Calibration */
#define DIVIDER_CALI_THRESHOLD	(10000)
	ULONG	divider_cali_js;
	ULONG	divider_cali_je;
...
#define TIME_ONE_SECOND		(1000000/TIME_BASE)
	...
	UCHAR EEPROMImage[1024]; /* Used to be the buffer of eeprom contents */
...
#define RxINT				0x00000001	/* Delayed Rx or indivi rx */
#define TxDataInt			0x000000f2	/* Delayed Tx or indivi tx */
...
BOOLEAN PeerProbeReqSanity(
    ...
    IN VOID *Msg, 
    IN ULONG MsgLen, 
    OUT PPEER_PROBE_REQ_PARAM Param);
