...
#ifdef NEW_ACS_ALGO
#define BOOTUP_AUTO_CHANNEL_SEL_TIMEOUT		200		// uint: msec
#endif
...
#ifdef CONFIG_AP_SUPPORT
#define MAX_LEN_OF_MLME_QUEUE            64 /*10 */
#endif /* CONFIG_AP_SUPPORT */
...
#ifdef RT_BIG_ENDIAN
	UCHAR rsv1_2:5;
	UCHAR ExtendChannelSwitch:1;   // BIT2
	UCHAR rsv1_1:1;
	UCHAR BssCoexistMgmtSupport:1; // BIT0
#else
	UCHAR BssCoexistMgmtSupport:1;	// BIT0
	UCHAR rsv1_1:1;
	UCHAR ExtendChannelSwitch:1;	// BIT2
...
#ifdef RT_BIG_ENDIAN
	UCHAR rsv2_2:3;					
	UCHAR ProxyARPSupport:1;		// BIT12
	UCHAR FMSSupport:1;				// BIT11			
	UCHAR rsv2_1:3;
#else
	UCHAR rsv2_1:3;
	UCHAR FMSSupport:1;				// BIT11
...
#ifdef RT_BIG_ENDIAN
	UCHAR rsv3_2:5;
	UCHAR BssTransitionManmt:1;     // BIT18
	UCHAR rsv3_1:1;
	UCHAR WNMSleepSupport:1;		// BIT16
#else
	UCHAR WNMSleepSupport:1;		// BIT16
	UCHAR rsv3_1:1; 
	UCHAR BssTransitionManmt:1;		// BIT18
...
#ifdef RT_BIG_ENDIAN
	UCHAR Interworking:1;           // BIT31
	UCHAR TDLSChSwitchSupport:1; 	  // BIT30 TDLS Channel Switching
	UCHAR TDLSPeerPSMSupport:1;	  // BIT29 TDLS Peer PSM Support
	UCHAR UAPSDBufSTASupport:1;	  // BIT28 Peer U-APSD Buffer STA Support
	UCHAR rsv4_2:2;
	UCHAR DMSSupport:1;             // BIT25
	UCHAR rsv4_1:1;
#else
	UCHAR rsv4_1:1;
	UCHAR DMSSupport:1;				// BIT25
...
#ifdef RT_BIG_ENDIAN
	UCHAR TDLSChSwitchProhibited:1;	// BIT39 TDLS Channel Switching Prohibited
	UCHAR TDLSProhibited:1;			// BIT38 TDLS Prohibited
	UCHAR TDLSSupport:1;			   // BIT37 TDLS Support
	UCHAR MSGCF:1;                  // BIT36
	UCHAR rsv5_1:1;
	UCHAR SSPNInterface:1;          // BIT34
	UCHAR EBR:1;                    // BIT33
	UCHAR QosMap:1;                 // BIT32
#else
	UCHAR QosMap:1;					// BIT32
	UCHAR EBR:1;					// BIT33
	UCHAR SSPNInterface:1;			// BIT34
...
#ifdef RT_BIG_ENDIAN
	UCHAR rsv6_2:1;   
	UCHAR WNMNotifySupport:1;		// BIT46 WNM Notification
	UCHAR rsv6_1:6;                 
#else  
	UCHAR rsv6_1:6;  
	UCHAR WNMNotifySupport:1;		// BIT46 WNM Notification
