...
#define		WLAN_PORTS_NUM		4
typedef struct wlan_pktqosToken_s {
	u32 tokens;  /*total tokens*/
	u32 ctokens; /*current tokens*/
	u32 c_time; /*current time*/
	u32 l_time; /*last check time*/
