/*
 ...
 the number of bytes to be hashed being given by the the u32
 ...
 functions using a call with a hash length parameter as follows:
       ...
       int sha2_begin(u32 len, sha2_ctx ctx[1]);
       void sha2_hash(const unsigned char data[],
                            u32 len, sha2_ctx ctx[1]);
...
void_ret sha256_hash(const unsigned char data[], u32 len, sha256_ctx ctx[1])
...
void_ret sha224(unsigned char hval[], const unsigned char data[], u32 len)
{   sha224_ctx  cx[1];
...
void_ret sha256(unsigned char hval[], const unsigned char data[], u32 len)
{   sha256_ctx  cx[1];
...
void_ret sha512_hash(const unsigned char data[], u32 len, sha512_ctx ctx[1])
...
void_ret sha384(unsigned char hval[], const unsigned char data[], u32 len)
{   sha384_ctx  cx[1];
...
void_ret sha512(unsigned char hval[], const unsigned char data[], u32 len)
{   sha512_ctx  cx[1];
...
int_ret sha2_begin(u32 len, sha2_ctx ctx[1])
{
    switch(len)
    {
#if defined(SHA_224)
...
void_ret sha2_hash(const unsigned char data[], u32 len, sha2_ctx ctx[1])
{
    switch(ctx->sha2_len)
    {
#if defined(SHA_224)
...
int_ret sha2(unsigned char hval[], u32 size,
