...
REG_PAIR_CHANNEL *RF5592Reg_Channel_2G = &RF5592Reg_Channel_2G_Default[0];
...
REG_PAIR_CHANNEL *RF5592Reg_Channel_5G = &RF5592Reg_Channel_5G_Default[0];
...
const REG_PAIR BBP5592Reg_2G_5G[] = 
{
	...
	{BBP_R104, 0x92},
	{BBP_R105, 0x3C},
	{BBP_R106, 0x37}, /* for SGI peak throughput (20110629) */
	{BBP_R128, 0x12},
	{BBP_R134, 0xD0},
	{BBP_R135, 0xF6},
	...
	*/
	for (i = 0; i < MAX_NUM_OF_CHANNELS; i++)
	{
		if (Channel == pAd->TxPower[i].Channel)
		{
			...
			Tx0FinePowerCtrl = pAd->TxPower[i].Tx0FinePowerCtrl;
			Tx1FinePowerCtrl = pAd->TxPower[i].Tx1FinePowerCtrl;
			break;
		}
	}
