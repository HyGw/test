...
#if (LINUX_VERSION_CODE >= KERNEL_VERSION(2,6,36))
	RTMP_INT_LOCK(&pAd->CommonCfg.MeasureReqTabLock, IrqFlags);
#else
...
#if (LINUX_VERSION_CODE >= KERNEL_VERSION(2,6,36))
	RTMP_INT_UNLOCK(&pAd->CommonCfg.MeasureReqTabLock, IrqFlags);
#else
...
#if (LINUX_VERSION_CODE >= KERNEL_VERSION(2,6,36))
	RTMP_INT_LOCK(&pAd->CommonCfg.TpcReqTabLock, IrqFlags);
#else
...
#if (LINUX_VERSION_CODE >= KERNEL_VERSION(2,6,36))
	RTMP_INT_UNLOCK(&pAd->CommonCfg.TpcReqTabLock, IrqFlags);
#else
