...
extern UCHAR RateSwitchTable11N3S_Normal[];
...
typedef struct _ATE_CHIP_STRUCT {
	...
	VOID 	(*RxVariableGainAmplifierInit)(PRTMP_ADAPTER pAd);
...
/* Radar detection is too sensitive on USB, so raise the thresholds */
#define CARRIER_DETECT_RECHECK_TIME                     5		
#define CARRIER_GONE_TRESHOLD				35		/* Radar tone count in 1 sec */ 
#define CARRIER_DETECT_THRESHOLD			0x4fffffff
#else
#define CARRIER_DETECT_RECHECK_TIME			3
#define CARRIER_GONE_TRESHOLD				10
...
/* ETxBF */
	...
	USHORT      BfTxQuality[MAX_STEP_OF_TX_RATE_SWITCH];	// Beamformed TX Quality
#endif /* TXBF_SUPPORT */
