...
NDIS_STATUS RtmpNetTaskInit(IN RTMP_ADAPTER *pAd)
{
	...
	IF_DEV_CONFIG_OPMODE_ON_AP(pAd)
	{
		...
		RTMP_OS_TASKLET_INIT(pAd, &pObj->carrier_sense_work, carrier_sense_workq);
...
#ifdef CARRIER_DETECTION_SUPPORT
		RTMP_OS_TASKLET_INIT(pAd, &pObj->carrier_sense_task, carrier_sense_tasklet, (unsigned long)pAd);
#endif /* CARRIER_DETECTION_SUPPORT */
...
#ifdef CARRIER_DETECTION_SUPPORT
		RTMP_OS_TASKLET_KILL(&pObj->carrier_sense_task);
#endif /* CARRIER_DETECTION_SUPPORT */
