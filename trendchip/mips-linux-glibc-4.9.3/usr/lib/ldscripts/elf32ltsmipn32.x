...
OUTPUT_ARCH(mips)
ENTRY(__start)
SEARCH_DIR("/opt/trendchip/mips-linux-glibc-4.9.3/usr/mips-buildroot-linux-gnu/lib32"); SEARCH_DIR("=/usr/local/lib32"); SEARCH_DIR("=/lib32"); SEARCH_DIR("=/usr/lib32"); SEARCH_DIR("=/usr/local/lib"); SEARCH_DIR("=/lib"); SEARCH_DIR("=/usr/lib");
SECTIONS
{
