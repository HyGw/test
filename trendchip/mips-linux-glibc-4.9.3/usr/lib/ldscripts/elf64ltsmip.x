...
OUTPUT_ARCH(mips)
ENTRY(__start)
SEARCH_DIR("/opt/trendchip/mips-linux-glibc-4.9.3/usr/mips-buildroot-linux-gnu/lib64"); SEARCH_DIR("=/usr/local/lib64"); SEARCH_DIR("=/lib64"); SEARCH_DIR("=/usr/lib64"); SEARCH_DIR("=/usr/local/lib"); SEARCH_DIR("=/lib"); SEARCH_DIR("=/usr/lib");
SECTIONS
{
