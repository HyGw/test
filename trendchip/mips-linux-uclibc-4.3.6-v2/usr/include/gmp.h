...
#define __GMP_CC "/mtkoss/gcc/3.4.6/i686/bin/gcc -std=gnu99"
#define __GMP_CFLAGS "-O2 -I/opt/trendchip/mips-linux-uclibc-4.3.6-v2/include -I/opt/trendchip/mips-linux-uclibc-4.3.6-v2/usr/include"
